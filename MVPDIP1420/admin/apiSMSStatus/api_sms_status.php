<?php
	...
	$sql = "SELECT count(*) total FROM api_sms_status WHERE 1 = 1   "; 
	...
	////////////////////////////
	////////////////////////////
	$sql = "SELECT id,nombre,codigo FROM api_sms_status WHERE 1 = 1  "; 
	...
	if($post_search){
		$sqlContadorScript = "SELECT count(*) total FROM api_sms_status WHERE 1 = 1   "; 
