<?php
	...
	$sql = "SELECT count(*) total FROM api_whatsapp_status WHERE 1 = 1   "; 
	...
	////////////////////////////
	////////////////////////////
	$sql = "SELECT id,nombre,codigo FROM api_whatsapp_status WHERE 1 = 1  "; 
	// getting records as per search parameters
	$codigo=$search_database['codigo'];
	if( $codigo!="" ){   //name
		$post_search=true;
		$sql.=" AND codigo LIKE '%{$codigo}%' ";
		$sqlContador .= " AND codigo LIKE '%{$codigo}%' ";
	} 
	...
	if($post_search){
		$sqlContadorScript = "SELECT count(*) total FROM api_whatsapp_status WHERE 1 = 1   "; 
