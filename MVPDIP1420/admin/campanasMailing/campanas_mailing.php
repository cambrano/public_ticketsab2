<?php
	...
	$sql = "SELECT count(*) total FROM campanas_mailing WHERE 1 = 1   "; 
	...
	$sql = "SELECT 
			...
			nombre 
		FROM campanas_mailing WHERE 1 = 1  "; 
	...
	if($post_search){
		$sqlContadorScript = "SELECT count(*) total FROM campanas_mailing WHERE 1 = 1   "; 
