<?php
	...
	$tablasRelacionadas = tablasRelacionadas('casillas_votos_2016',$id);
...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "casillasVotos2016/db_delete.php",
				data: dataString,
				success: function(data) { 
					if(data=="SI"){
						document.getElementById("mensaje").classList.remove("mensajeError"); 
	...
	<div class="bodymanager" id="bodymanager"> 
		...
		<div class="bodyinput">
			...
			<label class="descripcionForm">
				<strong><?= $casilla_voto_2016Datos['clave']?></strong>
			</label><br>
			<label class="labelForm" id="labeltemaname">Código</label><br>
			<label class="descripcionForm">
				<strong><?= $casilla_voto_2016Datos['codigo']?></strong>
			</label><br>
			<?php
			if($registros_tablas!=''){
