<?php
	...
	$sql = "SELECT count(*) total FROM casillas_votos_2018 WHERE 1 = 1   "; 
	...
	$sql = "SELECT * ,
			...
			END as tipo
			FROM casillas_votos_2018 cv WHERE 1 = 1 "; 
	...
	*/
	...
	if($post_search){
		$sqlContadorScript = "SELECT count(*) total FROM casillas_votos_2018 cv WHERE 1 = 1   "; 
