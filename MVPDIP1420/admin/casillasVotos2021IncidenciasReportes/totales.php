<?php
	...
	if($id_municipio != ""){
		...
		FROM (
			SELECT 
				(SELECT COUNT(*) FROM casillas_votos_2021_incidencias ci WHERE ci.id_casilla_voto_2021 = c.id) incidencias,
				(SELECT COUNT(*) FROM casillas_votos_2021_incidencias ci WHERE ci.id_casilla_voto_2021 = c.id AND ci.status=0 ) pendientes,
				(SELECT COUNT(*) FROM casillas_votos_2021_incidencias ci WHERE ci.id_casilla_voto_2021 = c.id AND ci.status=1 ) atendidas,
				(SELECT COUNT(*) FROM casillas_votos_2021_incidencias ci WHERE ci.id_casilla_voto_2021 = c.id AND ci.semaforo = 1 ) verde,
				(SELECT COUNT(*) FROM casillas_votos_2021_incidencias ci WHERE ci.id_casilla_voto_2021 = c.id AND ci.semaforo = 2 ) amarillo,
				(SELECT COUNT(*) FROM casillas_votos_2021_incidencias ci WHERE ci.id_casilla_voto_2021 = c.id AND ci.semaforo = 3 ) rojo
			FROM casillas_votos_2021 c WHERE c.tipo=0 '.$sqlMunicipip.'
		) as t';
		$resultado = $conexion->query($sql);
		$row_municipal=$resultado->fetch_assoc(); 
		//votos validos, votos_nulos, votos canreg
		$sql = 'SELECT COUNT(*) total FROM casillas_votos_2021 c WHERE c.tipo=0 '.$sqlMunicipip;
		$resultado = $conexion->query($sql);
		...
		FROM (
			SELECT 
				...
				(SELECT COUNT(*) FROM casillas_votos_2021_incidencias ci WHERE ci.id_casilla_voto_2021 = c.id AND ci.semaforo = 2 ) amarillo,
				(SELECT COUNT(*) FROM casillas_votos_2021_incidencias ci WHERE ci.id_casilla_voto_2021 = c.id AND ci.semaforo = 3 ) rojo
			FROM casillas_votos_2021 c WHERE c.tipo=1 '.$sqlDLocal.'
		) as t';
		$resultado = $conexion->query($sql);
		$row_local=$resultado->fetch_assoc(); 
		$sql = 'SELECT COUNT(*) total FROM casillas_votos_2021 c WHERE c.tipo=1 '.$sqlDLocal;
		$resultado = $conexion->query($sql);
		...
		FROM (
			SELECT 
				...
				(SELECT COUNT(*) FROM casillas_votos_2021_incidencias ci WHERE ci.id_casilla_voto_2021 = c.id AND ci.semaforo = 2 ) amarillo,
				(SELECT COUNT(*) FROM casillas_votos_2021_incidencias ci WHERE ci.id_casilla_voto_2021 = c.id AND ci.semaforo = 3 ) rojo
			FROM casillas_votos_2021 c WHERE c.tipo=2 '.$sqlDFederal.'
		) as t';
		$resultado = $conexion->query($sql);
		$row_federal=$resultado->fetch_assoc();
		$sql = 'SELECT COUNT(*) total FROM casillas_votos_2021 c WHERE c.tipo=2 '.$sqlDFederal;
		$resultado = $conexion->query($sql);
		...
		FROM (
			SELECT 
				...
				(SELECT COUNT(*) FROM casillas_votos_2021_incidencias ci WHERE ci.id_casilla_voto_2021 = c.id AND ci.semaforo = 2 ) amarillo,
				(SELECT COUNT(*) FROM casillas_votos_2021_incidencias ci WHERE ci.id_casilla_voto_2021 = c.id AND ci.semaforo = 3 ) rojo
			FROM casillas_votos_2021 c WHERE c.tipo=0
		) as t';
		$resultado = $conexion->query($sql);
		$row_municipal=$resultado->fetch_assoc(); 
		//votos validos, votos_nulos, votos canreg
		$sql = 'SELECT COUNT(*) total FROM casillas_votos_2021 c WHERE c.tipo=0 ';
		$resultado = $conexion->query($sql);
		$total_municipal=$resultado->fetch_assoc(); 
		...
		FROM (
			SELECT 
				...
				(SELECT COUNT(*) FROM casillas_votos_2021_incidencias ci WHERE ci.id_casilla_voto_2021 = c.id AND ci.semaforo = 2 ) amarillo,
				(SELECT COUNT(*) FROM casillas_votos_2021_incidencias ci WHERE ci.id_casilla_voto_2021 = c.id AND ci.semaforo = 3 ) rojo
			FROM casillas_votos_2021 c WHERE c.tipo=1 
		) as t';
		$resultado = $conexion->query($sql);
		$row_local=$resultado->fetch_assoc(); 
		$sql = 'SELECT COUNT(*) total FROM casillas_votos_2021 c WHERE c.tipo=1 ';
		$resultado = $conexion->query($sql);
		$total_local=$resultado->fetch_assoc();
		...
		FROM (
			SELECT 
				...
				(SELECT COUNT(*) FROM casillas_votos_2021_incidencias ci WHERE ci.id_casilla_voto_2021 = c.id AND ci.semaforo = 2 ) amarillo,
				(SELECT COUNT(*) FROM casillas_votos_2021_incidencias ci WHERE ci.id_casilla_voto_2021 = c.id AND ci.semaforo = 3 ) rojo
			FROM casillas_votos_2021 c WHERE c.tipo=2
		) as t';
		$resultado = $conexion->query($sql);
		$row_federal=$resultado->fetch_assoc();
		$sql = 'SELECT COUNT(*) total FROM casillas_votos_2021 c WHERE c.tipo=2 ';
		$resultado = $conexion->query($sql);
		$total_federal=$resultado->fetch_assoc();
