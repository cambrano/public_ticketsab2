<?php
	...
	$sql = "SELECT count(*) total FROM casillas_votos_2021_status WHERE 1 = 1   "; 
	...
	FROM casillas_votos_2021_status WHERE 1 = 1";
	$sql.= " AND id_casilla_voto_2021 ='{$id_casilla_voto_2021}' ";
	...
	if($post_search){
		$sqlContadorScript = "SELECT count(*) total FROM casillas_votos_2021_status sia WHERE 1 = 1   "; 
