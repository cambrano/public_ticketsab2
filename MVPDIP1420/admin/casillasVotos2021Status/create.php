<?php
	...
	@session_start();
	echo $id_casilla_voto_2021 = decrypt_ab_checkFinal($_COOKIE['paguinaId_1']);
	...
	$permiso='insert';
	$casilla_voto_2021_statusDatos['fecha'] = $fechaSF;
	$casilla_voto_2021_statusDatos['hora'] = $fechaSH;
