...
?>
	...
	<div style=" width: 100%; display:inline-block; text-align: left;">
		...
		<div class="sucForm">
			...
			<?php
				$selecTipoSeccion[$casilla_voto_2021_statusDatos['status']] = 'selected="selected"';
			?>
		...
		<div class="sucForm">
			...
			<input class="inputlogin" type="text" name="fecha" autocomplete="off"  id="fecha" value="<?= $casilla_voto_2021_statusDatos['fecha'] ?>" placeholder="" /><br>
		</div>

		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Hora<font color="#FF0004">*</font></label><br>
			<input class="inputlogin" type="text" name="hora" autocomplete="off"  id="hora" value="<?= $casilla_voto_2021_statusDatos['hora'] ?>" placeholder="" /><br>
		</div>
