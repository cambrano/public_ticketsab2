<?php
	...
	if(!empty($_GET)){
		$tipo = $_GET['tipo'];
		setcookie("paguinaId_1",encrypt_ab_check($tipo), array('expires' => time() + (60*60*24), 'path' => '/', 'secure' => true, 'httponly' => true, 'samesite' => 'Strict'));
	}else{
		$tipo = decrypt_ab_checkFinal($_COOKIE['paguinaId_1']);
	}
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "casillasVotos2022RevocacionMandato/db_add.php",
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Crear Casilla Voto 2022 Revocación de mandato<br></font>
					<?php
					/*
					if($tipo==0){
						?>
				...
				<label class="descripcionForm">
					<font style="font-size: 13px;">Campos para registrar y dar de casilla voto 2022 revocación de mandato.</font><br><br>
				</label><br>
