...
?>
	...
	<div style=" width: 100%; display:inline-block; text-align: left;">
		<div class="sucFormTitulo">
			<label class="labelForm" id="labeltemaname">Datos Casilla 2022 revocación de mandato</label>
		</div>
		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Clave<font color="#FF0004">*</font></label><br>
			<input class="inputlogin" <?= $claveF['input'] ?> type="text" name="clave" autocomplete="off"  id="clave" value="<?= $casilla_voto_2022_revocacion_mandatoDatos['clave'] ?>" placeholder="" maxlength="120" onblur="aMays(event, this)"/><br>
		</div>
		...
		<div class="sucForm">
			...
			<select class="myselect" id="id_seccion_ine" >
				<?php
				echo secciones_ine($casilla_voto_2022_revocacion_mandatoDatos['id_seccion_ine']);
				?>
			</select><br>
		</div>
		...
		<div class="sucForm">
			...
			<select class="myselect" id="id_tipo_casilla">
				<?php
				echo tipos_casillas($casilla_voto_2022_revocacion_mandatoDatos['id_tipo_casilla']);
				?>
			</select><br>
		</div>
		...
		<div class="sucForm">
			...
			<input class="inputlogin" type="text" style="width: 100%" name="codigo" autocomplete="off"  id="codigo" value="<?= $casilla_voto_2022_revocacion_mandatoDatos['codigo'] ?>" placeholder="Código" onblur="aMays(event, this)" /><br>
		</div>
		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Lista Nominal<font color="#FF0004">*</font></label><br>
			<input class="inputlogin" type="text" style="width: 100%" name="lista_nominal" autocomplete="off"  id="lista_nominal" value="<?= $casilla_voto_2022_revocacion_mandatoDatos['lista_nominal'] ?>" placeholder="Lista Nominal" onkeypress="return CheckNumeric()" /><br>
		</div>
		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Estatus<font color="#FF0004">*</font></label><br>
			<input class="inputlogin" type="text" style="width: 100%" name="status" autocomplete="off"  id="status" value="<?= $casilla_voto_2022_revocacion_mandatoDatos['status'] ?>" placeholder="estatus" /><br>
		</div>
		<div class="sucFormTitulo">
		...
		<div class="sucForm">
			...
			<input class="inputlogin" type="text" style="width: 100%" name="votos_nulos" autocomplete="off"  id="votos_nulos" value="<?= $casilla_voto_2022_revocacion_mandatoDatos['votos_nulos'] ?>" placeholder="Votos Nulos" onkeypress="return CheckNumeric()" onchange="votos_totales()"/><br>
		</div>

		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Votos CAN NREG<font color="#FF0004">*</font></label><br>
			<input class="inputlogin" type="text" style="width: 100%" name="votos_can_nreg" autocomplete="off"  id="votos_can_nreg" value="<?= $casilla_voto_2022_revocacion_mandatoDatos['votos_can_nreg'] ?>" placeholder="Votos CAN NREG" onkeypress="return CheckNumeric()" onchange="votos_totales()"/><br>
		</div>
