<?php
	...
	$casilla_voto_2024ClaveVerificacion=casilla_voto_2024ClaveVerificacion($_POST["casilla_voto_2024"][0]["clave"],$_POST["casilla_voto_2024"][0]['id'],1);
					...
					foreach ($casillas_votos_partidos_2024Datos as $keyT => $valueT) {
						if( $id_partido_2024 == $valueT['id_partido_2024']){
							$votos_partidos_2024[] = array(
								...
								'id_cuartel' => $_POST["casilla_voto_2024"][0]['id_cuartel'],
							);
						}
					}
				}
