<?php
	...
	$tablasRelacionadas = tablasRelacionadas('casillas_votos_2024',$id);
...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "casillasVotos2024/db_delete.php",
				data: dataString,
				success: function(data) { 
					if(data=="SI"){
						document.getElementById("mensaje").classList.remove("mensajeError"); 
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Eliminar Casilla Voto 2024</font>
				</label>
			</div>
		</div>
		<div class="bodyinput">
			...
			<label class="descripcionForm">
				<strong><?= $casilla_voto_2024Datos['clave']?></strong>
			</label><br>
			<label class="labelForm" id="labeltemaname">Código</label><br>
			<label class="descripcionForm">
				<strong><?= $casilla_voto_2024Datos['codigo']?></strong>
			</label><br>
			<?php
			if($registros_tablas!=''){
