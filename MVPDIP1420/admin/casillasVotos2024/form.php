<?php
	...
	$zoom = 14;
	if($casilla_voto_2024Datos['longitud']=="" || $casilla_voto_2024Datos['latitud']=="" ){
		$zoom = 14;
	}else{
		$longitud=$casilla_voto_2024Datos['longitud'];
		$latitud=$casilla_voto_2024Datos['latitud'];
	}
...
?>
	...
	<div style=" width: 100%; display:inline-block; text-align: left;">
		...
		<div class="sucForm">
			...
			<input class="inputlogin" <?= $claveF['input'] ?> type="text" name="clave" autocomplete="off"  id="clave" value="<?= $casilla_voto_2024Datos['clave'] ?>" placeholder="" maxlength="120" onblur="aMays(event, this)"/><br>
		</div>
		...
		<div class="sucForm">
			...
			<select class="myselect" id="id_seccion_ine" onchange="seccionesLocation(this.value)" >
				<?php
				echo secciones_ine($casilla_voto_2024Datos['id_seccion_ine']);
				?>
			</select><br>
		</div>
		<div class="sucForm">
			<?php
			$selecTipoSeccion[$casilla_voto_2024Datos['tipo_seccion']] = 'selected="selected"';
			?>
		...
		<div class="sucForm">
			...
			<select class="myselect" id="id_tipo_casilla">
				<?php
				echo tipos_casillas($casilla_voto_2024Datos['id_tipo_casilla']);
				?>
			</select><br>
		</div>
		...
		<div class="sucForm">
			...
			<input class="inputlogin" type="text" style="width: 100%" name="status" autocomplete="off"  id="status" value="<?= $casilla_voto_2024Datos['status'] ?>" placeholder="estatus" /><br>
		</div>
		<div class="sucFormTitulo">
		...
		<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px;display: none;">
			...
			<select   name="id_pais" id="id_pais" class='myselect' disabled="disabled" >
				<?php
				echo paises($casilla_voto_2024Datos['id_pais']);
				?>
			</select>
		</div>
		...
		<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px;display: none;">
			...
			<select   name="id_estado" id="id_estado" class='myselect' onchange="locationEstado(this);" disabled="disabled" >  
				<?php
				echo estados($casilla_voto_2024Datos['id_estado']);
				?>
			</select>
		</div>
		<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px;">
			...
			<select   name="id_municipio" id="id_municipio" class='myselect' onchange="locationMunicipio(this)">  
				<?php
				echo municipios($casilla_voto_2024Datos['id_municipio'],$casilla_voto_2024Datos['id_estado']);
				?>
			</select>
		</div>
		<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px">
			...
			<select   name="id_localidad" id="id_localidad" class='myselect'>  
				<?php
				echo localidades($casilla_voto_2024Datos['id_localidad'],$casilla_voto_2024Datos['id_municipio'],$casilla_voto_2024Datos['id_estado']);
				?>
			</select>
		</div>
		...
		<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px;width: 100%">
			...
			<input class="inputlogin" type="text" name="calle" autocomplete="off" id="calle" value="<?= $casilla_voto_2024Datos['calle'] ?>" placeholder="" maxlength="120" /><br>
		</div>

		<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px">
			<label class="labelForm" id="labeltemaname">Num Ext.</label><br>
			<input class="inputlogin" type="text" name="num_ext" autocomplete="off"  id="num_ext" value="<?= $casilla_voto_2024Datos['num_ext'] ?>" placeholder="" maxlength="120" /><br>
		</div>

		<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px">
			<label class="labelForm" id="labeltemaname">Num Int.</label><br>
			<input class="inputlogin" type="text" name="num_int" autocomplete="off"  id="num_int" value="<?= $casilla_voto_2024Datos['num_int'] ?>" placeholder="" maxlength="120" /><br>
		</div>

		<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px">
			<label class="labelForm" id="labeltemaname">Colonia<font color="#FF0004">*</font></label><br>
			<input class="inputlogin" type="text" name="colonia" autocomplete="off"  id="colonia" value="<?= $casilla_voto_2024Datos['colonia'] ?>" placeholder="" maxlength="120" /><br>
		</div> 


		<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px">
			<label class="labelForm" id="labeltemaname">Código Postal<font color="#FF0004">*</font></label><br>
			<input class="inputlogin" type="text" name="codigo_postal" autocomplete="off"  id="codigo_postal" value="<?= $casilla_voto_2024Datos['codigo_postal'] ?>" placeholder="" maxlength="120" onkeypress="return CheckNumeric()" /><br>
		</div>

		<div class="sucForm" style="width: 100%">
			<label class="labelForm" id="labeltemaname">Referencia</label><br>
			<textarea id="referencia" style="width: 99%;height: 150px"><?= $casilla_voto_2024Datos['referencia'] ?></textarea> <br>
		</div>

		<div class="sucForm" style="width: 100%">
			<label class="labelForm" id="labeltemaname">Latitud</label><br>
			<input type="text" name="latitud" id="latitud_m" value="<?= $casilla_voto_2024Datos['latitud'] ?>" placeholder="latitud">
		</div>
		<div class="sucForm" style="width: 100%">
			<label class="labelForm" id="labeltemaname">Longitud</label><br>
			<input type="text" name="longitud" id="longitud_m" value="<?= $casilla_voto_2024Datos['longitud'] ?>" placeholder="longitud">
		</div>
