...
?>
	...
	<div style=" width: 100%; display:inline-block; text-align: left;">
		...
		<div class="sucForm" style="width: 100%">
			...
			<?php
				$selecTipoSeccion[$casilla_voto_2024_incidenciaDatos['semaforo']] = 'selected="selected"';
			?>
		...
		<div class="sucForm">
			...
			<input class="inputlogin" type="text" name="fecha" autocomplete="off"  id="fecha" value="<?= $casilla_voto_2024_incidenciaDatos['fecha'] ?>" placeholder="" /><br>
		</div>

		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Hora<font color="#FF0004">*</font></label><br>
			<input class="inputlogin" type="text" name="hora" autocomplete="off"  id="hora" value="<?= $casilla_voto_2024_incidenciaDatos['hora'] ?>" placeholder="" /><br>
		</div>
		...
		<div class="sucForm" style="width: 100%">
			...
			<textarea id="observaciones" style="width: 99%;height: 150px" maxlength="140"><?= $casilla_voto_2024_incidenciaDatos['observaciones'] ?></textarea> <br>
		</div>
		<?php
			$casilla_voto_2024_incidenciaDatos['status'];
		?>
		<label class="labelForm" id="labeltemaname">Estatus<font color="#FF0004">*</font></label><br>
			<select id="status" class="myselect" name="status" >
				<?= statusAtendido($casilla_voto_2024_incidenciaDatos['status']); ?>
			</select><br><br>
