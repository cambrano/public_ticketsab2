<?php
	...
	@session_start();
	echo $id_casilla_voto_2024 = decrypt_ab_checkFinal($_COOKIE['paguinaId_1']);
	...
	$permiso='insert';
	$casilla_voto_2024_statusDatos['fecha'] = $fechaSF;
	$casilla_voto_2024_statusDatos['hora'] = $fechaSH;
...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "casillasVotos2024Status/db_add.php",
