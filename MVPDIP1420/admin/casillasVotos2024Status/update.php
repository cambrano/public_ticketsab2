<?php
	...
	$casilla_voto_2024_statusDatos=casilla_voto_2024_statusDatos($id,$id_casilla_voto_2024);
	?>
	<title>Update</title>
	<script language="javascript" type="text/javascript">
		function cerrar(){
			urlink="casillasVotos2024Status/index.php";
		...
		function guardar() {
			...
			casilla_voto_2024_status.push(data);
			$.ajax({
				type: "POST",
				url: "casillasVotos2024Status/db_edit.php",
				data: {casilla_voto_2024_status: casilla_voto_2024_status},
				success: function(data) {
	...
	<div class="bodymanager" id="bodymanager"> 
		...
		<div class="bodyform">
			<div class= "bodyheader">
				...
				<h2><?= $casilla_voto_2024Datos['codigo']; ?></h2>
