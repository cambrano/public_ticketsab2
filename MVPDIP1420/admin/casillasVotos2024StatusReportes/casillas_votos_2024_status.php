<?php
	...
	$sql = "SELECT count(*) total FROM casillas_votos_2024_incidencias WHERE 1 = 1   "; 
	...
	FROM casillas_votos_2024_incidencias c WHERE 1 = 1";
	...
	if($post_search){
		$sqlContadorScript = "SELECT count(*) total FROM casillas_votos_2024_incidencias sia WHERE 1 = 1   "; 
