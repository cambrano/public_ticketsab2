...
?>
	<div style="text-align: left;padding: 0px 0px 0px 5px;font-size: 8px;color: black;margin-bottom: 20px;margin-top: -13.6px;background-color: rgba(176,176,176,0.6);padding: 5px">
		Lista Nominal: <b><?=number_format($total_lista_nominal_2018, 0, '.', ','); ?></b>
		<br>
		<br>
		Participación: <b><?=number_format($votos_totales_2018, 0, '.', ','); ?></b>
		<br>
		Porcentaje: <b><?=number_format($participacion_ciudadana, 2, '.', ','); ?>%</b>
		<br>
		<br>
		Abstención: <b><?=number_format( $total_lista_abstencion_2018, 0, '.', ','); ?></b>
		<br>
