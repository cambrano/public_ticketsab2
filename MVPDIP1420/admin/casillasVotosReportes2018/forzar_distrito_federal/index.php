...
?>
	...
	<div id="bodymanager" class="bodymanager">
		...
		?>
		<div class="submenux" onclick="subConfiguracionF_Distrito_FederalSeccionesIneReportes2018()">Secciones INE Reportes <?= $ano ?></div> / 
		<br>
		...
		<label class="tituloForm">
			...
			<br>
			Distritos Federales <?= $seccion_ineDistritosFederalesNumero ?> 
			<br>
			Municipio:</font> <?= $municipioNombre; ?>
		</label><br>
		<label class="tituloForm">
