...
?>
	...
	<div id="bodymanager" class="bodymanager">
		...
		<?php
		if($tipo_uso_plataforma=='all'){
			echo '<div class="submenux" onclick="subConfiguracionSenadorReportes2018()">Goberandor Reporte '.$ano.'</div> /';
		}
		?>
		<div class="submenux" onclick="subConfiguracionSenadorSeccionesIneReportes2018()">Secciones INE Reportes <?= $ano ?></div> / 
