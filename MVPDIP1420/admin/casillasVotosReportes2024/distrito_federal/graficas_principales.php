...
?>
	<div style="text-align: left;padding: 0px 0px 0px 5px;font-size: 8px;color: black;margin-bottom: 20px;margin-top: -13.6px;background-color: rgba(176,176,176,0.6);padding: 5px">
		Lista Nominal: <b><?=number_format($total_lista_nominal_2024, 0, '.', ','); ?></b>
		<br>
		<br>
		Participación: <b><?=number_format($votos_totales_2024, 0, '.', ','); ?></b>
		<br>
		Porcentaje: <b><?=number_format($participacion_ciudadana, 2, '.', ','); ?>%</b>
		<br>
		<br>
		Abstención: <b><?=number_format( $total_lista_abstencion_2024, 0, '.', ','); ?></b>
		<br>
		Porcentaje: <b><?=number_format($abstencion_ciudadana, 2, '.', ','); ?>%</b>
		<br><br>
	...
	var config = {
		...
		data: {
			...
			datasets: [{
				data: [
					//300, 
					<?=number_format($votos_totales_2024, 0, '.', ''); ?>,
					<?=number_format($total_lista_abstencion_2024, 0, '.', ''); ?>,
				],
				dataX: [
					//300, 
					"<?=number_format($votos_totales_2024, 0, '.', ','); ?>",
