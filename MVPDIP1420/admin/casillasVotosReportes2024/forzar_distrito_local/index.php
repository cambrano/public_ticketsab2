...
?>
	...
	<div id="bodymanager" class="bodymanager">
		...
		?>
		<div class="submenux" onclick="subConfiguracionF_Distrito_LocalSeccionesIneReportes2024()">Secciones INE Reportes <?= $ano ?></div> / 
		<br>
		...
		<label class="tituloForm">
			...
			<br>
			Distritos Locales <?= $seccion_ineDistritosLocalesNumero ?> 
			<br>
