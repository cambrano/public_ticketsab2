...
?>
	...
	<div id="bodymanager" class="bodymanager">
		...
		<?php
		if($tipo_uso_plataforma=='all'){
			echo '<div class="submenux" onclick="subConfiguracionGobernadorReportes2024()">Goberandor Reporte '.$ano.'</div> /';
		}
		?>
		<div class="submenux" onclick="subConfiguracionGobernadorSeccionesIneReportes2024()">Secciones INE Reportes <?= $ano ?></div> / 
