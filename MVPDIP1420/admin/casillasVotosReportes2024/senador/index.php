...
?>
	...
	<div id="bodymanager" class="bodymanager">
		...
		<?php
		if($tipo_uso_plataforma=='all'){
			echo '<div class="submenux" onclick="subConfiguracionSenadorReportes2024()">Goberandor Reporte '.$ano.'</div> /';
		}
		?>
		<div class="submenux" onclick="subConfiguracionSenadorSeccionesIneReportes2024()">Secciones INE Reportes <?= $ano ?></div> / 
