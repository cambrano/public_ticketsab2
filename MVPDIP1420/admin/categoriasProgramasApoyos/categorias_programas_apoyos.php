<?php
	...
	$sql = "SELECT count(*) total FROM categorias_programas_apoyos WHERE 1 = 1   "; 
	...
	////////////////////////////
	////////////////////////////
	$sql = "SELECT id,clave,nombre FROM categorias_programas_apoyos WHERE 1 = 1  "; 
	...
	if($post_search){
		$sqlContadorScript = "SELECT count(*) total FROM categorias_programas_apoyos WHERE 1 = 1   "; 
