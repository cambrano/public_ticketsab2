	<div style=" width: 100%; display:inline-block; text-align: left;">
		<div class="sucFormTitulo">
			<label class="labelForm" id="labeltemaname">Datos Claves 2</label>
		</div>
		<?php
		foreach ($inputs as $key => $value) {
			if(substr($value, 0, 6)!="forma_"){
				...
				echo "<input class='inputlogin'  type='text' name='{$key}' autocomplete='off' id='{$key}' value='".$clave2Datos[$key]."' placeholder=''  onblur='aMays(event, this)' maxlength='20' /><br>";
				echo "</div>";
			}else{
				echo "<div class='sucForm'>";
				unset($sf_select);
				...
				$sf_select[$clave2Datos[$value]]='selected="selected"';
