	<script type="text/javascript">
		...
		if(!allowedExtensions.exec(filePath)){
			...
			document.getElementById('logo_1').innerHTML = '<img class="responsive" id="imageJs" src="data:image/png;base64,<?= $base64 ?>" alt="Imagen">';
			return false;
		}
	}
	</script>
		...
		<div class="sucForm" style="width: 100%">
			<div id="logo" style="width: 100%; display: table; text-align: center; height;">
				<div id="logo_1" style=" background-color: #fcfbf9; display: block;padding: 5px;text-align: center;">
					<img class="responsive" id="imageJs" src="data:image/png;base64,<?= $base64 ?>" alt="Imagen">
				</div>
			</div>
		</div>
		<div class="sucForm">
