	...
	<div style=" width: 100%; display:inline-block; text-align: left;">
		...
		<div class="sucForm" style="display:none">
			...
			<input class="inputlogin" type="text" name="votos_semaforo_amarillo" autocomplete="off"  id="votos_semaforo_amarillo" value="<?= $configuracion_matriz_rentabilidad_secciones_ine_2016Datos['votos_semaforo_amarillo'] ?>1" placeholder="" onkeypress="return CheckNumeric()" /><br>
		</div>
		...
		<div class="sucForm" <?= $display_municipio ?>>
			...
			<select   name="id_partido_2016_ayuntamiento" id="id_partido_2016_ayuntamiento" class='myselect'>
				<?php echo partidos_2016($configuracion_matriz_rentabilidad_secciones_ine_2016Datos['id_partido_2016_ayuntamiento'],'0'); ?>
			</select>
			<br>
		</div>
		...
		<div class="sucForm" <?= $display_distrito_local ?>>
			...
			<select   name="id_partido_2016_distrito_local" id="id_partido_2016_distrito_local" class='myselect'>
				<?php echo partidos_2016($configuracion_matriz_rentabilidad_secciones_ine_2016Datos['id_partido_2016_distrito_local'],'1'); ?>
			</select>
			<br>
		</div>
		<div class="sucForm" <?= $display_distrito_federal ?>>
			...
			<select   name="id_partido_2016_distrito_federal" id="id_partido_2016_distrito_federal" class='myselect'>
				<?php echo partidos_2016($configuracion_matriz_rentabilidad_secciones_ine_2016Datos['id_partido_2016_distrito_federal'],'2'); ?>
			</select>
			<br>
		</div>
		<div class="sucForm" <?= $display_distrito_gobernador ?>>
			...
			<select   name="id_partido_2016_gobernador" id="id_partido_2016_gobernador" class='myselect'>
				<?php echo partidos_2016($configuracion_matriz_rentabilidad_secciones_ine_2016Datos['id_partido_2016_gobernador'],'3'); ?>
			</select>
			<br>
		</div>
		<div class="sucForm" <?= $display_distrito_senador ?>>
			...
			<select   name="id_partido_2016_senador" id="id_partido_2016_senador" class='myselect'>
				<?php echo partidos_2016($configuracion_matriz_rentabilidad_secciones_ine_2016Datos['id_partido_2016_senador'],'4'); ?>
			</select>
			<br>
		</div>
		<div class="sucFormTitulo">
		...
		<div class="sucForm">
			...
			<select   name="id_partido_legado" id="id_partido_legado" class='myselect'>
				<?php echo partidos_legados($configuracion_matriz_rentabilidad_secciones_ine_2016Datos['id_partido_legado']); ?>
			</select>
			<br>
		</div>
		...
		<div class="sucForm">
			...
			<select   name="id_tipo_categoria_ciudadano" id="id_tipo_categoria_ciudadano" class='myselect'>
				<?php echo tipos_categorias_ciudadanos($configuracion_matriz_rentabilidad_secciones_ine_2016Datos['id_tipo_categoria_ciudadano']); ?>
			</select>
			<br>
		</div>
