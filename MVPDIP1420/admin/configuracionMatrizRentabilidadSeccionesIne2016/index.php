<?php
	...
	if($configuracion_matriz_rentabilidad_secciones_ine_2016Datos['id']!=""){
		$permiso="update";
	}else{
		$permiso="insert";
	}
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			if($tipo_uso_plataforma=='municipio'){
				?>
				var id_partido_2016_ayuntamiento = document.getElementById("id_partido_2016_ayuntamiento").value; 
				if(id_partido_2016_ayuntamiento == ""){
					document.getElementById("id_partido_2016_ayuntamiento").focus(); 
					document.getElementById("sumbmit").disabled = false;
				...
				?>
				var id_partido_2016_distrito_local = document.getElementById("id_partido_2016_distrito_local").value; 
				if(id_partido_2016_distrito_local == ""){
					document.getElementById("id_partido_2016_distrito_local").focus(); 
					document.getElementById("sumbmit").disabled = false;
				...
				?>
				var id_partido_2016_distrito_federal = document.getElementById("id_partido_2016_distrito_federal").value; 
				if(id_partido_2016_distrito_federal == ""){
					document.getElementById("id_partido_2016_distrito_federal").focus(); 
					document.getElementById("sumbmit").disabled = false;
				...
				?>
				var id_partido_2016_gobernador = document.getElementById("id_partido_2016_gobernador").value; 
				if(id_partido_2016_gobernador == ""){
					document.getElementById("id_partido_2016_gobernador").focus(); 
					document.getElementById("sumbmit").disabled = false;
				...
				?>
				var id_partido_2016_senador = document.getElementById("id_partido_2016_senador").value; 
				if(id_partido_2016_senador == ""){
					document.getElementById("id_partido_2016_senador").focus(); 
					document.getElementById("sumbmit").disabled = false;
					$("#mensaje").html("Partido Gobernador requerido");
					document.getElementById("mensaje").classList.add("mensajeError");
					return false;
			...
			if($tipo_uso_plataforma=='municipio'){
				?>
				var configuracion_matriz_rentabilidad_secciones_ine_2016 = []; 
				var data = {
						'votos_semaforo_amarillo' : votos_semaforo_amarillo,
						'id_tipo_categoria_ciudadano' : id_tipo_categoria_ciudadano,
						'id_partido_2016_ayuntamiento' : id_partido_2016_ayuntamiento,
						'id_partido_legado' : id_partido_legado,
					}
				configuracion_matriz_rentabilidad_secciones_ine_2016.push(data);
				<?php
			}elseif($tipo_uso_plataforma=='distrito_local'){
				?>
				var configuracion_matriz_rentabilidad_secciones_ine_2016 = []; 
				var data = {
						'votos_semaforo_amarillo' : votos_semaforo_amarillo,
						'id_tipo_categoria_ciudadano' : id_tipo_categoria_ciudadano,
						'id_partido_2016_distrito_local' : id_partido_2016_distrito_local,
						'id_partido_legado' : id_partido_legado,
					}
				configuracion_matriz_rentabilidad_secciones_ine_2016.push(data);
				<?php
				...
				var data = {
						'votos_semaforo_amarillo' : votos_semaforo_amarillo,
						'id_tipo_categoria_ciudadano' : id_tipo_categoria_ciudadano,
						'id_partido_2016_distrito_federal' : id_partido_2016_distrito_federal,
						'id_partido_legado' : id_partido_legado,
					}
				configuracion_matriz_rentabilidad_secciones_ine_2016.push(data);
				<?php
			...
			$.ajax({
				type: "POST",
				url: "configuracionMatrizRentabilidadSeccionesIne2016/db_add_update.php",
				data: {configuracion_matriz_rentabilidad_secciones_ine_2016: configuracion_matriz_rentabilidad_secciones_ine_2016},
				success: function(data) {
					if(data=="SI"){ 
						document.getElementById("sumbmit").disabled = true;
