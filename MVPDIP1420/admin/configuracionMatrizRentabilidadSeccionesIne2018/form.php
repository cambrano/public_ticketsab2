	...
	<div style=" width: 100%; display:inline-block; text-align: left;">
		...
		<div class="sucForm" style="display:none">
			...
			<input class="inputlogin" type="text" name="votos_semaforo_amarillo" autocomplete="off"  id="votos_semaforo_amarillo" value="<?= $configuracion_matriz_rentabilidad_secciones_ine_2018Datos['votos_semaforo_amarillo'] ?>1" placeholder="" onkeypress="return CheckNumeric()" /><br>
		</div>
		...
		<div class="sucForm" <?= $display_distrito_gobernador ?>>
			...
			<select   name="id_partido_2018_gobernador" id="id_partido_2018_gobernador" class='myselect'>
				<?php echo partidos_2018($configuracion_matriz_rentabilidad_secciones_ine_2018Datos['id_partido_2018_gobernador'],'3'); ?>
			</select>
			<br>
		</div>
		<div class="sucForm" <?= $display_distrito_senador ?>>
			...
			<select   name="id_partido_2018_senador" id="id_partido_2018_senador" class='myselect'>
				<?php echo partidos_2018($configuracion_matriz_rentabilidad_secciones_ine_2018Datos['id_partido_2018_senador'],'4'); ?>
			</select>
			<br>
		</div>
		<div class="sucFormTitulo">
