	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			if($tipo_uso_plataforma=='municipio'){
				...
				?>
				var id_partido_2021_gobernador = document.getElementById("id_partido_2021_gobernador").value; 
				if(id_partido_2021_gobernador == ""){
					document.getElementById("id_partido_2021_gobernador").focus(); 
					document.getElementById("sumbmit").disabled = false;
				...
				?>
				var id_partido_2021_senador = document.getElementById("id_partido_2021_senador").value; 
				if(id_partido_2021_senador == ""){
					document.getElementById("id_partido_2021_senador").focus(); 
					document.getElementById("sumbmit").disabled = false;
					$("#mensaje").html("Partido Gobernador requerido");
					document.getElementById("mensaje").classList.add("mensajeError");
					return false;
