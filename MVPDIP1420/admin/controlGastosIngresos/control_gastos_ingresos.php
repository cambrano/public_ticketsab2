<?php
	...
	$sql = "SELECT count(*) total FROM control_gastos_ingresos WHERE 1 = 1   ";
	...
	////////////////////////////
	////////////////////////////
	$sql = "SELECT id,clave FROM control_gastos_ingresos WHERE 1 = 1  "; 
	...
	if($post_search){
		$sqlContadorScript = "SELECT count(*) total FROM control_gastos_ingresos WHERE 1 = 1   "; 
