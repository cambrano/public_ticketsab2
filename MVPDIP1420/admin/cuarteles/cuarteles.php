<?php
	...
	$sql = "SELECT count(*) total FROM cuarteles WHERE 1 = 1   "; 
	...
	////////////////////////////
	////////////////////////////
	$sql = "SELECT id,clave,nombre FROM cuarteles WHERE 1 = 1  ";
	...
	if($post_search){
		$sqlContadorScript = "SELECT count(*) total FROM cuarteles WHERE 1 = 1   "; 
