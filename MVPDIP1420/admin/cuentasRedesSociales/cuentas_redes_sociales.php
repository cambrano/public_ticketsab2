<?php
	...
	$id_identidadx = decrypt_ab_checkFinal($_COOKIE['paguinaId_1']);
	////////////////////////////
	////////////////////////////
	/// Para saber el total
	...
	if($id_identidad !=""){
		...
		$sql.= " AND crs.id_identidad = '{$id_identidadx}'";
	}
	...
	$id_red_social=$search_database['id_red_social'];
	if($id_red_social !=""){
		$post_search=true;
	...
	$verificado=$search_database['verificado'];
	if($verificado !=""){
		$post_search=true;
