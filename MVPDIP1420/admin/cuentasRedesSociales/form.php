...
?>
	...
	<script type="text/javascript">
		...
		<script type="text/javascript">
			function getCoords(marker){ 
				...
				// Obtiene la longitud del marcador.
				var longitud = marker.getPosition().lng();
				// Concatena latitud y longitud en una sola cadena.
				var latLngString = latitud + ', ' + longitud;

				 // Asigna las coordenadas y la precisión a los campos de entrada en tu formulario HTML.
				document.getElementById("latitud_script1").value = latitud;
				document.getElementById("longitud_script1").value = longitud;
				document.getElementById("precision_script1").value = 1;
				document.getElementById("loc_script1").value = latLngString;				
			}
	...
	<div style=" width: 100%; display:inline-block; text-align: left;">
		...
		<div class="sucForm">
			...
			<input type="text" name="latitud_script1" id="latitud_script1" value="<?= $cuenta_red_socialDatos['latitud_script'] ?>">
		</div>
		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Longitud<font color="#FF0004">*</font></label><br>
			<input type="text" name="longitud_script1" id="longitud_script1" value="<?= $cuenta_red_socialDatos['longitud_script'] ?>">
		</div>
		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Presición<font color="#FF0004">*</font></label><br>
			<input type="text" name="precision_script1" id="precision_script1" value="<?= $cuenta_red_socialDatos['precision_script'] ?>">
		</div>
		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Location<font color="#FF0004">*</font></label><br>
			<input type="text" name="loc_script1" id="loc_script1" value="<?= $cuenta_red_socialDatos['loc_script'] ?>">
		</div>
		<div class="sucForm" style="width: 100%" >
			<br>
			<?php
