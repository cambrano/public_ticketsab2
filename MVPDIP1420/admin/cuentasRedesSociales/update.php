<?php
	...
	if($cuenta_red_socialDatos['clave']==""){
		$cuenta_red_socialDatos['clave']=$claveF['clave'];
	}


	$identidadDatos = identidadDatos($cuenta_red_socialDatos['id_identidad']);
	...
	echo $latitud = $identidadDatos['latitud'];
	echo "<br>";
	echo $longitud = $identidadDatos['longitud'];
	echo "<br>";
...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "cuentasRedesSociales/db_edit.php",
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Modificar Cuenta Red Social</font>
				</label><br>
				<label class="descripcionForm">
					<font style="font-size: 13px;">Campos para modificar a cuenta red social.</font><br><br>
				</label><br>
