...
?>
	<script type="text/javascript">
		...
		function verMasDistritoFederal(valor) {
			link = "seccionesIneReportes2016/distrito_federal/index.php?id=" + valor;
			var link2 = "seccionesIneReportes2016/distrito_federal/index.php";
		...
		function verMasDistritoFederalMatrizRentabilidad(valor) {
			link = "seccionesIneReportes2016MatrizRentabilidad/distrito_federal/index.php?id=" +
					valor;
	...
	<table
		...
		<tbody>
			...
			foreach ($datos_distritos_federales as $key => $value) {
				...
				<span class="btnText">Revocación Mandato 2016</span></button>'; 
			?>
			<tr>
