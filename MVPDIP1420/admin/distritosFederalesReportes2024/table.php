...
?>
	<script type="text/javascript">
		...
		function verMasDistritoFederal(valor) {
			link = "seccionesIneReportes2024/distrito_federal/index.php?id=" + valor;
			var link2 = "seccionesIneReportes2024/distrito_federal/index.php";
		...
		function verMasDistritoFederalMatrizRentabilidad(valor) {
			link = "seccionesIneReportes2024MatrizRentabilidad/distrito_federal/index.php?id=" +
					valor;
	...
	<table
		...
		<tbody>
			...
			foreach ($datos_distritos_federales as $key => $value) {
				...
				<span class="btnText">Revocación Mandato 2024</span></button>'; 
			?>
			<tr>
