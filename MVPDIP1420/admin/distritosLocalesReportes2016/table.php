...
?>
	<script type="text/javascript">
		$(document).ready(function () {
			var dataTable = $('#distritos_locales_reportes-tabla').DataTable({
				"destroy": true,
				"responsive": true,
				"pageLength": 11,
				"retrieve": true,
		...
		function verMasDistritoLocal(valor) {
			link = "seccionesIneReportes2016/distrito_local/index.php?id=" + valor;
			var link2 = "seccionesIneReportes2016/distrito_local/index.php";
		...
		function verMasDistritoLocalMatrizRentabilidad(valor) {
			link = "seccionesIneReportes2016MatrizRentabilidad/distrito_local/index.php?id=" +
					valor;
		...
		function verMasDistritoLocalMandato2022(valor) {
			link = "seccionesIneReportes2022RevocacionMandato/distrito_local/index.php?id=" +
					valor;
			var link2 = "seccionesIneReportes2022RevocacionMandato/distrito_local/index.php";
			dataString = 'urlink=' + link2;
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
	...
	<table
		id="distritos_locales_reportes-tabla"
		...
		<tbody>
			...
			foreach ($datos_distritos_locales as $key => $value) {
				...
				$revocacion_mandato22='<button class="btn btn-info"  onClick="verMasDistritoLocalMandato2022('.$value["id"].');" >
