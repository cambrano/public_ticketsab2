...
?>
	<script type="text/javascript">
		...
		function verMasDistritoLocal(valor) {
			link = "seccionesIneReportes2024/distrito_local/index.php?id=" + valor;
			var link2 = "seccionesIneReportes2024/distrito_local/index.php";
		...
		function verMasDistritoLocalMatrizRentabilidad(valor) {
			link = "seccionesIneReportes2024MatrizRentabilidad/distrito_local/index.php?id=" +
					valor;
