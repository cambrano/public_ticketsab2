	...
	<script>
		...
		function img_frente_reset(){
			...
			if($img_array['frente']['name_img']){
				$mostrarImagenBase64 = mostrarImagenBase64($img_array['frente']['name_img']);
				$mostrarImagenBase64 = "data:image/png;base64,".$mostrarImagenBase64;
				?>
				document.getElementById('chk_frente_origin').checked = true;
				var imagen = document.getElementById("preview_frente");
				imagen.src = '<?= $mostrarImagenBase64 ?>';
				//imagen.hidden = false;
		...
		function img_atras_reset(){
			...
			if($img_array['atras']['name_img']){
				$mostrarImagenBase64 = mostrarImagenBase64($img_array['atras']['name_img']);
				$mostrarImagenBase64 = "data:image/png;base64,".$mostrarImagenBase64;
				?>
		...
		function img_otros_reset(){
			...
			if($img_array['otros']['name_img']){
				$mostrarImagenBase64 = mostrarImagenBase64($img_array['otros']['name_img']);
				$mostrarImagenBase64 = "data:image/png;base64,".$mostrarImagenBase64;
				?>
	...
	<div class="sucForm" style="width: 100%;text-align:center">
		...
		if(!empty($img_array['frente'])){
			...
			if(!empty($img_array['frente']['name_img'])){
				...
				$mostrarImagenBase64 = "data:image/png;base64,".$mostrarImagenBase64;
				?>
				<img id="preview_frente" src="<?= $mostrarImagenBase64 ?>" width="80%" alt="Previsualización" />
				<embed id="pdf_preview_frente" src="#" type="application/pdf" height="300px" style="display:none;" />
				<?php
			}else{
				$mostrarImagenBase64Array = mostrarFilesPDF($img_array['frente']['name_pdf']);
				$mostrarImagenBase64 = "data:".$mostrarImagenBase64Array['tipo'].";base64,".$mostrarImagenBase64Array['file'];
				?>
				<img id="preview_frente" src="#" height="450px" alt="Previsualización" style="display:none;" />
				<embed id="pdf_preview_frente" src="<?= $mostrarImagenBase64 ?>" type="application/pdf"  style="width:80%;height:300px" />
				<?php
			}
		}else{
			?>
	...
	<div class="sucForm" style="width: 100%;text-align:center">
		...
		if(!empty($img_array['atras'])){
			...
			if(!empty($img_array['atras']['name_img'])){
				...
				$mostrarImagenBase64 = "data:image/png;base64,".$mostrarImagenBase64;
				?>
				<img id="preview_atras" src="<?= $mostrarImagenBase64 ?>" width="80%" alt="Previsualización" />
				<embed id="pdf_preview_atras" src="#" type="application/pdf" height="300px" style="display:none;" />
				<?php
			}else{
				$mostrarImagenBase64Array = mostrarFilesPDF($img_array['atras']['name_pdf']);
				$mostrarImagenBase64 = "data:".$mostrarImagenBase64Array['tipo'].";base64,".$mostrarImagenBase64Array['file'];
				?>
				<img id="preview_frente" src="#" height="450px" alt="Previsualización" style="display:none;" />
				<embed id="pdf_preview_frente" src="<?= $mostrarImagenBase64 ?>" type="application/pdf"  style="width:80%;height:300px" />
	...
	<div class="sucForm" style="width: 100%;text-align:center">
		...
		if(!empty($img_array['otros'])){
			...
			if(!empty($img_array['otros']['name_img'])){
				...
				$mostrarImagenBase64 = "data:image/png;base64,".$mostrarImagenBase64;
				?>
				<img id="preview_otros" src="<?= $mostrarImagenBase64 ?>" width="80%" alt="Previsualización" />
				<embed id="pdf_preview_otros" src="#" type="application/pdf" height="300px" style="display:none;" />
				<?php
			}else{
				$mostrarImagenBase64Array = mostrarFilesPDF($img_array['otros']['name_pdf']);
				$mostrarImagenBase64 = "data:".$mostrarImagenBase64Array['tipo'].";base64,".$mostrarImagenBase64Array['file'];
				?>
				<img id="preview_frente" src="#" height="450px" alt="Previsualización" style="display:none;" />
				<embed id="pdf_preview_frente" src="<?= $mostrarImagenBase64 ?>" type="application/pdf"  style="width:80%;height:300px" />
