<?php
	...
	$tablasRelacionadas = tablasRelacionadas('ejes_gobierno',$id);
...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "ejesGobierno/db_delete.php",
				data: dataString,
				success: function(data) { 
					if(data=="SI"){
						document.getElementById("mensaje").classList.remove("mensajeError"); 
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Eliminar Eje Gobierno</font>
				</label>
			</div>
		</div>
		<div class="bodyinput">
			<label class="labelForm" id="labeltemaname">Eje Gobierno</label><br>
			<label class="descripcionForm">
				<strong><?= $eje_gobiernoDatos['nombre']?></strong>
			</label><br>
			<?php
			if($registros_tablas!=''){
