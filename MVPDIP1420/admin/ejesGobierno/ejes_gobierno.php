<?php
	...
	$sql = "SELECT count(*) total FROM ejes_gobierno WHERE 1 = 1   "; 
	...
	////////////////////////////
	////////////////////////////
	$sql = "SELECT id,numero,nombre FROM ejes_gobierno WHERE 1 = 1  "; 
	// getting records as per search parameters
	$numero=$search_database['numero'];
	if( $numero!="" ){   //name
		$post_search=true;
	...
	if($post_search){
		$sqlContadorScript = "SELECT count(*) total FROM ejes_gobierno WHERE 1 = 1   "; 
