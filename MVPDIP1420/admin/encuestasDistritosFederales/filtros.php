...
?>
	<script type="text/javascript">
		function searchTable(value){
			...
			$.ajax({
				type: "POST",
				url: "encuestasDistritosFederales/table.php",
			...
			$.ajax({
				type: "POST",
				url: "encuestasDistritosFederales/mapa.php",
				data: {searchTable: searchTable,mapa:mapa},
				async: true,
				success: function(data) {
					$("#mapaLoad").html(data);
	...
	<div class="sucForm">
		<label class="labelForm" id="labeltemaname">Distrito<br></label><br>
		<select class="selectpicker" multiple data-live-search="true" data-size="5" data-actions-box="true" title="Seleccione" id="id_distrito_federal" onchange="searchTable();">
			<?php
			echo distritos_federales($id_distrito_federal,$id_estado,'SIN');
			?>
		</select><br>
	</div>
