	...
	<div style="background-color: white;padding: 5px;display: table;">
		<div class="div50Reporte" style="padding: 2px; margin: 0px;">
			<table style="table-layout: fixed; width: 100%" cellspacing="0" cellpadding="0">
				<thead>
					<tr>
						<td style="text-align: center;padding: 10px;background-color: #191919;color: white" colspan="3">Municipios Más Encuestados (5)</td>
					</tr>
				</thead>
				<tbody> 
					<?php 
		...
		<div class="div50Reporte" style="padding: 2px; margin: 0px;">
			<table style="table-layout: fixed; width: 100%" cellspacing="0" cellpadding="0">
				<thead>
					<tr>
						<td style="text-align: center;padding: 10px;background-color: #191919;color: white" colspan="3">Municipios Menos Encuestados (5)</td>
					</tr>
				</thead>
				<tbody> 
					<?php 
					$num = 1;
					krsort($datos_municipios);
					foreach ($datos_municipios as $key => $value) {
						if($num <=5){
							$num ++;
							?>
