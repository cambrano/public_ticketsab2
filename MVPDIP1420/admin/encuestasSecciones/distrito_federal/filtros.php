...
?>
	<script type="text/javascript">
		function searchTable(value){
			...
			$.ajax({
				type: "POST",
				url: "encuestasSecciones/distrito_federal/table.php",
			...
			$.ajax({
				type: "POST",
				url: "encuestasSecciones/distrito_federal/mapa.php",
				data: {searchTable: searchTable,mapa:mapa},
				async: true,
				success: function(data) {
					$("#mapaLoad").html(data);
	...
	<div class="sucForm">
		<input type="hidden" name="id_distrito_federal" id = "id_distrito_federal" value="<?= $id_distrito_federal ?>" >
	</div>
	<div class="sucForm">
