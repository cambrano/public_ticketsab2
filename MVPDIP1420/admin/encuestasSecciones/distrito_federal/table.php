	...
	<script type="text/javascript" language="javascript" >
		$(document).ready(function() {
			...
			var dataTable = $('#secciones_ine_ciudadanos_encuestas-tabla').DataTable( {
				...
				"ajax":{
					url :"encuestasSecciones/distrito_federal/secciones_ine_ciudadanos_encuestas.php", // json datasource
		...
		function edit(valor){
			link="encuestasSecciones/distrito_federal/update.php?id="+valor; 
			var link2="encuestasSecciones/distrito_federal/update.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
