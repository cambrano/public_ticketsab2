...
?>
	<script type="text/javascript">
		function searchTable(value){
			...
			$.ajax({
				type: "POST",
				url: "encuestasSecciones/distrito_local/table.php",
			...
			$.ajax({
				type: "POST",
				url: "encuestasSecciones/distrito_local/mapa.php",
				data: {searchTable: searchTable,mapa:mapa},
				async: true,
				success: function(data) {
					$("#mapaLoad").html(data);
	...
	<div class="sucForm">
		<input type="hidden" name="id_distrito_local" id = "id_distrito_local" value="<?= $id_distrito_local ?>" >
	</div>
	<div class="sucForm">
