...
?>
	<div style="text-align: left;padding: 0px 0px 0px 5px;font-size: 8px;color: black;margin-bottom: 20px;margin-top: -13.6px;background-color: rgba(176,176,176,0.6);padding: 5px">
		Ciudadanos: <?=number_format($totales_ciudadanos, 0, '.', ','); ?>
		<br>
		<br>
		Encuestados: <?=number_format($totales_encuestados, 0, '.', ','); ?>
		<br>
		Porcentaje: <?=number_format($totales_encuestados_porcentaje, 2, '.', ','); ?>%
		<br>
		<br>
		No Encuestados: <?=number_format( $totales_no_encuestados, 0, '.', ','); ?>
		<br>
		Porcentaje: <?=number_format($totales_no_encuestados_porcentaje, 2, '.', ','); ?>%
