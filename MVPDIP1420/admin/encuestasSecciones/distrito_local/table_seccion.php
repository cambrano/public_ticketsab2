	...
	<script type="text/javascript" language="javascript" >
		$(document).ready(function() {
			...
			var dataTable = $('#secciones_ine_ciudadanos_encuestas-tabla').DataTable( {
				...
				"ajax":{
					url :"encuestasSecciones/distrito_local/secciones_ine_ciudadanos_encuestas_seccion.php", // json datasource
		...
		function edit(valor){
			link="encuestasSecciones/distrito_local/update_seccion.php?id="+valor; 
			var link2="encuestasSecciones/distrito_local/update_seccion.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
