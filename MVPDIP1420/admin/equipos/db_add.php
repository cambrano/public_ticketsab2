<?php
	...
	if(!empty($_POST)){
		...
		$equipoClaveVerificacion=equipoClaveVerificacion($_POST["equipo"][0]['clave'],'',1);
		...
		$_POST["equipo"][0]['identificador']=$gen_id3.'_'.$cod32;
		...
		$id=$_POST["equipo"][0]['id_equipo']=$conexion->insert_id;
		$log[] = array(
			'id' => $id,
			'tabla' => 'equipos',
			'tipo' => 'Insert',
