	...
	<script type="text/javascript" language="javascript" >
		$(document).ready(function() {
			...
			var dataTable = $('#equipos-tabla').DataTable( {
				...
				"ajax":{
					url :"equipos/equipos.php", // json datasource
			...
			$('#selectCheckbox').on("click", function(event){ // triggering delete one by one
				if( $('.checkselected:checked').length > 0 ){  // at-least one checkbox checked
					...
					var link="equipos/index.php?cot="+ids_string;   
					var link2="equipos/index.php";
		...
		function edit(valor){
			link="equipos/update.php?id="+valor+"&refresh=1"; 
			var link2="equipos/update.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
		...
		function add(){
			////ajax
			link="equipos/create.php?refresh=1";
			var link2="equipos/create.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
		...
		function borrar(valor){
			link="equipos/delete.php?id="+valor; 
			var link2="equipos/delete.php";
			dataString = 'urlink='+link2; 
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
