<?php
	...
	$moduloAccionPermisos = moduloAccionPermisos('operatividad',"equipo_directorios",$_COOKIE["id_usuario"]);
	...
	$id_equipo = $_POST["equipo_directorio"][0]['id'];
	unset($_POST["equipo_directorio"][0]['id_directorio']);

	$equipoClaveVerificacion=equipoClaveVerificacion($_POST["equipo_directorio"][0]["clave"],$_POST["equipo_directorio"][0]['id'],1);
	if($equipoClaveVerificacion){
		$claveF= clave("equipo_directorios");
	...
	if( registrosCompara("equipos",$_POST["equipo_directorio"][0],1)){
		if(!empty($_POST)){ 
			$chk = true;
			$_POST["equipo_directorio"][0]["fechaR"]=$fechaH;
			$_POST["equipo_directorio"][0]["codigo_plataforma"]=$codigo_plataforma;
			$equipoDatos = equipoDatos($_POST["equipo_directorio"][0]["id"]);
			$_POST["equipo_directorio"][0]["identificador"] = $equipoDatos['identificador'];
			foreach($_POST["equipo_directorio"] as $keyPrincipal => $atributos) {
			...
			$update_equipo_directorios = "UPDATE equipos SET ". join(",",$valueSets) . " WHERE id=".$id;
			$conexion->autocommit(FALSE);
			...
			unset($_POST["equipo_directorio"][0]['id']); 
			$id_equipo=$_POST["equipo_directorio"][0]["id_equipo"]=$id;
			$fields_pdo = "`".implode('`,`', array_keys($_POST["equipo_directorio"][0]))."`";
			$values_pdo = "'".implode("','", $_POST["equipo_directorio"][0])."'";
			$insert_equipo_directorios_historicos= "INSERT INTO equipos_historicos ($fields_pdo) VALUES ($values_pdo);";
	...
	$equipos_sistemas_operativos_licenciasDatos = equipos_sistemas_operativos_licenciasDatos('',$_POST["equipo_directorio"][0]['id']);
	...
	//!checamos para eliminar
	$equipos_softwares_licenciasDatos = equipos_softwares_licenciasDatos('',$_POST["equipo_directorio"][0]['id']);
	...
	$equipos_usuariosDatos = equipos_usuariosDatos('',$_POST["equipo_directorio"][0]['id']);
