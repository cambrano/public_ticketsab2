...
<script type="text/javascript">
	function guardarImportacion(){
		...
		var ruta = "importacionesSistema/casillas_preguntas_2022_revocacion_mandato/casillas_preguntas_2022_revocacion_mandato_db_add.php";
...
<?php
	...
	if($tabla=="casillas_preguntas_2022_revocacion_mandato"){
		$columnData = array(
