<?php
	...
	$columnData = array(
		...
		'clave_casillas_votos_2022_revocacion_mandato'=>array('alfanumerico','requerido','buscar_clave','mayuscula'),
		'clave_preguntas_2022_revocacion_mandato'=>array('alfanumerico','requerido','buscar_clave','mayuscula'),
	...
	$usuario=usuarios(); 
	$tipo=1;
	$tabla="casillas_preguntas_2022_revocacion_mandato";
	$numarray=0;
	...
	$primaria="id_casilla_pregunta_2022_revocacion_mandato";
	foreach ($data as $key => $value) {
		...
		if($array_casillas_votos_2022_revocacion_mandato[$value['clave_casillas_votos_2022_revocacion_mandato']] ==""){
			$value['id_casilla_voto_2022_revocacion_mandato'] = claveId($value['clave_casillas_votos_2022_revocacion_mandato'],'casillas_votos_2022_revocacion_mandato');
			$array_casillas_votos_2022_revocacion_mandato[$value['clave_casillas_votos_2022_revocacion_mandato']] = $value['id_casilla_voto_2022_revocacion_mandato'];
			unset($value['clave_casillas_votos_2022_revocacion_mandato']);
			//datos de las secciones para municipio,
			$casilla_voto_2022_revocacion_mandatoDatos = casilla_voto_2022_revocacion_mandatoDatos($value['id_casilla_voto_2022_revocacion_mandato']);
			$array_secciones_ine_datos[$value['id_casilla_voto_2022_revocacion_mandato']] = array(
																			'id_municipio' => $casilla_voto_2022_revocacion_mandatoDatos['id_municipio'],
																			'id_distrito_local' => $casilla_voto_2022_revocacion_mandatoDatos['id_distrito_local'],
																			'id_distrito_federal' => $casilla_voto_2022_revocacion_mandatoDatos['id_distrito_federal'],
																			'id_cuartel' => $casilla_voto_2022_revocacion_mandatoDatos['id_cuartel'],
																		);
			$value['id_municipio'] = $casilla_voto_2022_revocacion_mandatoDatos['id_municipio'];
			$value['id_distrito_local'] = $casilla_voto_2022_revocacion_mandatoDatos['id_distrito_local'];
			$value['id_distrito_federal'] = $casilla_voto_2022_revocacion_mandatoDatos['id_distrito_federal'];
			$value['id_cuartel'] = $casilla_voto_2022_revocacion_mandatoDatos['id_cuartel'];
		}else{
			$value['id_casilla_voto_2022_revocacion_mandato'] = $array_casillas_votos_2022_revocacion_mandato[$value['clave_casillas_votos_2022_revocacion_mandato']];

			$value['id_municipio'] = $array_secciones_ine_datos[$value['id_casilla_voto_2022_revocacion_mandato']]['id_municipio'];
			$value['id_distrito_local'] = $array_secciones_ine_datos[$value['id_casilla_voto_2022_revocacion_mandato']]['id_distrito_local'];
			$value['id_distrito_federal'] = $array_secciones_ine_datos[$value['id_casilla_voto_2022_revocacion_mandato']]['id_distrito_federal'];
			$value['id_cuartel'] = $array_secciones_ine_datos[$value['id_casilla_voto_2022_revocacion_mandato']]['id_cuartel'];

			unset($value['clave_casillas_votos_2022_revocacion_mandato']);

		}

		if($array_preguntas_2022_revocacion_mandato[$value['clave_preguntas_2022_revocacion_mandato']] ==""){
			$value['id_pregunta_2022_revocacion_mandato'] = claveId($value['clave_preguntas_2022_revocacion_mandato'],'preguntas_2022_revocacion_mandato');
			$array_preguntas_2022_revocacion_mandato[$value['clave_preguntas_2022_revocacion_mandato']] = $value['id_pregunta_2022_revocacion_mandato'];
			unset($value['clave_preguntas_2022_revocacion_mandato']);

		}else{
			$value['id_pregunta_2022_revocacion_mandato'] = $array_preguntas_2022_revocacion_mandato[$value['clave_preguntas_2022_revocacion_mandato']];
			unset($value['clave_preguntas_2022_revocacion_mandato']);
