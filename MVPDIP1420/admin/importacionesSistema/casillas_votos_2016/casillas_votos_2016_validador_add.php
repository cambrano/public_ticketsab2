...
<script type="text/javascript">
	function guardarImportacion(){
		...
		var ruta = "importacionesSistema/casillas_votos_2016/casillas_votos_2016_db_add.php";
		...
		while(($line = fgetcsv($csvFile)) !== FALSE){
			...
			if($countdraw > 1){
				...
				foreach ($columnData as $key => $value) {
					...
					if($key=='municipio'){
						$municipioId=municipioIdClave($line_valor,$id_estado);
