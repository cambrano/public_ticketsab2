<?php
	...
	$file_doc = "import/24_Casillas_Actuales_".$xxx_numero.".csv";
	//$file_doc = "import/".$xxx_numero.".csv";
	$handle = fopen($file_doc, "r");
	$columnData = array(
		'clave'=>array('alfanumerico','requerido','unique','unique_db','mayuscula'),
		'clave_tipos_casillas'=>array('alfanumerico','requerido','buscar_clave','mayuscula'),
		'clave_secciones_ine'=>array('alfanumerico','requerido','buscar_clave','mayuscula'),
		/*'municipio'=>array('alfanumerico','requerido'),*/
		/*'clave_distritos_locales'=>array('alfanumerico','requerido','buscar_clave','mayuscula'),*/
		/*'clave_distritos_federales'=>array('alfanumerico','requerido','buscar_clave','mayuscula'),*/
		'codigo'=>array('alfanumerico','requerido'),
		'votos_can_nreg'=>array('alfanumerico','requerido'),
		'votos_nulos'=>array('alfanumerico','requerido'),
		'lista_nominal'=>array('alfanumerico','requerido'),
		'status'=>array('alfanumerico','requerido'),
		'tipo'=>array('alfanumerico','requerido'),
		'tipo_seccion'=>array('alfanumerico','requerido'),
	);
	...
	foreach ($data as $key => $value) {
		...
		if($array_secciones_ine[$value['clave_secciones_ine']] ==""){
			...
			$array_secciones_ine[ $value['clave_secciones_ine'] ] = array(
																			...
																			'id_seccion_ine' => $seccion_ineDatos['id'],
																		);
			$value['id_municipio'] = $seccion_ineDatos['id_municipio'];
			$value['clave_municipio'] = $seccion_ineDatos['clave_municipio'];
			$value['id_distrito_local'] = $seccion_ineDatos['id_distrito_local'];
			$value['clave_distrito_local'] = $seccion_ineDatos['clave_distrito_local'];
			$value['id_distrito_federal'] = $seccion_ineDatos['id_distrito_federal'];
			$value['clave_distrito_federal'] = $seccion_ineDatos['clave_distrito_federal'];
			$value['id_cuartel'] = $seccion_ineDatos['id_cuartel'];
			$value['clave_seccion_ine'] = $value['clave_secciones_ine'];
			$value['id_seccion_ine'] = $seccion_ineDatos['id'];
			unset($value['clave_secciones_ine']);
		}else{
			$value['id_municipio'] = $array_secciones_ine[$value['clave_secciones_ine']]['id_municipio'];
			$value['clave_municipio'] = $array_secciones_ine[$value['clave_secciones_ine']]['clave_municipio'];
			$value['id_distrito_local'] = $array_secciones_ine[$value['clave_secciones_ine']]['id_distrito_local'];
			$value['clave_distrito_local'] = $array_secciones_ine[$value['clave_secciones_ine']]['clave_distrito_local'];
			$value['id_distrito_federal'] = $array_secciones_ine[$value['clave_secciones_ine']]['id_distrito_federal'];
			$value['clave_distrito_federal'] = $array_secciones_ine[$value['clave_secciones_ine']]['clave_distrito_federal'];
			$value['id_cuartel'] = $array_secciones_ine[$value['clave_secciones_ine']]['id_cuartel'];
			$value['clave_seccion_ine'] = $value['clave_secciones_ine'];
			$value['id_seccion_ine'] = $array_secciones_ine[$value['clave_secciones_ine']]['id_seccion_ine'];
			unset($value['clave_secciones_ine']);
		}
