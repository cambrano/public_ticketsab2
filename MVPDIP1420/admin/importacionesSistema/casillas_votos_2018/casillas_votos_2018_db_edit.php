		...
		foreach ($data as $key => $value) {
			...
			if($value['id']!=""){
				...
				if($array_secciones_ine[$value['clave_secciones_ine']] ==""){
					...
					$value['clave_municipio'] = $array_secciones_ine_datos[$value['id_seccion_ine']]['clave_municipio'];
					$value['id_distrito_local'] = $array_secciones_ine_datos[$value['id_seccion_ine']]['id_distrito_local'];
					$value['clave_distrito_local'] = $array_secciones_ine_datos[$value['id_seccion_ine']]['clave_distrito_local'];
					$value['id_distrito_federal'] = $array_secciones_ine_datos[$value['id_seccion_ine']]['id_distrito_federal'];
					$value['clave_distrito_federal'] = $array_secciones_ine_datos[$value['id_seccion_ine']]['clave_distrito_federal'];
