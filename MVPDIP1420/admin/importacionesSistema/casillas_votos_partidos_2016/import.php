<?php
	...
	$usuario=usuarios(); 
	$tipo=1;
	$tabla="casillas_votos_partidos_2016";
	$numarray=0;
	...
	$primaria="id_casilla_voto_partido_2016";
	foreach ($data as $key => $value) {
		...
		if($array_casillas_votos_2016[$value['clave_casillas_votos_2016']] ==""){
			$value['id_casilla_voto_2016'] = clave2Id($value['clave_casillas_votos_2016'],'casillas_votos_2016');
			
			//datos de las secciones para municipio,
			$casilla_voto_2016Datos = casilla_voto_2016Datos($value['id_casilla_voto_2016']);
			
			$value['id_municipio'] = $casilla_voto_2016Datos['id_municipio'];
			$value['clave_municipio'] = $casilla_voto_2016Datos['clave_municipio'];
			$value['id_distrito_local'] = $casilla_voto_2016Datos['id_distrito_local'];
			$value['clave_distrito_local'] = $casilla_voto_2016Datos['clave_distrito_local'];
			$value['id_distrito_federal'] = $casilla_voto_2016Datos['id_distrito_federal'];
			$value['clave_distrito_federal'] = $casilla_voto_2016Datos['clave_distrito_federal'];
			$value['id_cuartel'] = $casilla_voto_2016Datos['id_cuartel'];
			$array_casillas_votos_2016[$value['clave_casillas_votos_2016']] = array(
																			'id_municipio' => $casilla_voto_2016Datos['id_municipio'],
																			'clave_municipio' => $casilla_voto_2016Datos['clave_municipio'],
																			'id_distrito_local' => $casilla_voto_2016Datos['id_distrito_local'],
																			'clave_distrito_local' => $casilla_voto_2016Datos['clave_distrito_local'],
																			'id_distrito_federal' => $casilla_voto_2016Datos['id_distrito_federal'],
																			'clave_distrito_federal' => $casilla_voto_2016Datos['clave_distrito_federal'],
																			'id_cuartel' => $casilla_voto_2016Datos['id_cuartel'],
																			'id_casilla_voto_2016' => $casilla_voto_2016Datos['id'],
																		);
			unset($value['clave_casillas_votos_2016']);
		}else{

			$value['id_casilla_voto_2016'] = $array_casillas_votos_2016[$value['clave_casillas_votos_2016']]['id_casilla_voto_2016'];
			$value['id_municipio'] = $array_casillas_votos_2016[$value['clave_casillas_votos_2016']]['id_municipio'];
			$value['clave_municipio'] = $array_casillas_votos_2016[$value['clave_casillas_votos_2016']]['clave_municipio'];
			$value['id_distrito_local'] = $array_casillas_votos_2016[$value['clave_casillas_votos_2016']]['id_distrito_local'];
			$value['clave_distrito_local'] = $array_casillas_votos_2016[$value['clave_casillas_votos_2016']]['clave_distrito_local'];
			$value['id_distrito_federal'] = $array_casillas_votos_2016[$value['clave_casillas_votos_2016']]['id_distrito_federal'];
			$value['clave_distrito_federal'] = $array_casillas_votos_2016[$value['clave_casillas_votos_2016']]['clave_distrito_federal'];
			$value['id_cuartel'] = $array_casillas_votos_2016[$value['clave_casillas_votos_2016']]['id_cuartel'];
			unset($value['clave_casillas_votos_2016']);

		}

		if($array_partidos_2016[$value['clave_partidos_2016']] ==""){
			$value['id_partido_2016'] = clave2Id($value['clave_partidos_2016'],'partidos_2016');
			$array_partidos_2016[$value['clave_partidos_2016']] = $value['id_partido_2016'];
			unset($value['clave_partidos_2016']);

		}else{
			$value['id_partido_2016'] = $array_partidos_2016[$value['clave_partidos_2016']];
			unset($value['clave_partidos_2016']);
