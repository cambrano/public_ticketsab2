<?php
	...
	$columnData = array(
		...
		'clave_casillas_votos_2021'=>array('alfanumerico','requerido','buscar_clave','mayuscula'),
		'clave_partidos_2021'=>array('alfanumerico','requerido','buscar_clave','mayuscula'),
	...
	$usuario=usuarios(); 
	$tipo=1;
	$tabla="casillas_votos_partidos_2021";
	$numarray=0;
	...
	foreach ($data as $key => $value) {
		...
		if($array_casillas_votos_2021[$value['clave_casillas_votos_2021']] ==""){
			...
			$value['clave_municipio'] = $casilla_voto_2021Datos['clave_municipio'];
			$value['id_distrito_local'] = $casilla_voto_2021Datos['id_distrito_local'];
			$value['clave_distrito_local'] = $casilla_voto_2021Datos['clave_distrito_local'];
			$value['id_distrito_federal'] = $casilla_voto_2021Datos['id_distrito_federal'];
			$value['clave_distrito_federal'] = $casilla_voto_2021Datos['clave_distrito_federal'];
			$value['id_cuartel'] = $casilla_voto_2021Datos['id_cuartel'];
			$array_casillas_votos_2021[$value['clave_casillas_votos_2021']] = array(
																			'id_municipio' => $casilla_voto_2021Datos['id_municipio'],
																			'clave_municipio' => $casilla_voto_2021Datos['clave_municipio'],
																			'id_distrito_local' => $casilla_voto_2021Datos['id_distrito_local'],
																			'clave_distrito_local' => $casilla_voto_2021Datos['clave_distrito_local'],
																			'id_distrito_federal' => $casilla_voto_2021Datos['id_distrito_federal'],
																			'clave_distrito_federal' => $casilla_voto_2021Datos['clave_distrito_federal'],
																			'id_cuartel' => $casilla_voto_2021Datos['id_cuartel'],
																			'id_casilla_voto_2021' => $casilla_voto_2021Datos['id'],
																		);
			unset($value['clave_casillas_votos_2021']);
		}else{

			$value['id_casilla_voto_2021'] = $array_casillas_votos_2021[$value['clave_casillas_votos_2021']]['id_casilla_voto_2021'];
			$value['id_municipio'] = $array_casillas_votos_2021[$value['clave_casillas_votos_2021']]['id_municipio'];
			$value['clave_municipio'] = $array_casillas_votos_2021[$value['clave_casillas_votos_2021']]['clave_municipio'];
			$value['id_distrito_local'] = $array_casillas_votos_2021[$value['clave_casillas_votos_2021']]['id_distrito_local'];
			$value['clave_distrito_local'] = $array_casillas_votos_2021[$value['clave_casillas_votos_2021']]['clave_distrito_local'];
			$value['id_distrito_federal'] = $array_casillas_votos_2021[$value['clave_casillas_votos_2021']]['id_distrito_federal'];
			$value['clave_distrito_federal'] = $array_casillas_votos_2021[$value['clave_casillas_votos_2021']]['clave_distrito_federal'];
			$value['id_cuartel'] = $array_casillas_votos_2021[$value['clave_casillas_votos_2021']]['id_cuartel'];
			unset($value['clave_casillas_votos_2021']);
