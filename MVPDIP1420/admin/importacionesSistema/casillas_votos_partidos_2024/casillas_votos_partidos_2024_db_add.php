<?php
	...
	if(!empty($_POST)){
		...
		$array_casillas_votos_2024 = array();
		
		$array_partidos_2024 =  array();
		...
		foreach ($data as $key => $value) {
			...
			if($array_casillas_votos_2024[$value['clave_casillas_votos_2024']] ==""){
				$value['id_casilla_voto_2024'] = clave2Id($value['clave_casillas_votos_2024'],'casillas_votos_2024');
				$array_casillas_votos_2024[$value['clave_casillas_votos_2024']] = $value['id_casilla_voto_2024'];
				unset($value['clave_casillas_votos_2024']);
				//datos de las secciones para municipio,
				$casilla_voto_2024Datos = casilla_voto_2024Datos($value['id_casilla_voto_2024']);
				$array_secciones_ine_datos[$value['id_casilla_voto_2024']] = array(
				...
				$value['id_casilla_voto_2024'] = $array_casillas_votos_2024[$value['clave_casillas_votos_2024']];

				$value['id_municipio'] = $array_secciones_ine_datos[$value['id_casilla_voto_2024']]['id_municipio'];
				$value['id_distrito_local'] = $array_secciones_ine_datos[$value['id_casilla_voto_2024']]['id_distrito_local'];
				$value['id_distrito_federal'] = $array_secciones_ine_datos[$value['id_casilla_voto_2024']]['id_distrito_federal'];
				$value['id_cuartel'] = $array_secciones_ine_datos[$value['id_casilla_voto_2024']]['id_cuartel'];
