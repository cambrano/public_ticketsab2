<?php
	...
	foreach ($data as $key => $value) {
		...
		$insert_claves_historicos= "INSERT INTO claves_historicos ($fields_pdo) VALUES ($values_pdo);";
		$success=$insert_claves_historicos=$conexion->query($insert_claves_historicos);
		$num=$conexion->affected_rows;
		if(!$insert_claves_historicos || $num=0){
			$success=false;
			echo "ERROR insert_claves_historicos"; 
			var_dump($conexion->error);
		}
