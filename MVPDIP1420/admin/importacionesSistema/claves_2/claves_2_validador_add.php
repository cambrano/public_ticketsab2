...
<script type="text/javascript">
	function guardarImportacion(){
		...
		var ruta = "importacionesSistema/claves_2/claves_2_db_add.php";
...
<?php
	...
	if($tabla=="claves_2"){
		$columnData = array(
					...
					'seccion_ine_ciudadano_gira'=>array('alfanumerico','requerido','mayuscula'),
					'forma_seccion_ine_ciudadano_gira'=>array('alfanumerico','requerido','mayuscula'),
					...
					'tipo_gira'=>array('alfanumerico','requerido','mayuscula'),
					'forma_tipo_gira'=>array('alfanumerico','requerido','mayuscula'),
				);
	}
