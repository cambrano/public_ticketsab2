...
<script type="text/javascript">
	function guardarImportacion(){
		...
		var ruta = "importacionesSistema/claves_2/claves_2_db_edit.php";
...
<?php
	...
	if($tabla=="claves_2"){
		$columnData = array(
					'empresa_adjudicada'=>array('alfanumerico','','mayuscula'),
					'forma_empresa_adjudicada'=>array('alfanumerico','','mayuscula'),

					'supervisor'=>array('alfanumerico','','mayuscula'),
					'forma_supervisor'=>array('alfanumerico','','mayuscula'),

					'seccion_ine_gira'=>array('alfanumerico','','mayuscula'),
					'forma_seccion_ine_gira'=>array('alfanumerico','','mayuscula'),

					'seccion_ine_ciudadano_gira'=>array('alfanumerico','','mayuscula'),
					'forma_seccion_ine_ciudadano_gira'=>array('alfanumerico','','mayuscula'),


					'partido_2016'=>array('alfanumerico','','mayuscula'),
					'forma_partido_2016'=>array('alfanumerico','','mayuscula'),

					'casilla_voto_2016'=>array('alfanumerico','','mayuscula'),
					'forma_casilla_voto_2016'=>array('alfanumerico','','mayuscula'),

					'partido_2024'=>array('alfanumerico','','mayuscula'),
					'forma_partido_2024'=>array('alfanumerico','','mayuscula'),
