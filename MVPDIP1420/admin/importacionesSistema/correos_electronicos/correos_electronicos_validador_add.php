...
<script type="text/javascript">
	function guardarImportacion(){
		...
		var ruta = "importacionesSistema/correos_electronicos/correos_electronicos_db_add.php";
...
<?php
	...
	if($tabla=="correos_electronicos"){
		$columnData = array(
			...
			'clave_servidores_correos'=>array('alfanumerico','requerido','buscar_clave','mayuscula'),
			...
			'correo_electronico_recuperacion'=>array('correo_electronico','requerido'),
		);
	}
