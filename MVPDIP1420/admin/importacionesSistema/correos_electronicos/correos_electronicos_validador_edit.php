...
<script type="text/javascript">
	function guardarImportacion(){
		...
		var ruta = "importacionesSistema/correos_electronicos/correos_electronicos_db_edit.php";
...
<?php
	...
	if($tabla=="correos_electronicos"){
		$columnData = array(
			...
			'clave_servidores_correos'=>array('alfanumerico','','buscar_clave','mayuscula'),
			'fecha_emision'=>array('fecha',''),
			'hora_emision'=>array('hora',''),
			'usuario'=>array('alfanumerico',''),
			'password'=>array('alfanumerico',''),
			'telefono'=>array('telefono',''),
			'correo_electronico_recuperacion'=>array('correo_electronico',''),
		);
	}
	//echo "<pre>";
	//print_r($columnData);
