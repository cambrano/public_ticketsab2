...
<script type="text/javascript">
	function guardarImportacion(){
		...
		var ruta = "importacionesSistema/cuentas_redes_sociales/cuentas_redes_sociales_db_edit.php";
...
<?php
	...
	if($tabla=="cuentas_redes_sociales"){
		$columnData = array(
			...
			'clave_identidades'=>array('alfanumerico','','buscar_clave','mayuscula'),
			'clave_redes_sociales'=>array('alfanumerico','','buscar_clave','mayuscula'),
			'fecha_emision'=>array('fecha',''),
			'hora_emision'=>array('hora',''),
			'usuario'=>array('alfanumerico',''),
			'password'=>array('alfanumerico',''),
			'correo_electronico'=>array('correo_electronico',''),
			'telefono'=>array('telefono',''),
			'url'=>array('alfanumerico',''),
			'verificado'=>array('alfanumerico',''),
		);
	}
