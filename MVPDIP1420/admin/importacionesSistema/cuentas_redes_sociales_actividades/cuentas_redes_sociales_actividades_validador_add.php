...
<script type="text/javascript">
	function guardarImportacion(){
		...
		var ruta = "importacionesSistema/cuentas_redes_sociales_actividades/cuentas_redes_sociales_actividades_db_add.php";
...
<?php
	...
	if($tabla=="cuentas_redes_sociales_actividades"){
		$columnData = array(
			'clave'=>array('alfanumerico','requerido','unique','unique_db','mayuscula'),
			'clave_identidades'=>array('alfanumerico','requerido','buscar_clave','mayuscula'),
			'clave_cuentas_redes_sociales'=>array('alfanumerico','requerido','buscar_clave','mayuscula'),
			'clave_redes_sociales'=>array('alfanumerico','requerido','buscar_clave','mayuscula'),
			'fecha_emision'=>array('fecha','requerido'),
			'hora_emision'=>array('hora','requerido'),
			'clave_tipos_actividades'=>array('alfanumerico','requerido','buscar_clave','mayuscula'),
			'url'=>array('alfanumerico','requerido'),
			'detalle'=>array('alfanumerico','requerido'),
		);
	}
