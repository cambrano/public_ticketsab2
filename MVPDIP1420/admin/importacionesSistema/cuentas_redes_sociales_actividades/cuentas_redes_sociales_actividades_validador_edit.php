...
<script type="text/javascript">
	function guardarImportacion(){
		...
		var ruta = "importacionesSistema/cuentas_redes_sociales_actividades/cuentas_redes_sociales_actividades_db_edit.php";
...
<?php
	...
	if($tabla=="cuentas_redes_sociales_actividades"){
		$columnData = array(
			...
			'clave_secciones_ine_ciuddanos'=>array('alfanumerico','','buscar_clave','mayuscula'),
			'clave_encuestas'=>array('alfanumerico','','buscar_clave','mayuscula'),
			'fecha'=>array('fecha',''),
			'hora'=>array('hora',''),
