...
<script type="text/javascript">
	function guardarImportacion(){
		...
		var ruta = "importacionesSistema/cuestionarios/cuestionarios_db_add.php";
...
<?php
	...
	if($tabla=="cuestionarios"){
		$columnData = array(
			...
			'cantidad'=>array('alfanumerico','requerido'),
			'tipo'=>array('alfanumerico','requerido'),
			'campo'=>array('alfanumerico','requerido'),
			'requerido'=>array('alfanumerico','requerido','valor_si_no'),
			'pregunta'=>array('alfanumerico','requerido'),
		);
	}
