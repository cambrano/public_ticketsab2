...
<script type="text/javascript">
	function guardarImportacion(){
		...
		var ruta = "importacionesSistema/ejes_gobierno/ejes_gobierno_db_edit.php";
...
<?php
	...
	if($tabla=="ejes_gobierno"){
		$columnData = array(
					'numero'=>array('alfanumerico','requerido','unique','unique_db','mayuscula'),
