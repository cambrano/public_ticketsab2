		...
		foreach ($data as $key => $value) {
			...
			if($value['id']!=""){
				if($tabla=="empresas_adjudicadas"){
					$primaria="id_empresa_adjudicada";
				}
				//$value['fechaR']=$fechaH;
				...
				if($status_comparacion){
					...
					$value['representante_nombre_completo'] = $value['representante_nombre'].' '.$value['representante_apellido_paterno'].' '.$value['representante_apellido_materno'];
