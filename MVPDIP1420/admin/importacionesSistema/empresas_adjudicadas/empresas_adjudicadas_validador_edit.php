...
<script type="text/javascript">
	function guardarImportacion(){
		...
		var ruta = "importacionesSistema/empresas_adjudicadas/empresas_adjudicadas_db_edit.php";
...
<?php
	...
	if($tabla=="empresas_adjudicadas"){
		$columnData = array(
					'clave'=>array('alfanumerico','requerido','unique','unique_db','mayuscula'),
					'nombre'=>array('alfanumerico','requerido'),
					'representante_nombre'=>array('alfanumerico','requerido'),
					'representante_apellido_paterno'=>array('alfanumerico','requerido'),
					'representante_apellido_materno'=>array('alfanumerico','requerido'),
					'correo_electronico'=>array('correo_electronico',''),
					'telefono'=>array('alfanumerico',''),
					'celular'=>array('alfanumerico',''),
					'whatsapp'=>array('alfanumerico',''),
