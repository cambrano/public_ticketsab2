...
<script type="text/javascript">
	function guardarImportacion(){
		...
		var ruta = "importacionesSistema/preguntas_2022_revocacion_mandato/preguntas_2022_revocacion_mandato_db_add.php";
...
<?php
	...
	if($tabla=="preguntas_2022_revocacion_mandato"){
		$columnData = array(
				'clave'=>array('alfanumerico','requerido','unique','unique_db','mayuscula'),
				'nombre_corto'=>array('alfanumerico','requerido'),
				'nombre'=>array('alfanumerico','requerido'),
				'icono'=>array('alfanumerico','requerido'),
				'logo'=>array('alfanumerico','requerido'),
				'color_border'=>array('alfanumerico','requerido'),
				'color_background'=>array('alfanumerico','requerido'),
