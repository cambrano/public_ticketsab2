<?php
	...
	if(!empty($_POST)){
		...
		$primaria="id_programa_apoyo_categoria";
		foreach ($data as $key => $value) {
			...
			if($array_programas_apoyos[$value['clave_programas_apoyos']] ==""){
				$value['id_programa_apoyo'] = claveId($value['clave_programas_apoyos'],'programas_apoyos');
				$array_programas_apoyos[$value['clave_programas_apoyos']] = $value['id_programa_apoyo'];
				unset($value['clave_programas_apoyos']);
			}else{
				$value['id_programa_apoyo'] = $array_programas_apoyos[$value['clave_programas_apoyos']];
				unset($value['clave_programas_apoyos']);
			}

			if($array_categorias_programas_apoyos[$value['clave_categorias_programas_apoyos']] ==""){
				$value['id_categoria_programa_apoyo'] = claveId($value['clave_categorias_programas_apoyos'],'categorias_programas_apoyos');
				$array_categorias_programas_apoyos[$value['clave_categorias_programas_apoyos']] = $value['id_categoria_programa_apoyo'];
				unset($value['clave_categorias_programas_apoyos']);
			}else{
				$value['id_categoria_programa_apoyo'] = $array_categorias_programas_apoyos[$value['clave_categorias_programas_apoyos']];
				unset($value['clave_categorias_programas_apoyos']);
			}
