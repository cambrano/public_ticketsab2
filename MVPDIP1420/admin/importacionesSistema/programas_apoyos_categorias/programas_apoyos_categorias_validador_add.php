...
<script type="text/javascript">
	function guardarImportacion(){
		...
		var ruta = "importacionesSistema/programas_apoyos_categorias/programas_apoyos_categorias_db_add.php";
...
<?php
	...
	if($tabla=="programas_apoyos_categorias"){
		$columnData = array(
			'clave_programas_apoyos'=>array('alfanumerico','requerido','buscar_clave','mayuscula'),
			'clave_categorias_programas_apoyos'=>array('alfanumerico','requerido','buscar_clave','mayuscula'),
		);
	}
