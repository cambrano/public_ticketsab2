<?php
	...
	if(!empty($_POST)){
		...
		$primaria="id_programa_apoyo_dependencia";
		foreach ($data as $key => $value) {
			...
			if($array_dependencias[$value['clave_dependencias']] ==""){
				$value['id_dependencia'] = claveId($value['clave_dependencias'],'dependencias');
				$array_dependencias[$value['clave_dependencias']] = $value['id_dependencia'];
				unset($value['clave_dependencias']);
			}else{
				$value['id_dependencia'] = $array_dependencias[$value['clave_dependencias']];
				unset($value['clave_dependencias']);
			}
