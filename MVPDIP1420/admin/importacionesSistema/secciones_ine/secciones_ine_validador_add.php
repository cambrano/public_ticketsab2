...
<script type="text/javascript">
	function guardarImportacion(){
		...
		var ruta = "importacionesSistema/secciones_ine/secciones_ine_db_add.php";
...
<?php
	...
	if($tabla=="secciones_ine"){
		$columnData = array(
				...
				'clave_cuarteles'=>array('alfanumerico','requerido','buscar_clave','mayuscula'),
				'municipio'=>array('alfanumerico','requerido'),
				'numero'=>array('alfanumerico','requerido'),
				'latitud'=>array('alfanumerico','requerido'),
				'longitud'=>array('alfanumerico','requerido'),
