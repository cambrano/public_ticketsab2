...
<script type="text/javascript">
	function guardarImportacion(){
		...
		var ruta = "importacionesSistema/secciones_ine_actividades/secciones_ine_actividades_db_add.php";
...
<?php
	...
	if($tabla=="secciones_ine_actividades"){
		$columnData = array(
			...
			'numero_contrato' =>array('alfanumerico','requerido'),
			'cedula' =>array('alfanumerico','requerido'),
			'clave_empresas_adjudicadas'=>array('alfanumerico','requerido','buscar_clave','mayuscula'),
			'clave_supervisores'=>array('alfanumerico','requerido','buscar_clave','mayuscula'),

			'monto_total'=>array('alfanumerico','requerido'),
			'beneficiarios'=>array('alfanumerico','requerido'),
			'meta_cantidad'=>array('alfanumerico','requerido'),
			'id_unidad_medida'=>array('alfanumerico','requerido'),
			
			'tipo'=>array('alfanumerico','requerido'),
			'id_tipo_infraestructura'=>array('alfanumerico','requerido'),
			'fecha_inicio'=>array('fecha','requerido'),
			'fecha_final'=>array('fecha','requerido'),
