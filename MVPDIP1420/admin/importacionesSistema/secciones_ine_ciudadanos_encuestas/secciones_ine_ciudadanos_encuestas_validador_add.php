...
<script type="text/javascript">
	function guardarImportacion(){
		...
		var ruta = "importacionesSistema/secciones_ine_ciudadanos_encuestas/secciones_ine_ciudadanos_encuestas_db_add.php";
...
<?php
	...
	if($tabla=="secciones_ine_ciudadanos_encuestas"){
		$columnData = array(
