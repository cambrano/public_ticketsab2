<?php
	...
	$file_doc = "import/35_ciudadanos_respuestas_".$xxx_numero.".csv";
	$handle = fopen($file_doc, "r");
	$columnData = array(
		'clave_secciones_ine_ciudadanos_encuestas'=>array('alfanumerico','requerido','buscar_clave','mayuscula'),
	...
	$usuario=usuarios(); 
	$tipo=1;
	$tabla="secciones_ine_ciudadanos_encuestas_respuestas";
	$numarray=0;
	...
	foreach ($data as $key => $value) {
		...
		if($array_secciones_ine_ciudadanos_encuestas_datos[$value['clave_secciones_ine_ciudadanos_encuestas']] ==""){
			unset($array_secciones_ine_ciudadanos_encuestas_datos);
			$claveIdDatos = claveIdDatos($value['clave_secciones_ine_ciudadanos_encuestas'],'secciones_ine_ciudadanos_encuestas');
			...
			$array_secciones_ine_ciudadanos_encuestas_datos[$value['clave_secciones_ine_ciudadanos_encuestas']]['id_seccion_ine_ciudadano_encuesta'] = $value['id_seccion_ine_ciudadano_encuesta'];
			$array_secciones_ine_ciudadanos_encuestas_datos[$value['clave_secciones_ine_ciudadanos_encuestas']]['id_seccion_ine'] = $claveIdDatos['id_seccion_ine'];
			$array_secciones_ine_ciudadanos_encuestas_datos[$value['clave_secciones_ine_ciudadanos_encuestas']]['id_seccion_ine_ciudadano'] = $claveIdDatos['id_seccion_ine_ciudadano'];
			$array_secciones_ine_ciudadanos_encuestas_datos[$value['clave_secciones_ine_ciudadanos_encuestas']]['id_municipio'] = $claveIdDatos['id_municipio'];
			$array_secciones_ine_ciudadanos_encuestas_datos[$value['clave_secciones_ine_ciudadanos_encuestas']]['id_distrito_local'] = $claveIdDatos['id_distrito_local'];
			$array_secciones_ine_ciudadanos_encuestas_datos[$value['clave_secciones_ine_ciudadanos_encuestas']]['id_distrito_federal'] = $claveIdDatos['id_distrito_federal'];
			$array_secciones_ine_ciudadanos_encuestas_datos[$value['clave_secciones_ine_ciudadanos_encuestas']]['fecha'] = $claveIdDatos['fecha'];
			$array_secciones_ine_ciudadanos_encuestas_datos[$value['clave_secciones_ine_ciudadanos_encuestas']]['hora'] = $claveIdDatos['hora'];
			unset($claveIdDatos);
			unset($value['clave_secciones_ine_ciudadanos_encuestas']);
		}else{

			$value['id_seccion_ine_ciudadano_encuesta'] = $array_secciones_ine_ciudadanos_encuestas_datos[$value['clave_secciones_ine_ciudadanos_encuestas']]['id_seccion_ine_ciudadano_encuesta'];
