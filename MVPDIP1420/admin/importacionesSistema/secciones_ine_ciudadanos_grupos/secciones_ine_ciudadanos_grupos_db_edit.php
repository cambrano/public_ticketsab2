<?php
	...
	if(!empty($_POST)){
		...
		foreach ($data as $key => $value) {
			...
			if($value['id']!=""){
				if($tabla=="secciones_ine_ciudadanos_grupos"){
					$primaria="id_seccion_ine_ciudadano_grupo";
				}

				if($array_secciones_ine_grupos[$value['clave_secciones_ine_grupos']] ==""){
					$value['id_seccion_ine_grupo'] = claveId($value['clave_secciones_ine_grupos'],'secciones_ine_grupos');
					$array_secciones_ine_grupos[$value['clave_secciones_ine_grupos']] = $value['id_seccion_ine_grupo'];
					unset($value['clave_secciones_ine_grupos']);
				}else{
					$value['id_seccion_ine_grupo'] = $array_secciones_ine_grupos[$value['clave_secciones_ine_grupos']];
					unset($value['clave_secciones_ine_grupos']);
				}
