...
<script type="text/javascript">
	function guardarImportacion(){
		...
		var ruta = "importacionesSistema/secciones_ine_ciudadanos_grupos/secciones_ine_ciudadanos_grupos_db_edit.php";
...
<?php
	...
	if($tabla=="secciones_ine_ciudadanos_grupos"){
		$columnData = array(
				...
				'clave_secciones_ine_grupos'=>array('alfanumerico','','buscar_clave','mayuscula'),
				'clave_secciones_ine_ciudadanos'=>array('alfanumerico','','buscar_clave','mayuscula'),
				'fecha'=>array('fecha',''),
				'hora'=>array('hora',''),
				'id_tipo_nombramiento'=>array('alfanumerico',''),


				'fecha_inicio'=>array('fecha',''),
				'fecha_final'=>array('fecha',''),
				'correo_electronico'=>array('correo_electronico',''),
				'whatsapp'=>array('telefono',''),
