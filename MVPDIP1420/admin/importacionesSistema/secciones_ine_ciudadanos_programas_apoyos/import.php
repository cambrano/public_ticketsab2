<?php
	...
	echo "<br>";
	//debemes poner el ultimo archivo
	$fin_importacion=23;
	...
	$file_doc = "import/42_ciudadanos_programas_apoyos_".$xxx_numero.".csv";
	...
	$usuario=usuarios(); 
	$tipo=1;
	$tabla="secciones_ine_ciudadanos_programas_apoyos";
	$numarray=0;
	...
	$primaria="id_seccion_ine_ciudadano_programa_apoyo";
