<?php
	...
	$sql = "SELECT count(*) total FROM log_usuarios_tracking WHERE 1 = 1  "; 
	...
	$sql = "SELECT 
				...
				domain,
				user_agent
			FROM log_usuarios_tracking WHERE 1 = 1  "; 
	$sql .= ' AND id_usuario !=1 ';
	...
	if($id_usuario!=""){
		...
		$sqlContador .= " AND id_usuario = '{$id_usuario}' ";
	}
	...
	if($post_search){
		$sqlContadorScript = "SELECT count(*) total FROM log_usuarios_tracking WHERE 1 = 1  "; 
