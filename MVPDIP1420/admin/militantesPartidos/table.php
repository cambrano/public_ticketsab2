	...
	<script type="text/javascript" language="javascript" >
		$(document).ready(function() {
			...
			var dataTable = $('#militantes_partidos-tabla').DataTable( {
				...
				"ajax":{
					url :"militantesPartidos/militantes_partidos.php", // json datasource
			...
			$('#selectCheckbox').on("click", function(event){ // triggering delete one by one
				if( $('.checkselected:checked').length > 0 ){  // at-least one checkbox checked
					...
					var link="militantesPartidos/index.php?cot="+ids_string;   
		...
		function edit(valor){
			link="militantesPartidos/update.php?id="+valor; 
			var link2="militantesPartidos/update.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
		...
		function add(){
			////ajax
			link="militantesPartidos/create.php";
			var link2="militantesPartidos/create.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
		...
		function borrar(valor){
			link="militantesPartidos/delete.php?id="+valor; 
			var link2="militantesPartidos/delete.php";
			dataString = 'urlink='+link2; 
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
		...
		function militantes_partidosCredenciales(valor){
			link="militantesPartidosCredenciales/index.php?cot="+valor+"&refresh=1"; 
			var link2="militantesPartidosCredenciales/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
