<?php
	...
	$filename = 'PartidosMilitantes_-_'.date("Ymd-His").'-'.$gen_id3.$mk_id.'.xlsx';
	...
	*/
	...
	$keywords = array('Partidos Militantes','Data','Información');
	$writer->setTitle('Partidos Militantes Ciudadanos');
	...
	$excel_head = array(
		...
		4 => array('row' => 'fecha_hora' ,'nombre' => 'Fecha Hora Registro' ,'tipo' => 'string','mostrar' => 1 ),
