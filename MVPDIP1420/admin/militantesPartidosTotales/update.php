<?php
	...
	echo $redirectSecurity=redirectSecurity($id,'militantes_partidos','militantesPartidosTotales','index');
	if($redirectSecurity!=""){
		die;
	}
	...
	<script language="javascript" type="text/javascript">
		function cerrar(){
			urlink="militantesPartidosTotales/index.php";
