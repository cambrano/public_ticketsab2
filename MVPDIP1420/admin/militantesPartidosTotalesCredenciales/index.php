<?php
	...
	if($_GET['refresh']==1){
		...
		setcookie("paguinaId_2",encrypt_ab_check($id_militante_partido), array('expires' => time() + (60*60*24), 'path' => '/', 'secure' => true, 'httponly' => true, 'samesite' => 'Strict'));
		die;
	}else{
		$id_militante_partido = decrypt_ab_checkFinal($_COOKIE['paguinaId_2']);
	}
