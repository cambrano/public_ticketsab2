...
?>
	<script type="text/javascript">
		...
		function verMasMunicipio(valor) {
			link = "seccionesIneReportes2016/municipio/index.php?id=" + valor;
			var link2 = "seccionesIneReportes2016/municipio/index.php";
		...
		function verMasMunicipioMatrizRentabilidad(valor) {
			link = "seccionesIneReportes2016MatrizRentabilidad/municipio/index.php?id=" +
					valor;
		...
		function verMasMunicipioMandato2022(valor) {
			link = "seccionesIneReportes2022RevocacionMandato/municipio/index.php?id=" + valor;
