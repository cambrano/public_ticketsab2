<?php
	...
	echo $redirectSecurity=redirectSecurity($id,'partidos_2016','partidos2016','index');
	//var_dump($redirectSecurity);
	if($redirectSecurity!=""){
		die;
	}

	$claveF= clave2('partidos_2016');
	$partido_2016Datos=partido_2016Datos($id);
	if($partido_2016Datos['clave']==""){
		$partido_2016Datos['clave']=$claveF['clave'];
	}
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			partido_2016.push(data);
			$.ajax({
				type: "POST",
				url: "partidos2016/db_edit.php",
				data: {partido_2016: partido_2016},
				success: function(data) {
