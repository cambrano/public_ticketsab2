<?php
	...
	$filename = 'PartidosLegados_-_'.date("Ymd-His").'-'.$gen_id3.$mk_id.'.xlsx';
	...
	*/
	...
	$keywords = array('Partidos Legados','Data','Información');
	$writer->setTitle('Partidos Legados');
	...
	$result = $conexion->query($decryptedQuery);
	$color_reg = 1;
