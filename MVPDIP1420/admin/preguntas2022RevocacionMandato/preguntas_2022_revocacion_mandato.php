<?php
	...
	$sql = "SELECT count(*) total FROM preguntas_2022_revocacion_mandato WHERE 1 = 1   "; 
	/*
	if($tipo_uso_plataforma=='municipio'){
		$sql.=" AND tipo = '0' ";
		$search_database['tipo'] = 0;
	}elseif($tipo_uso_plataforma=='distrito_local'){
		$sql.=" AND tipo = '1' ";
		$search_database['tipo'] = 1;
	}elseif($tipo_uso_plataforma=='distrito_federal'){
		$sql.=" AND tipo = '2' ";
		$search_database['tipo'] = 2;
	}
	*/
	...
	$sql = "
		SELECT 
			...
			END as tipo
		FROM preguntas_2022_revocacion_mandato WHERE 1 = 1  "; 
	...
	if($post_search){
		$sqlContadorScript = "SELECT count(*) total FROM preguntas_2022_revocacion_mandato WHERE 1 = 1   "; 
