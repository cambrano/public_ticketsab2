...
?>
	...
	<div class="sucForm">
		...
		<input data-column="1" id="folio" autocomplete="off" type="text" onkeyup="searchTable();" > <br>
	</div>
	...
	<div class="sucForm">
		<label class="labelForm" id="labeltemaname">Tipos Territorios</label><br>
		<select class="selectpicker" multiple data-live-search="true" data-size="5" data-actions-box="true" title="Seleccione" id="id_tipo_territorio" onchange="searchTable();">
			<?php
			echo tipos_territorios('','SIN');
			?>
		</select><br>
	</div>
	<div class="sucForm">
		<label class="labelForm" id="labeltemaname">Dependencias</label><br>
		<select class="selectpicker" multiple data-live-search="true" data-size="5" data-actions-box="true" title="Seleccione" id="id_dependencia" onchange="searchTable();">
			<?php
