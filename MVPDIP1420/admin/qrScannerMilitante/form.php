...
<div style=" width: 100%; display:inline-block; text-align: left;">
	<div class="sucFormTitulo">
		<label class="labelForm" id="labeltemaname">Código QR Militante</label>
	</div>
	...
	<script src="qrScannerMilitante/jsQR.js"></script>
	...
	<div class="sucForm">
		...
		<input class="inputlogin" type="text"  name="clave" autocomplete="off"  id="clave" value="<?= $seccion_ine_ciudadanoDatos['clave'] ?>" placeholder="Clave" onblur="aMays(event, this)" size="40" readonly/><br>
	</div>
	<div class="sucForm">
	...
	<script type="text/javascript">
		...
		function cambioCamara(value) {
			...
			$.ajax({
				type: "POST",
				url: "qrScannerMilitante/camara.php",
				data: { camara: camara },
				success: function(data) {
		...
		function reiniciarEscaneo() {
			...
			$.ajax({
				type: "POST",
				url: "qrScannerMilitante/delete.php",
				dataType: 'json',
				data: { scaneo: scaneo },
				success: function(data) {
				}
				...
				if (code) {
					if(code.data!=''){
						...
						setTimeout(function () {
							...
							$.ajax({
								type: "POST",
								url: "qrScannerMilitante/data.php",
								dataType: 'json',
								data: { scaneo: scaneo },
								success: function(data) {
...
<script type="text/javascript">
	function borrar(){
		...
		link="seccionesIneMilitantes/deleterapid.php?id="+id; 
		var link2="seccionesIneMilitantes/delete.php";
	...
	function edit(){
		...
		link="seccionesIneMilitantes/updaterapid.php?id="+id; 
		var link2="seccionesIneMilitantes/update.php";
		dataString = 'urlink='+link2;  
		$.ajax({
			type: "POST",
			url: "functions/backarray.php",
	...
	function secciones_ine_ciudadanos_expediente(){
		...
		var link="seccionesIneMilitantes/print/index.php?cot="+expediente;
		window.open(link); 
		return false;
	}
	function documentos_oficiales(){
		...
		link="documentosOficialesMilitantes/index.php?cot="+id; 
		var link2="documentosOficialesMilitantes/index.php";
		dataString = 'urlink='+link2;  
		$.ajax({
			type: "POST",
			url: "functions/backarray.php",
	...
	function secciones_ine_gira(){
		...
		link="seccionesIneMilitantesGiras/index.php?cot="+id; 
		var link2="seccionesIneMilitantesGiras/index.php";
		dataString = 'urlink='+link2;  
		$.ajax({
			type: "POST",
			url: "functions/backarray.php",
	...
	function programas_apoyos(){
		...
		link="seccionesIneMilitantesProgramasApoyos/index.php?cot="+id; 
		var link2="seccionesIneMilitantesProgramasApoyos/index.php";
		dataString = 'urlink='+link2;  
		$.ajax({
			type: "POST",
			url: "functions/backarray.php",
	...
	function ciudadano_categoria(){
		...
		link="seccionesIneMilitantesCategorias/index.php?cot="+id; 
		var link2="seccionesIneMilitantesCategorias/index.php";
		dataString = 'urlink='+link2;  
		$.ajax({
			type: "POST",
			url: "functions/backarray.php",
	...
	function encuestas(){
		...
		link="seccionesIneMilitantesEncuestas/index.php?cot="+id; 
		var link2="seccionesIneMilitantesEncuestas/index.php";
		dataString = 'urlink='+link2;  
		$.ajax({
			type: "POST",
			url: "functions/backarray.php",
	...
	function seguimientos(){
		...
		link="seccionesIneMilitantesSeguimientos/index.php?cot="+id; 
		var link2="seccionesIneMilitantesSeguimientos/index.php";
		dataString = 'urlink='+link2;  
		$.ajax({
			type: "POST",
			url: "functions/backarray.php",
	...
	function secciones_ine_ciudadanos_grupos(){
		...
		link="seccionesIneMilitantesGrupos/index.php?cot="+id; 
		var link2="seccionesIneMilitantesGrupos/index.php";
		dataString = 'urlink='+link2;  
		$.ajax({
			type: "POST",
			url: "functions/backarray.php",
