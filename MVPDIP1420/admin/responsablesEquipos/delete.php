<?php
	...
	$tablasRelacionadas = tablasRelacionadas('responsables_equipos',$id);
...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "responsablesEquipos/db_delete.php",
				data: dataString,
				success: function(data) { 
					if(data=="SI"){
						document.getElementById("mensaje").classList.remove("mensajeError"); 
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Eliminar Responsable de Equipo</font>
				</label>
			</div>
		</div>
		<div class="bodyinput">
			<label class="labelForm" id="labeltemaname">Responsable de Equipo</label><br>
			<label class="descripcionForm">
				<strong><?= $responsable_equipoDatos['nombre']?></strong>
			</label><br>
			<?php
			if($registros_tablas!=''){
