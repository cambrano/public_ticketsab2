<?php
	...
	$sql = "SELECT count(*) total FROM responsables_equipos WHERE 1 = 1   ";
	...
	////////////////////////////
	////////////////////////////
	$sql = "SELECT id,clave,nombre FROM responsables_equipos WHERE 1 = 1  "; 
	...
	if($post_search){
		$sqlContadorScript = "SELECT count(*) total FROM responsables_equipos WHERE 1 = 1   "; 
