<?php
	...
	$seccion_ine_actividadDatos['id_estado'] = $id_estado;
	$seccion_ine_actividadDatos['id_municipio'] = $id_municipio;
	$seccion_ine_actividadDatos['id_localidad'] = 290086;
	$seccion_ine_actividadDatos['fecha'] = date("Y-m-d");
	$seccion_ine_actividadDatos['hora'] = date("H:i:s");
...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "seccionesIneActividades/db_add.php",
				data: {seccion_ine_actividad: seccion_ine_actividad,puntos:puntos},
				success: function(data) {
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Crear Acción u Obra</font>
				</label><br>
				<label class="descripcionForm">
					<font style="font-size: 13px;">Campos para registrar y dar de alta a acción u obra.</font><br><br>
				</label><br>
