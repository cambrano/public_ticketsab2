<?php
	...
	$filename = 'Actividades_-_'.date("Ymd-His").'-'.$gen_id3.$mk_id.'.xlsx';
	...
	*/
	...
	$keywords = array('Actividades','Data','Información');
	$writer->setTitle('Actividades');
	...
	$excel_head = array(
		...
		2 => array('row' => 'tipo' ,'nombre' => 'Tipo' ,'tipo' => 'string','mostrar' => 1 ),
		3 => array('row' => 'participantes' ,'nombre' => 'Participantes' ,'tipo' => 'number','mostrar' => 1 ),
		4 => array('row' => 'nombre' ,'nombre' => 'Nombre' ,'tipo' => 'string','mostrar' => 1 ),
		5 => array('row' => 'fecha' ,'nombre' => 'Fecha' ,'tipo' => 'date','mostrar' => 1 ),
		6 => array('row' => 'hora' ,'nombre' => 'Hora' ,'tipo' => 'string','mostrar' => 1 ),
		7 => array('row' => 'observaciones' ,'nombre' => 'Observaciones' ,'tipo' => 'string','mostrar' => 1 ),
		8 => array('row' => 'municipio' ,'nombre' => 'Municipio' ,'tipo' => 'string','mostrar' => 1 ),
		9 => array('row' => 'localidad' ,'nombre' => 'Localidad' ,'tipo' => 'string','mostrar' => 1 ), 
		10 => array('row' => 'colonia' ,'nombre' => 'Colonia' ,'tipo' => 'string','mostrar' => 1 ), 
		11 => array('row' => 'seccion' ,'nombre' => 'Sección' ,'tipo' => 'number','mostrar' => 1 ),
		12 => array('row' => 'distrito_local' ,'nombre' => 'Distrito Local' ,'tipo' => 'number','mostrar' => 1 ),
		13 => array('row' => 'distrito_federal' ,'nombre' => 'Distrito Federal' ,'tipo' => 'number','mostrar' => 1 ),
		14 => array('row' => 'latitud' ,'nombre' => 'Latitud' ,'tipo' => 'string','mostrar' => 1 ),
		15 => array('row' => 'longitud' ,'nombre' => 'Longitud' ,'tipo' => 'string','mostrar' => 1 ),
	);
	...
	$sql = "
		SELECT
			...
			sia.folio,
			sia.tipo,
			(SELECT COUNT(*) FROM secciones_ine_ciudadanos_actividades sicg WHERE sicg.id_seccion_ine_actividad = sia.id) participantes,
			sia.nombre,
			sia.fecha,
			sia.hora,
			sia.observaciones,
