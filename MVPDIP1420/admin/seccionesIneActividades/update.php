<?php
	...
	$secciones_ine_actividades_puntosDatos = secciones_ine_actividades_puntosDatos('',$id);
	$xlatitud = null;
	unset($value);
	...
	if($value['longitud']!=''){
		$seccion_ine_actividadDatos['longitud'] = $value['longitud'];
		$seccion_ine_actividadDatos['latitud'] = $value['latitud'];
	}
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				...
				data: {seccion_ine_actividad: seccion_ine_actividad,puntos_nuevos:puntos_nuevos,puntos_registrados:puntos_registrados},
				success: function(data) {
