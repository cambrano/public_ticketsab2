...
?>
	...
	<script>
		...
		function seccionIneSearch(valor){
			id_seccion_ine = valor.value;
			$('#id_seccion_ine').val(id_seccion_ine);
			$('#id_seccion_ine').select2().trigger('change');
		...
		<div id="divDatosDireccionActual" style="display:none">
			...
			<div class="sucForm" style="width: 100%">
				...
				<div class="sucForm">
					...
					<select class="myselect" id="id_seccion_ine_search" onchange="seccionIneSearch(this)" >
						<?php
