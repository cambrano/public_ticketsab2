<?php
	if($reload_mapa == ""){
		...
		if(!empty($_POST)){
			...
			$secciones_ine_ciudadanos_secciones_avance_semaforoDatos = secciones_ine_ciudadanos_secciones_avance_semaforoDatos();
											...
											<tr>
												...
												<td
													...
													<font class="fontDataReporte" style="font-size: 12px">
														...
														<?= $secciones_ine_ciudadanos_avance_semaforoDatos['rojo_rango_inicial'] ?> 
														& 
														<i class="fas fa-less-than-equal"></i> 
														<?= $secciones_ine_ciudadanos_avance_semaforoDatos['rojo_rango_final'] ?> 
													</font>
												</td>
												...
												<td
													...
													<font class="fontDataReporte" style="font-size: 12px">
														<i class="fas fa-greater-than-equal"></i> 
														<?= $secciones_ine_ciudadanos_avance_semaforoDatos['amarillo_rango_inicial'] ?> 
														& 
														<i class="fas fa-less-than-equal"></i> 
														<?= $secciones_ine_ciudadanos_avance_semaforoDatos['amarillo_rango_final'] ?> 
													</font>
												</td>
												...
												<td
													...
													<font class="fontDataReporte" style="font-size: 12px">
														<i class="fas fa-greater-than-equal"></i> 
														<?= $secciones_ine_ciudadanos_avance_semaforoDatos['verde_rango_inicial'] ?> 
														& 
														<i class="fas fa-less-than-equal"></i> 
														<?= $secciones_ine_ciudadanos_avance_semaforoDatos['verde_rango_final'] ?> 
													</font>
												</td>
					...
					function myMap(){
						...
						<?php
							foreach ($secciones_ineDatosMapa as $key => $value) {
								...
								if(!empty( $secciones_ine_ciudadanos_secciones_avance_semaforoDatos[$value['id']]) && $secciones_ine_ciudadanos_secciones_avance_semaforoDatos[$value['id']]['status']==1 ){
									$semaforo_tipo = 'Unidad';
								...
								if($semaforo_activo){
									...
									<b>Semáforo '.$semaforo_tipo.' General</b>
