...
<body style="background-color:red">
    <div class="titulos_cuadros">
        <table style="table-layout: fixed; width: 100%;  padding: 0px; border: 1px solid #753232;border-collapse: collapse;">
            <tr>
                <td style="padding: 2px 5px 2px 5px; width: 60px; background-color: #753232; border: 1px solid #753232;">
                    [__Empresa_Logo__]
                </td>
                <td style="font-size: 12px; text-align: left; padding: 10px; background-color: #753232; color: white; border: 1px solid #753232;">
                    [__Empresa_Nombre__]<br>
                    <div style="font-size: 6px; font-style: italic; background-color: #753232; color: white; border: 1px solid #753232;">
                        [__Empresa_Slogan__]
                    </div>
                </td>
                <td style="color: white; font-size: 8px; text-align: left; padding: 2px; width: 70px; background-color: #753232; border: 1px solid #753232;">
