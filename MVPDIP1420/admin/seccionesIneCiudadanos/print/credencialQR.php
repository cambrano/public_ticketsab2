<?php
	...
	//$mostrarImagenBase64 = mostrarImagenBase64('kanasin.png');
	...
	$size = 100;
	$marge = 1;
	$link = substr($codigo_seccion_ine_ciudadano, 0, 6)."-".$id_seccion_ine_ciudadano;
	$level = QR_ECLEVEL_L;
	$enlace_comprobante = "";
	...
	$img_qr = '<img style="width: 141px;" src="data:image/png;base64,' . $image_base64 . '" alt="QR Code with Image">';
