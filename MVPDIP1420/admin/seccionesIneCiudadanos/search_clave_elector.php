<?php
	...
	if(!empty($_POST)){
		...
		$sqlClave = "SELECT 
						...
						WHERE sic.clave_elector = '{$clave_elector}' ";
		...
		if($rowClave['id']!=""){
			...
			$myObj->folio = $rowClave['folio'];
			$myObj->clave = $rowClave['clave'];
			$myObj->tipo_ciudadano = $rowClave['tipo_ciudadano'];
		}else{
