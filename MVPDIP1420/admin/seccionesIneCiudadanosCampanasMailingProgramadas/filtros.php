...
?>
	<script type="text/javascript">
		function searchTable(value){
			...
			$.ajax({
				type: "POST",
				url: "seccionesIneCiudadanosCampanasMailingProgramadas/table.php",
	...
	<div class="sucForm">
		...
		<select class="selectpicker"  data-live-search="true" data-size="5" data-actions-box="true" title="Seleccione" id="f_status" onchange="searchTable();">
	...
	<div class="sucForm">
		...
		<select class="selectpicker"  data-live-search="true" data-size="5" data-actions-box="true" title="Seleccione" id="f_tipo" onchange="searchTable();">
			<option value="">Seleccione</option>
