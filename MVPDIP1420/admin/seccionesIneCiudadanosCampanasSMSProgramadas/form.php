...
?>
	<div style=" width: 100%; display:inline-block; text-align: left;">
		...
		<div class="sucForm" style="width: 100%">
			...
			<input class="inputlogin" disabled="disabled" type="text" style="width: 100%" value="<?= $seccion_ine_ciudadano_campana_sms_programadaDatos['nombre_completo'] ?>" ><br>
		</div>
		<div class="sucForm" style="width: 100%">
			<label class="labelForm" id="labeltemaname">Celular<font color="#FF0004">*</font></label><br>
			<input class="inputlogin" disabled="disabled" type="text" style="width: 100%" value="<?= $seccion_ine_ciudadano_campana_sms_programadaDatos['celular'] ?>" ><br>
		</div>
		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Nombre<font color="#FF0004">*</font></label><br>
			<input class="inputlogin" disabled="disabled" type="text" style="width: 100%" value="<?= $seccion_ine_ciudadano_campana_sms_programadaDatos['nombre'] ?>" ><br>
		</div>
		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Estatus<font color="#FF0004">*</font></label><br>
			<?php
			$selectStatus[$seccion_ine_ciudadano_campana_sms_programadaDatos['status']]='selected="selected" ';
			?>
		...
		<div class="sucForm" style="width: 100%">
			<br><br>
			<?= $seccion_ine_ciudadano_campana_sms_programadaDatos['cuerpo'] ?>
			<br><br>
		</div>
		<div class="sucForm" style="width: 100%">
			<br>
