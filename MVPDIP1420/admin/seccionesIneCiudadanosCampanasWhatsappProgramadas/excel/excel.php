<?php
	...
	$filename = 'Ciudadanos_Whatsapp-_'.date("Ymd-His").'-'.$gen_id3.$mk_id.'.xlsx';
	/*
	...
	*/
	...
	$keywords = array('Ciudadanos Whatsapp','Data','Información');
	$writer->setTitle('Ciudadanos Whatsapp');
	...
	$excel_head = array(
		...
		4 => array('row' => 'whatsapp' ,'nombre' => 'whatsapp','tipo' => 'string','mostrar' => 1),
		5 => array('row' => 'fecha_hora_envio' ,'nombre' => 'Envío' ,'tipo' => 'datetime','mostrar' => 1),
		6 => array('row' => 'fecha_hora_entrega' ,'nombre' => 'Entrega' ,'tipo' => 'datetime','mostrar' => 1),
		7 => array('row' => 'fecha_hora_leido' ,'nombre' => 'Leído' ,'tipo' => 'datetime','mostrar' => 1),
		...
		12 => array('row' => 'mensaje_proveedor' ,'nombre' => 'Mensaje' ,'tipo' => 'string','mostrar' => 1),
		13 => array('row' => 'status' ,'nombre' => 'Estatus' ,'tipo' => 'string','mostrar' => 1), 
	);
	...
	while($row=$result->fetch_assoc()){
		...
		if($numero==1){
			sleep(1);
			$txt = "Ciudadanos Whatsapp Pag - ".$page;
			$page ++;
