...
?>
	<script type="text/javascript">
		...
		function searchTable(value){
			...
			*/
			...
			$.ajax({
				type: "POST",
				url: "seccionesIneCiudadanosCheck2024/table.php",
	...
	<div class="sucForm">
		<label class="labelForm" id="labeltemaname">Checks</label><br>
		<select class="selectpicker" data-live-search="true" data-size="5" data-actions-box="true" title="Seleccione" id="checks" >
			<option selected="selected" value="">Seleccione</option>
			<!--<option value="1"> Check IN</option>-->
			<option value="2"> Check OUT</option>
			<!--<option value="3"> Doble Check</option>-->
			<option value="4"> Sin Checks</option>
		</select>
	</div>

	<div class="sucForm">
		<label class="labelForm" id="labeltemaname">clave</label><br>
		<input data-column="0" id="clave" autocomplete="off" type="text" > <br>
	</div>
