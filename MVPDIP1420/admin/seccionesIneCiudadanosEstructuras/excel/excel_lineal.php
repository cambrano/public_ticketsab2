<?php
	...
	*/
	...
	$columa = array(
		...
		7 => array('row' => 'insert' ,'nombre' => 'Creo' ,'tipo' => 'string','mostrar' => 1),
		8 => array('row' => 'update' ,'nombre' => 'Modifico' ,'tipo' => 'string','mostrar' => 1),
		9 => array('row' => 'whatsapp' ,'nombre' => 'Teléfono' ,'tipo' => 'string','mostrar' => 1),
		10 => array('row' => 'nombre' ,'nombre' => 'Nombre' ,'tipo' => 'string','mostrar' => 1),
		11 => array('row' => 'apellido_paterno' ,'nombre' => 'Apellido Paterno' ,'tipo' => 'string','mostrar' => 1),
		12 => array('row' => 'apellido_materno' ,'nombre' => 'Apellido Materno' ,'tipo' => 'string','mostrar' => 1),
		14 => array('row' => 'calle' ,'nombre' => 'Calle' ,'tipo' => 'string','mostrar' => 1),
		15 => array('row' => 'num_ext' ,'nombre' => 'Num Ext' ,'tipo' => 'string','mostrar' => 1),
		16 => array('row' => 'num_int' ,'nombre' => 'Num Int' ,'tipo' => 'string','mostrar' => 1),
		17 => array('row' => 'colonia' ,'nombre' => 'colonia' ,'tipo' => 'string','mostrar' => 1),
	);
	$columa = array(
		0 => array('row' => 'seccion' ,'nombre' => 'Sección' ,'tipo' => 'string','mostrar' => 1 ),
		1 => array('row' => 'clave' ,'nombre' => 'Clave' ,'tipo' => 'string','mostrar' => 1 ),
		...
		5 => array('row' => 'clave_elector' ,'nombre' => 'Clave Elector' ,'tipo' => 'string','mostrar' => 1),
		6 => array('row' => 'municipio' ,'nombre' => 'Municipio' ,'tipo' => 'string','mostrar' => 1),
		7 => array('row' => 'whatsapp' ,'nombre' => 'Teléfono' ,'tipo' => 'string','mostrar' => 1),
		8 => array('row' => 'nombre' ,'nombre' => 'Nombre' ,'tipo' => 'string','mostrar' => 1),
		9 => array('row' => 'apellido_paterno' ,'nombre' => 'Apellido Paterno' ,'tipo' => 'string','mostrar' => 1),
		10 => array('row' => 'apellido_materno' ,'nombre' => 'Apellido Materno' ,'tipo' => 'string','mostrar' => 1),
		11 => array('row' => 'calle' ,'nombre' => 'Calle' ,'tipo' => 'string','mostrar' => 1),
		12 => array('row' => 'num_ext' ,'nombre' => 'Num Ext' ,'tipo' => 'string','mostrar' => 1),
		13 => array('row' => 'num_int' ,'nombre' => 'Num Int' ,'tipo' => 'string','mostrar' => 1),
		14 => array('row' => 'colonia' ,'nombre' => 'colonia' ,'tipo' => 'string','mostrar' => 1),
	);
	...
	sic.clave_elector,
	sic.whatsapp,
	/*IF(sic.calle='','SN',sic.calle) calle,*/
	/*IF(sic.num_ext IS NULL,'SN',sic.num_ext) num_ext,*/
	/*IF(sic.num_int IS NULL,'SN',sic.num_int) num_int,*/
	IF(sic.calle IS NULL OR sic.calle = '', ' ', sic.num_ext) AS calle,
	IF(sic.num_ext IS NULL OR sic.num_ext = '', ' ', sic.num_ext) AS num_ext,
	IF(sic.num_int IS NULL OR sic.num_int = '', ' ', sic.num_int) AS num_int,
	sic.colonia,
	...
	(SELECT CONCAT_WS(' ',lg.nombre_usuario,lg.fechaR) FROM log_usuarios lg WHERE lg.id_columna = sic.id AND lg.operacion = 'Insert' AND tabla = 'secciones_ine_ciudadanos' ORDER BY lg.fechaR ) 'Insert',
	(SELECT CONCAT_WS(' ',lg.nombre_usuario,lg.fechaR) FROM log_usuarios lg WHERE lg.id_columna = sic.id AND lg.operacion = 'Update' AND tabla = 'secciones_ine_ciudadanos' ORDER BY lg.fechaR LIMIT 1) 'Update'*/
			...
			while($row3=$resultado3->fetch_assoc()){
				...
				$exel[]= array( 
					...
					'datos' => array(
							...
							$row3['whatsapp'],
							$row3['nombre'],
							$row3['apellido_paterno'],
							$row3['apellido_materno'],
							$row3['calle'],
							$row3['num_ext'],
							$row3['num_int'],
							$row3['colonia']
				...
				while($row4=$resultado4->fetch_assoc()){
					...
					$exel[]= array( 
						...
						'datos' => array(
							...
							$row4['whatsapp'],
							$row4['nombre'],
							$row4['apellido_paterno'],
							$row4['apellido_materno'],
							$row4['calle'],
							$row4['num_ext'],
							$row4['num_int'],
							$row4['colonia']
					...
					while($row5=$resultado5->fetch_assoc()){
						...
						$exel[]= array( 
							...
							'datos' => array(
								...
								$row5['whatsapp'],
								$row5['nombre'],
								$row5['apellido_paterno'],
								$row5['apellido_materno'],
								$row5['calle'],
								$row5['num_ext'],
								$row5['num_int'],
								$row5['colonia']
						...
						while($row6=$resultado6->fetch_assoc()){
							...
							$exel[]= array( 
								...
								'datos' => array(
									...
									$row6['whatsapp'],
									$row6['nombre'],
									$row6['apellido_paterno'],
									$row6['apellido_materno'],
									$row6['calle'],
									$row6['num_ext'],
									$row6['num_int'],
									$row6['colonia']
							...
							while($row7=$resultado7->fetch_assoc()){
								...
								$exel[]= array( 
									...
									'datos' => array(
										...
										$row7['whatsapp'],
										$row7['nombre'],
										$row7['apellido_paterno'],
										$row7['apellido_materno'],
										$row7['calle'],
										$row7['num_ext'],
										$row7['num_int'],
										$row7['colonia']
