...
while($row=$resultado->fetch_assoc()){
	$id = $row['id'];
	//! definimos el tipo de estructura y las metas en lo general
	$estructuras[$id] = array(1,2,3,4,5);
	$estructuras_metas[$id][1] = 1;
	$estructuras_metas[$id][2] = 8;
	$estructuras_metas[$id][3] = 320;
	$estructuras_metas[$id][4] = 640;
	$estructuras_metas[$id][5] = 500;
...
<hr>
<input type="text" id="validador_input" value="0" >
...
<?php
	...
	foreach ($estructuras as $id => $niveles) {
		...
		$sql1 = "SELECT 
				...
				";
		if(!empty($id_municipio)){
			$sql1 .= " AND ea.id_municipio = {$id_municipio} ";
		}
		if(!empty($id_distrito_local)){
			$sql1 .= " AND ea.id_distrito_local = {$id_distrito_local} ";
		}
		if(!empty($id_distrito_federal)){
			$sql1 .= " AND ea.id_distrito_federal = {$id_distrito_federal} ";
		}
		...
		if($nivel1_id_tipo_ciudadano != $niveles[0] ){
			...
			echo "<table border=1>";
			echo "<tr>";
			echo "<td>id1</td><td>clave".$id."</td><td>folio</td><td>En Base de datos</td><td>Como debe estar</td><td>nombre_completo</td><td>Registro</td><td>Modifico</td>";
			echo "</tr>";
			...
			$sql2 = "SELECT 
				...
				while($row2=$resultado2->fetch_assoc()){
					...
					if($nivel2_id_tipo_ciudadano != $niveles[1] ){
						...
						echo "<table border=1>";
						echo "<tr>";
						echo "<td>id2</td><td>clave</td><td>folio</td><td>En Base de datos</td><td>Como debe estar</td><td>nombre_completo</td><td>Registro</td><td>Modifico</td>";
						echo "</tr>";
						...
						while($row3=$resultado3->fetch_assoc()){
							...
							if($nivel3_id_tipo_ciudadano != $niveles[2] ){
								...
								echo "<table border=1>";
								echo "<tr>";
								echo "<td>id3</td><td>clave</td><td>folio</td><td>En Base de datos</td><td>Como debe estar</td><td>nombre_completo</td><td>Registro</td><td>Modifico</td>";
								echo "</tr>";
								echo "<tr><td>".$nivel1_id."</td><td>".$nivel1_clave."</td><td>".$nivel1_folio."</td><td>".$nivel1_tipo."</td><td>".$_tipo_nivel[$niveles[0]]."</td><td>".$nivel1_nombre_completo."</td></tr>";
								...
								while($row4=$resultado4->fetch_assoc()){
									...
									if($nivel4_id_tipo_ciudadano != $niveles[3] ){
										...
										echo "<table border=1>";
										echo "<tr>";
										echo "<td>id4</td><td>clave</td><td>folio</td><td>En Base de datos</td><td>Como debe estar</td><td>nombre_completo</td><td>Registro</td><td>Modifico</td>";
										echo "</tr>";
										echo "<tr><td>".$nivel1_id."</td><td>".$nivel1_clave."</td><td>".$nivel1_folio."</td><td>".$nivel1_tipo."</td><td>".$_tipo_nivel[$niveles[0]]."</td><td>".$nivel1_nombre_completo."</td></tr>";
										echo "<tr><td>".$nivel2_id."</td><td>".$nivel2_clave."</td><td>".$nivel2_folio."</td><td>".$nivel2_tipo."</td><td>".$_tipo_nivel[$niveles[1]]."</td><td>".$nivel2_nombre_completo."</td></tr>";
										...
										while($row5=$resultado5->fetch_assoc()){
											...
											if($nivel5_id_tipo_ciudadano != $niveles[4] ){
												...
												echo "<table border=1>";
												echo "<tr>";
												echo "<td>id5</td><td>clave</td><td>folio</td><td>En Base de datos</td><td>Como debe estar</td><td>nombre_completo</td><td>Registro</td><td>Modifico</td>";
												echo "</tr>";
												echo "<tr><td>".$nivel1_id."</td><td>".$nivel1_clave."</td><td>".$nivel1_folio."</td><td>".$nivel1_tipo."</td><td>".$_tipo_nivel[$niveles[0]]."</td><td>".$nivel1_nombre_completo."</td></tr>";
												echo "<tr><td>".$nivel2_id."</td><td>".$nivel2_clave."</td><td>".$nivel2_folio."</td><td>".$nivel2_tipo."</td><td>".$_tipo_nivel[$niveles[1]]."</td><td>".$nivel2_nombre_completo."</td></tr>";
												echo "<tr><td>".$nivel3_id."</td><td>".$nivel3_clave."</td><td>".$nivel3_folio."</td><td>".$nivel3_tipo."</td><td>".$_tipo_nivel[$niveles[2]]."</td><td>".$nivel3_nombre_completo."</td></tr>";
												...
												while($row6=$resultado6->fetch_assoc()){
													...
													if($nivel6_id_tipo_ciudadano != $niveles[5] ){
														...
														echo "<table border=1>";
														echo "<tr>";
														echo "<td>id6</td><td>clave</td><td>folio</td><td>En Base de datos</td><td>Como debe estar</td><td>nombre_completo</td><td>Registro</td><td>Modifico</td>";
														echo "</tr>";
														echo "<tr><td>".$nivel1_id."</td><td>".$nivel1_clave."</td><td>".$nivel1_folio."</td><td>".$nivel1_tipo."</td><td>".$_tipo_nivel[$niveles[0]]."</td><td>".$nivel1_nombre_completo."</td></tr>";
														echo "<tr><td>".$nivel2_id."</td><td>".$nivel2_clave."</td><td>".$nivel2_folio."</td><td>".$nivel2_tipo."</td><td>".$_tipo_nivel[$niveles[1]]."</td><td>".$nivel2_nombre_completo."</td></tr>";
														echo "<tr><td>".$nivel3_id."</td><td>".$nivel3_clave."</td><td>".$nivel3_folio."</td><td>".$nivel3_tipo."</td><td>".$_tipo_nivel[$niveles[2]]."</td><td>".$nivel3_nombre_completo."</td></tr>";
...
<script>
	...
	iniciarTemporizador();
	function validadorRefres() {
		var validador_input = document.getElementById("validador_input").value;
		if (validador_input != "0") {
			//console.log("Esperamos");
			return false;
		} else {
			document.getElementById("validador_input").value = 1;
		}
		var datos_validador = [];
		var data = { 
			'sub': 1,
		...
		$.ajax({
			...
			success: function(data) {
				document.getElementById("validador_input").value = "0";
				$("#validador").html(data);
			}
		});
	}
