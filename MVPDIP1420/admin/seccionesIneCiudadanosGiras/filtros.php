...
?>
	<script type="text/javascript">
		...
		function searchTable(value){
			...
			$.ajax({
				type: "POST",
				url: "seccionesIneCiudadanosGiras/table.php",
	...
	<div class="sucForm">
		<label class="labelForm" id="labeltemaname">Agenda</label><br>
		<select class="selectpicker" data-live-search="true" data-size="5" data-actions-box="true" title="Seleccione" id="id_seccion_ine_gira" onchange="searchTable();">
			<?php
			echo secciones_ine_giras();
			?>
		</select><br>
	</div>
