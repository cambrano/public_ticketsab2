...
?>
	<script type="text/javascript">
		...
		function buscar_clave_electoral(){
			...
			$.ajax({
				type: "POST",
				url: "seccionesIneCiudadanosGiras/search_clave_elector.php",
				data: dataString,
				dataType: 'json',
				success: function(data) {
					//console.log(data);
	...
	<div style=" width: 100%; display:inline-block; text-align: left;">
		...
		<div class="sucFormTitulo">
			<label class="labelForm" id="labeltemaname">Datos Participación</label>
		</div>
		...
		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Agenda<font color="#FF0004">*</font></label><br>
			<select id="id_seccion_ine_gira" onchange="buscar_clave_electoral();">
				<?php echo secciones_ine_giras($seccion_ine_ciudadano_giraDatos['id_seccion_ine_gira']); ?>
			</select>
			<br>
		</div>
