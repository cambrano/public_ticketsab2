	...
	<script type="text/javascript" language="javascript" >
		$(document).ready(function() {
			...
			var dataTable = $('#secciones_ine_ciudadanos_giras-tabla').DataTable( {
				...
				"ajax":{
					url :"seccionesIneCiudadanosGiras/secciones_ine_ciudadanos_giras.php", // json datasource
			...
			$('#selectCheckbox').on("click", function(event){ // triggering delete one by one
				if( $('.checkselected:checked').length > 0 ){  // at-least one checkbox checked
					...
					var link="seccionesIneCiudadanosGiras/index.php?cot="+ids_string;   
		...
		function edit(valor){
			link="seccionesIneCiudadanosGiras/update.php?id="+valor; 
			var link2="seccionesIneCiudadanosGiras/update.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
		...
		function add(){
			////ajax
			link="seccionesIneCiudadanosGiras/create.php";
			var link2="seccionesIneCiudadanosGiras/create.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
		...
		function borrar(valor){
			link="seccionesIneCiudadanosGiras/delete.php?id="+valor; 
			var link2="seccionesIneCiudadanosGiras/delete.php";
			dataString = 'urlink='+link2; 
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
