<?php
	...
	include __DIR__."/../functions/plataformas.php";include '../functions/tool_xhpzab.php';
	@session_start();  
	if(!empty($_GET)){
		$id = $_GET['id'];
	...
	echo $redirectSecurity=redirectSecurity($id,'secciones_ine_ciudadanos_programas_apoyos','seccionesIneCiudadanosProgramasApoyosTotales','index');
	if($redirectSecurity!=""){
		die;
	}
...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "seccionesIneCiudadanosProgramasApoyosTotales/db_delete.php",
				data: dataString,
				success: function(data) { 
					if(data=="SI"){
						document.getElementById("sumbmit").disabled = true;
	...
	<div class="bodymanager" id="bodymanager"> 
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Eliminar Ciudadano</font>
				</label><br>
		...
		<div class="bodyinput">
			...
			<label class="descripcionForm">
				<strong><?=$programa_apoyoDatos['nombre']; ?></strong>
			</label><br><br>
