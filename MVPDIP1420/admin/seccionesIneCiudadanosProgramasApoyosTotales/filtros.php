...
?>
	<script type="text/javascript">
		function searchTable(value){
			...
			$.ajax({
				type: "POST",
				url: "seccionesIneCiudadanosProgramasApoyosTotales/table.php",
	...
	<div class="sucForm">
		...
		<input data-column="0" id="curp" autocomplete="off" type="text" onkeyup ="searchTable();" > <br>
	</div>
	...
	<div class="sucForm">
		<label class="labelForm" id="labeltemaname">Repetidos</label><br>
		<select class="selectpicker" data-live-search="true" data-size="5" data-actions-box="true" title="Seleccione" id="repetidos" onchange="searchTable();">
