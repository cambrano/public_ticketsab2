<?php
	...
	$seccion_ine_ciudadanoDatos['id_municipio_ine'] = $seccion_ine_ciudadanoDatos['id_municipio'] = $id_municipio;
	...
	#$seccion_ine_ciudadanoDatos['folio'] = 'RNM2021';
	...
	$option_relacionado ='<option value="">Buscar Relacionado</option>';
	...
	//borrar
	$seccion_ine_ciudadanoDatos['whatsapp'] = '';
	$seccion_ine_ciudadanoDatos['vigencia'] = '';
	$seccion_ine_ciudadanoDatos['folio'] = $seccion_ine_ciudadanoDatos['clave'];
	$seccion_ine_ciudadanoDatos['folio'] = 'SF-';
	$id_seccion_ine = decrypt_ab_checkFinal($_COOKIE['paguinaId_1']);
	$seccion_ine_ciudadanoDatos['id_seccion_ine'] = $id_seccion_ine;
	
?>
	<title>Create</title>
	<script language="javascript" type="text/javascript">
		function cerrar(){
			urlink="seccionesIneCiudadanosSeccion/index.php";
		...
		function guardar() {
			...
			*/
			...
			$.ajax({
				type: "POST",
				url: "seccionesIneCiudadanosSeccion/db_add.php",
				...
				success: function(data) {
					...
					if(data=="SI"){
						...
						//$("#homebody").load('seccionesIneCiudadanosSeccion/index.php?refresh=1');
						var regmasivo = document.getElementById("regmasivo");
						if (regmasivo.checked == true){
							urlink="seccionesIneCiudadanosSeccion/createrapid.php";
							dataString = 'urlink='+urlink; 
							$.ajax({
								type: "POST",
								url: "functions/backarray.php",
