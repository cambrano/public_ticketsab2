<?php
	...
	$sql = "
		SELECT 
			(SELECT COUNT(*) FROM secciones_ine_ciudadanos sice WHERE 1 {$sqlTipoPlat} AND sice.id_seccion_ine = $id_seccion_ine ) ciudadanos_totales,
			(SELECT SUM(lista_nominal) FROM manzanas_ine sice WHERE 1 = 1 {$sqlTipoPlat_gen} AND sice.id_seccion_ine = $id_seccion_ine ) total_lista_nominal_2021,
		...
		FROM   secciones_ine_ciudadanos sice WHERE 1 {$sqlTipoPlat} AND sice.id_seccion_ine = $id_seccion_ine ";
	...
	*/
	...
	$sql = "
		SELECT 
			tc.nombre,
			(SELECT COUNT(*) FROM secciones_ine_ciudadanos sice WHERE sice.id_tipo_ciudadano = tc.id {$sqlTipoPlat} AND sice.id_seccion_ine = $id_seccion_ine ) ciudadanos
	...
	$sql = "
		SELECT 
			tc.nombre,
			(SELECT COUNT(*) FROM secciones_ine_ciudadanos_categorias sice WHERE sice.id_tipo_categoria_ciudadano = tc.id {$sqlTipoPlat} AND sice.id_seccion_ine = $id_seccion_ine {$sqlTipoPlat_gen} ) ciudadanos
	...
	$sql = "
		...
		WHERE 1
		{$sqlTipoPlat}
		AND sice.id_seccion_ine = $id_seccion_ine
