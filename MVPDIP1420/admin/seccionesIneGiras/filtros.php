...
?>
	<script type="text/javascript">
		...
		function searchTable(value){
			...
			$.ajax({
				type: "POST",
				url: "seccionesIneGiras/table.php",
			...
			$.ajax({
				type: "POST",
				url: "seccionesIneGiras/mapa.php",
	...
	<div class="sucFormTitulo">
		<label class="labelForm" id="labeltemaname">Filtros Agenda de Gobierno</label>
	</div>
	...
	<div class="sucForm">
		<label class="labelForm" id="labeltemaname">Eje de Gobierno<br></label><br>
		<select name="id_eje_gobierno" id="id_eje_gobierno" class='myselect' onchange="searchTable();">
			<?php
			echo ejes_gobierno();
			?>
		</select><br>
	...
	<div class="sucForm">
		<label class="labelForm" id="labeltemaname">Dep Coordinadora<br></label><br>
		<select class="selectpicker" multiple data-live-search="true" data-size="5" data-actions-box="true" title="Seleccione" id="id_dependencias" onchange="searchTable();">
			<?php
			echo dependencias('','SIN');
			?>
		</select><br>
	</div>
	<div class="sucForm" style="display:none">
		<label class="labelForm" id="labeltemaname">Dep Colaborativa<br></label><br>
		<select class="selectpicker" multiple data-live-search="true" data-size="5" data-actions-box="true" title="Seleccione" id="id_dependencias_colaborativas" onchange="searchTable();">
			<?php
			echo dependencias('','SIN');
			?>
		</select><br>
	...
	<div class="sucForm" style="display:none">
		<label class="labelForm" id="labeltemaname">Dep General<br></label><br>
		<select class="selectpicker" multiple data-live-search="true" data-size="5" data-actions-box="true" title="Seleccione" id="id_dependencias_general" onchange="searchTable();">
			<?php
			echo dependencias('','SIN');
			?>
		</select><br>
	...
	<div class="sucForm">
		<label class="labelForm" id="labeltemaname">Tipos de Agenda Gobierno</label><br>
		<select class="selectpicker" multiple data-live-search="true" data-size="5" data-actions-box="true" title="Seleccione" id="id_tipo_gira" onchange="searchTable();">
			<?php
	...
	<div class="sucForm">
		...
		<input id="fecha_1" autocomplete="off" type="text" onchange="searchTable();" > <br>
	</div>

	<div class="sucForm">
		<label class="labelForm" id="labeltemaname">Fecha(2)</label><br>
		<input id="fecha_2" autocomplete="off" type="text" onchange="searchTable();" > <br>
	</div>
