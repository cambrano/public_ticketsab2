	...
	<div style=" width: 100%; display:inline-block; text-align: left;">
		...
		<div class="sucForm" style=" width: 100%; ">
			...
			<select class="myselect" id="id_eje_gobierno" >
				<?php
				echo ejes_gobierno($seccion_ine_giraDatos['id_eje_gobierno']);
				?>
			</select><br>
		</div>
		<div class="sucForm">
			...
			<select class="myselect" id="id_dependencia">
				<?php
				echo dependencias($seccion_ine_giraDatos['id_dependencia']);
				?>
			</select><br>
		</div>
		<div class="sucForm" style="width: 100%;display:none">
			<label class="labelForm" id="labeltemaname">Dependencias colaborativas<font color="#FF0004">*</font></label><br>
		</div>
		<?php
		$ids_dependencias = explode(',', $seccion_ine_giraDatos['ids_dependencias']);
		foreach ($dependenciasDatos as $key => $value) {
			...
			?>
			<div class="sucForm" style="padding:5px 20px 5px 20px;width:48%;float:left;display:none">
			<table>
				<tr>
		...
		?>
		<div class="sucFormTitulo">
			<label class="labelForm" id="labeltemaname">Datos Agenda de Gobierno</label>
		</div>
		<div class="sucForm" style="width: 100%">
		...
		<div class="sucForm">
			...
			<input maxlength="350" max="350" class="inputlogin" type="text" name="num_asistentes" autocomplete="off"  id="num_asistentes" value="<?= $seccion_ine_giraDatos['num_asistentes'] ?>" onkeypress="return CheckNumeric()" /><br>
		</div>

		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Num Beneficiarios<font color="#FF0004">*</font></label><br>
			<input maxlength="350" max="350" class="inputlogin" type="text" name="num_beneficiarios" autocomplete="off"  id="num_beneficiarios" value="<?= $seccion_ine_giraDatos['num_beneficiarios'] ?>" onkeypress="return CheckNumeric()" /><br>
		</div>
		<div class="sucForm" style="width: 100%">
		</div>
		...
		<div class="sucForm">
			...
			<select class="myselect" id="id_tipo_gira" >
				<?php
				echo tipos_giras($seccion_ine_giraDatos['id_tipo_gira']);
				?>
			</select><br>
		</div>
		...
		<div class="sucForm">
			...
			<select class="myselect" id="id_seccion_ine" >
				<?php
				echo secciones_ine($seccion_ine_giraDatos['id_seccion_ine'],$id_municipio);
				?>
			</select><br>
		</div>
