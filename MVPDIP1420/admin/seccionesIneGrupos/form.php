<?php
	...
	$zoom = 14;
	if($seccion_ine_grupoDatos['longitud']=="" || $seccion_ine_grupoDatos['latitud']=="" ){
		$zoom = 14;
	}else{
		$longitud=$seccion_ine_grupoDatos['longitud'];
		$latitud=$seccion_ine_grupoDatos['latitud'];
	}
...
?>
	...
	<div style=" width: 100%; display:inline-block; text-align: left;">
		...
		<div class="sucForm">
			...
			<input class="inputlogin" type="text" name="clave" autocomplete="off" <?= $claveF['input'] ?> id="clave" value="<?= $seccion_ine_grupoDatos['clave'] ?>" onkeyup="clave(this.value)" /><br>
		</div>

		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Folio<font color="#FF0004">*</font></label><br>
			<input class="inputlogin" type="text" name="folio" autocomplete="off"  id="folio" value="<?= $seccion_ine_grupoDatos['folio'] ?>" onkeyup="aMays(event, this)" /><br>
		</div>

		<div class="sucForm" style="width: 100%">
			<label class="labelForm" id="labeltemaname">Nombre<font color="#FF0004">*</font></label><br>
			<input maxlength="350" max="350" class="inputlogin" type="text" name="nombre" autocomplete="off"  id="nombre" value="<?= $seccion_ine_grupoDatos['nombre'] ?>" onkeyup="aMays(event, this)" /><br>
		</div>

		<div class="sucForm" style="width: 100%"></div>

		<div class="sucFormTitulo">
			<label class="labelForm" id="labeltemaname">Datos Grupo</label>
		</div>
		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Fecha<font color="#FF0004">*</font></label><br>
			<input class="inputlogin" type="text" name="fecha" autocomplete="off"  id="fecha" value="<?= $seccion_ine_grupoDatos['fecha'] ?>" placeholder="" /><br>
		</div>

		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Hora<font color="#FF0004">*</font></label><br>
			<input class="inputlogin" type="text" name="hora" autocomplete="off"  id="hora" value="<?= $seccion_ine_grupoDatos['hora'] ?>" placeholder="" /><br>
		</div>
		<div class="sucForm" style="width: 100%"></div>

		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Tipo Grupo<font color="#FF0004">*</font></label><br>
			<select class="myselect" id="id_tipo_seccion_ine_grupo" >
				<?= tipos_secciones_ine_grupos($seccion_ine_grupoDatos['id_tipo_seccion_ine_grupo']) ?>
			</select><br>
		</div>
		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Tipo Interes<font color="#FF0004">*</font></label><br>
			<select class="myselect" id="id_tipo_interes" >
				<?= tipos_intereses($seccion_ine_grupoDatos['id_tipo_interes']) ?>
			</select><br>
		</div>

		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Tipo Relación<font color="#FF0004">*</font></label><br>
			<select class="myselect" id="id_tipo_relacion" >
				<?= tipos_relaciones($seccion_ine_grupoDatos['id_tipo_relacion']) ?>
			</select><br>
		</div>

		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Partido<font color="#FF0004">*</font></label><br>
			<select class="myselect" id="id_partido_legado" >
				<?= partidos_legados($seccion_ine_grupoDatos['id_partido_legado']) ?>
			</select><br>
		</div>

		<div class="sucForm" style="width: 100%">
			<label class="labelForm" id="labeltemaname">Observaciones</label><br>
			<textarea id="observaciones" style="width: 99%;height: 150px"><?= $seccion_ine_grupoDatos['observaciones'] ?></textarea> <br>
		</div>
		...
		<div class="sucForm">
			...
			<select class="myselect" id="id_seccion_ine" >
				<?php
				echo secciones_ine($seccion_ine_grupoDatos['id_seccion_ine']);
				?>
			</select><br>
		</div>
		...
		<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px;display: none;">
			...
			<select   name="id_pais" id="id_pais" class='myselect' disabled="disabled" >
				<?php
				echo paises($seccion_ine_grupoDatos['id_pais']);
				?>
			</select>
		</div>
		...
		<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px;display: none;">
			...
			<select   name="id_estado" id="id_estado" class='myselect' onchange="locationEstado(this);" disabled="disabled" >  
				<?php
				echo estados($seccion_ine_grupoDatos['id_estado']);
				?>
			</select>
		</div>
		<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px;">
			...
			<select   name="id_municipio" id="id_municipio" class='myselect' onchange="locationMunicipio(this)">  
				<?php
				echo municipios($seccion_ine_grupoDatos['id_municipio'],$seccion_ine_grupoDatos['id_estado']);
				?>
			</select>
		</div>
		<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px">
			...
			<select   name="id_localidad" id="id_localidad" class='myselect' onchange="locationLocalidad(this)">  
				<?php
				echo localidades($seccion_ine_grupoDatos['id_localidad'],$seccion_ine_grupoDatos['id_municipio'],$seccion_ine_grupoDatos['id_estado']);
				?>
			</select>
		</div>
		<div class="sucForm">
		...
		<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px;width: 100%">
			...
			<input class="inputlogin" type="text" name="calle" autocomplete="off" id="calle" value="<?= $seccion_ine_grupoDatos['calle'] ?>" placeholder="" maxlength="120" onkeyup="aMays(event, this)" /><br>
		</div>

		<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px">
			<label class="labelForm" id="labeltemaname">Num Ext.</label><br>
			<input class="inputlogin" type="text" name="num_ext" autocomplete="off"  id="num_ext" value="<?= $seccion_ine_grupoDatos['num_ext'] ?>" placeholder="" maxlength="120" onkeyup="aMays(event, this)" /><br>
		</div>

		<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px">
			<label class="labelForm" id="labeltemaname">Num Int.</label><br>
			<input class="inputlogin" type="text" name="num_int" autocomplete="off"  id="num_int" value="<?= $seccion_ine_grupoDatos['num_int'] ?>" placeholder="" maxlength="120" onkeyup="aMays(event, this)" /><br>
		</div>

		<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px">
			<label class="labelForm" id="labeltemaname">Colonia<font color="#FF0004">*</font></label><br>
			<input class="inputlogin" type="text" name="colonia" autocomplete="off"  id="colonia" value="<?= $seccion_ine_grupoDatos['colonia'] ?>" placeholder="" maxlength="120" onkeyup="aMays(event, this)" /><br>
		</div> 


		<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px">
			<label class="labelForm" id="labeltemaname">Código Postal<font color="#FF0004">*</font></label><br>
			<input class="inputlogin" type="text" name="codigo_postal" autocomplete="off"  id="codigo_postal" value="<?= $seccion_ine_grupoDatos['codigo_postal'] ?>" placeholder="" maxlength="120" onkeypress="return CheckNumeric()" /><br>
		</div>
		<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px">
		...
		<div class="sucForm" style="width: 100%">
			...
			<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px">
				...
				<input class="inputlogin" type="text" name="latitud" autocomplete="off"  id="latitud" value="<?= $seccion_ine_grupoDatos['latitud'] ?>" placeholder="" maxlength="120" onkeypress="" /><br>
			</div>

			<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px">
				<label class="labelForm" id="labeltemaname">Longitud<font color="#FF0004">*</font></label><br>
				<input class="inputlogin" type="text" name="longitud" autocomplete="off"  id="longitud" value="<?= $seccion_ine_grupoDatos['longitud'] ?>" placeholder="" maxlength="120" onkeypress=" " /><br>
			</div>
