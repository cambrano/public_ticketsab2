<?php
	...
	$sql = "SELECT 
				t.votos_validos,
				(SELECT SUM(votos_nulos) FROM casillas_votos_2016 WHERE id_distrito_federal={$id_distrito_federal} AND tipo = '{$tipo}' {$sqlSeccionesIne} {$sqlDistritos} ) votos_nulos,
				(SELECT SUM(votos_can_nreg) FROM casillas_votos_2016 WHERE id_distrito_federal={$id_distrito_federal} AND tipo = '{$tipo}' {$sqlSeccionesIne} {$sqlDistritos} ) votos_can_nreg,
				...
				(SELECT COUNT(id) FROM casillas_votos_2016 WHERE id_distrito_federal={$id_distrito_federal} AND tipo = '{$tipo}' {$sqlSeccionesIne} {$sqlDistritos} ) casillas,
				(SELECT SUM(lista_nominal) FROM casillas_votos_2016 WHERE id_distrito_federal={$id_distrito_federal} AND tipo = '{$tipo}' {$sqlSeccionesIne} {$sqlDistritos} ) total_lista_nominal,
			...
			FROM
				(SELECT SUM(votos) votos_validos FROM  casillas_votos_partidos_2016 WHERE id_distrito_federal={$id_distrito_federal} AND tipo =  '{$tipo}' {$sqlSeccionesIne} {$sqlDistritos} )t
