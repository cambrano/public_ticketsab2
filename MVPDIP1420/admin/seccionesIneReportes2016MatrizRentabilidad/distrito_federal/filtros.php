...
?>
	<script type="text/javascript">
		...
		function searchTable(value){
			...
			$.ajax({
				type: "POST",
				url: "seccionesIneReportes2016/table.php",
			...
			*/
			...
			if(value != 'pagina'){
				...
				$.ajax({
					type: "POST",
					url: "seccionesIneReportes2016MatrizRentabilidad/distrito_federal/mapa.php",
					data: {searchTable: searchTable,mapa:mapa},
					async: true,
					success: function(data) {
						$("#mapaLoad").html(data);
			...
			$.ajax({
				type: "POST",
				url: "seccionesIneReportes2016MatrizRentabilidad/distrito_federal/graficas.php",
	...
	<div class="sucForm">
		...
		<select class="selectpicker" multiple data-live-search="true" data-size="5" data-actions-box="true" title="Seleccione" id="partido_ganador_id" onchange="searchTable();">
			...
			<?php
			echo partidos_2016('',$tipo,'sin_coalicion','SIN');
			?>
		</select><br>
	</div>
	<div class="sucForm">
