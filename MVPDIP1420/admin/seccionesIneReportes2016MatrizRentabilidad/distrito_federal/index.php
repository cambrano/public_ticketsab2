...
?>
	...
	<div id="bodymanager" class="bodymanager">
		...
		if($tipo_uso_plataforma=='all'){
			echo '<div class="submenux" onclick="subConfiguracionDistritosFederalesReportes2016()">Distritos Federales Reporte '.$ano.'</div> / ';
			echo '<div class="submenux" onclick="subConfiguracionDistritosFederalesSeccionesIneReportes2016()">Secciones INE Reportes '.$ano.'</div> / ';
		}else{
			echo '<div class="submenux" onclick="subConfiguracionDistritosFederalesSeccionesIneReportes2016()">Secciones INE Reportes '.$ano.'</div> / ';
		}
		?>
