<?php
	...
	if(!empty($_POST)){
		...
		#$tipo = $configuracion_matriz_rentabilidad_secciones_ine_2016Datos['tipo_eleccion'] = '1';// 0 - Ayuntamiento | 1 - Distrito Federal | 2 - Distrito Federal
		...
		*/
		...
		if ($json_data === false) {
			...
			$archivo_json = $rutaEfs.'competitividad_rentabilidad_individual_distrito_federal_2016_'.$id_distrito_federal.'-'.$_COOKIE["id_usuario"].'.json';
		...
		if ($json_data === false) {
			...
			// Guarda el JSON en un archivo
			$archivo_json = $rutaEfs.'competitividad_rentabilidad_totales_distrito_federal_2016_'.$id_distrito_federal.'-'.$_COOKIE["id_usuario"].'.json';
			if (file_put_contents($archivo_json, $json_data)) {
				//echo "Los datos se han guardado en $archivo_json";
			} else {
				//echo "Error al guardar los datos en $archivo_json";
	...
	if(empty($_POST)){
		...
		if ($json_data === false) {
			...
			// Guarda el JSON en un archivo
			$archivo_json = $rutaEfs.'datos_secciones_ine_distrito_federal_2016_'.$id_distrito_federal.'-'.$_COOKIE["id_usuario"].'.json';
			if (file_put_contents($archivo_json, $json_data)) {
				//echo "Los datos se han guardado en $archivo_json";
			} else {
				//echo "Error al guardar los datos en $archivo_json";
	...
	if ($json_data === false) {
		...
		// Guarda el JSON en un archivo
		$archivo_json = $rutaEfs.'columnas_titulos_partidos_distrito_federal_2016_'.$id_distrito_federal.'-'.$_COOKIE["id_usuario"].'.json';
		if (file_put_contents($archivo_json, $json_data)) {
			//echo "Los datos se han guardado en $archivo_json";
		} else {
			//echo "Error al guardar los datos en $archivo_json";
	...
	if(!empty($columnas_datos)){
		...
		if ($json_data === false) {
			...
			// Guarda el JSON en un archivo
			$archivo_json = $rutaEfs.'columnas_datos_distrito_federal_2016_'.$id_distrito_federal.'-'.$_COOKIE["id_usuario"].'.json';
			if (file_put_contents($archivo_json, $json_data)) {
				//echo "Los datos se han guardado en $archivo_json";
			} else {
				//echo "Error al guardar los datos en $archivo_json";
		...
		if ($json_data === false) {
			...
			// Guarda el JSON en un archivo
			$archivo_json = $rutaEfs.'secciones_distrito_federal_2016_'.$id_distrito_federal.'-'.$_COOKIE["id_usuario"].'.json';
			if (file_put_contents($archivo_json, $json_data)) {
				//echo "Los datos se han guardado en $archivo_json";
			} else {
				//echo "Error al guardar los datos en $archivo_json";
