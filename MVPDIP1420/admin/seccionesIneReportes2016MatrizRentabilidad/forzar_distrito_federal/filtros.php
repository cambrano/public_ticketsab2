		...
		function searchTable(value){
			...
			*/
			...
			if(value != 'pagina'){
				...
				$.ajax({
					type: "POST",
					url: "seccionesIneReportes2016MatrizRentabilidad/forzar_distrito_federal/mapa.php",
					data: {searchTable: searchTable,mapa:mapa},
					async: true,
					success: function(data) {
						$("#mapaLoad").html(data);
			...
			$.ajax({
				type: "POST",
				url: "seccionesIneReportes2016MatrizRentabilidad/forzar_distrito_federal/graficas.php",
