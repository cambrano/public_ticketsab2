...
?>
	...
	<div id="bodymanager" class="bodymanager">
		...
		if($tipo_uso_plataforma=='all'){
			echo '<div class="submenux" onclick="subConfiguracionF_Distrito_FederalReportes2016()">F_Distrito_Federal Reporte '.$ano.'</div> / ';
			echo '<div class="submenux" onclick="subConfiguracionF_Distrito_FederalSeccionesIneReportes2016()">Secciones INE Reportes '.$ano.'</div> / ';
		}else{
			echo '<div class="submenux" onclick="subConfiguracionF_Distrito_FederalSeccionesIneReportes2016()">Secciones INE Reportes '.$ano.'</div> / ';
		}
		?>
