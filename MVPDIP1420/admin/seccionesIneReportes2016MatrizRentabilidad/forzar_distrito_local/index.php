...
?>
	...
	<div id="bodymanager" class="bodymanager">
		...
		if($tipo_uso_plataforma=='all'){
			echo '<div class="submenux" onclick="subConfiguracionF_Distrito_LocalReportes2016()">F_Distrito_Local Reporte '.$ano.'</div> / ';
			echo '<div class="submenux" onclick="subConfiguracionF_Distrito_LocalSeccionesIneReportes2016()">Secciones INE Reportes '.$ano.'</div> / ';
		}else{
			echo '<div class="submenux" onclick="subConfiguracionF_Distrito_LocalSeccionesIneReportes2016()">Secciones INE Reportes '.$ano.'</div> / ';
		}
		?>
