<?php
	...
	$id_partido_2016 = $configuracion_matriz_rentabilidad_secciones_ine_2016Datos['id_partido_2016_gobernador'];// Partidos 2016 PRI
	...
	if ($json_data === false) {
		...
		$archivo_json = $rutaEfs.'datos_generales_gobernador_2016_'.$id_municipio.'-'.$_COOKIE["id_usuario"].'.json';
	...
	if ($json_data === false) {
		...
		// Guarda el JSON en un archivo
		$archivo_json = $rutaEfs.'datos_partidos_gobernador_2016_'.$id_municipio.'-'.$_COOKIE["id_usuario"].'.json';
		if (file_put_contents($archivo_json, $json_data)) {
			//echo "Los datos se han guardado en $archivo_json";
		} else {
			//echo "Error al guardar los datos en $archivo_json";
