...
?>
	...
	<div id="bodymanager" class="bodymanager">
		...
		if($tipo_uso_plataforma=='all'){
			echo '<div class="submenux" onclick="subConfiguracionSenadorReportes2016()">Senador Reporte '.$ano.'</div> / ';
			echo '<div class="submenux" onclick="subConfiguracionSenadorSeccionesIneReportes2016()">Secciones INE Reportes '.$ano.'</div> / ';
		}else{
			echo '<div class="submenux" onclick="subConfiguracionSenadorSeccionesIneReportes2016()">Secciones INE Reportes '.$ano.'</div> / ';
		}
		?>
		...
		<label class="tituloForm">
			<font style="font-weight: initial;font-size: 15px">Senador:</font> <?= $municipioNombre; ?>
		</label><br>
