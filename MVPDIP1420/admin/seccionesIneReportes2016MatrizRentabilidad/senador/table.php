...
?> 
	<script type="text/javascript">
		...
		function verMasMunicipio(valor){
			link="seccionesIneReportes2016MatrizRentabilidad/senador/index.php?id="+valor; 
		...
		function downloadExcel(){
			...
			?>
			var link="seccionesIneReportes2016MatrizRentabilidad/senador/excel/index.php?cot=<?=$_COOKIE['pageService']?>";
			//window.open(link);
		...
		function printPdf() {
			...
			?>
			var link="seccionesIneReportes2016MatrizRentabilidad/senador/print/index.php?cot=<?=$_COOKIE['pageService']?>";
			//window.open(link);
