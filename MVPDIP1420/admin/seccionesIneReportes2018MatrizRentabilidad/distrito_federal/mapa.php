<?php
	...
	if(!empty($_POST)){
		...
		$id_municipio = explode(',', $id_municipio);
		$id_municipio = array_filter($id_municipio, 'strlen');
		$id_municipio = implode(',', $id_municipio);
		...
		*/
		...
		$sql = "SELECT * FROM secciones_ine WHERE id_distrito_federal = $id_distrito_federal ";
		$result = $conexion->query($sql);
		while($row=$result->fetch_assoc()){
		...
		$sql="
			...
			WHERE cvp.id_distrito_federal='{$id_distrito_federal}' AND cvp.tipo = '{$tipo}' {$sqlPartidos} {$sqlMunicipio} {$sqlDistritoLocal}
		...
		$sql="SELECT 
			...
			WHERE cprm.id_distrito_federal = '{$id_distrito_federal}'  {$sqlPartidosRM2019} {$sqlMunicipioRM2019} {$sqlDistritoLocalRM2019}
		...
		*/
		...
		if ($json_data === false) {
			...
			$archivo_json = $rutaEfs.'competitividad_rentabilidad_individual_distrito_federal_2018_'.$id_distrito_federal.'-'.$_COOKIE["id_usuario"].'.json';
		...
		if ($json_data === false) {
			...
			// Guarda el JSON en un archivo
			$archivo_json = $rutaEfs.'competitividad_rentabilidad_totales_distrito_federal_2018_'.$id_distrito_federal.'-'.$_COOKIE["id_usuario"].'.json';
			if (file_put_contents($archivo_json, $json_data)) {
				//echo "Los datos se han guardado en $archivo_json";
			} else {
				//echo "Error al guardar los datos en $archivo_json";
	...
	if(empty($_POST)){
		...
		if ($json_data === false) {
			...
			// Guarda el JSON en un archivo
			$archivo_json = $rutaEfs.'datos_secciones_ine_distrito_federal_2018_'.$id_distrito_federal.'-'.$_COOKIE["id_usuario"].'.json';
			if (file_put_contents($archivo_json, $json_data)) {
				//echo "Los datos se han guardado en $archivo_json";
			} else {
				//echo "Error al guardar los datos en $archivo_json";
	...
	if ($json_data === false) {
		...
		// Guarda el JSON en un archivo
		$archivo_json = $rutaEfs.'columnas_titulos_partidos_distrito_federal_2018_'.$id_distrito_federal.'-'.$_COOKIE["id_usuario"].'.json';
		if (file_put_contents($archivo_json, $json_data)) {
			//echo "Los datos se han guardado en $archivo_json";
		} else {
			//echo "Error al guardar los datos en $archivo_json";
	...
	if(!empty($columnas_datos)){
		...
		if ($json_data === false) {
			...
			// Guarda el JSON en un archivo
			$archivo_json = $rutaEfs.'columnas_datos_distrito_federal_2018_'.$id_distrito_federal.'-'.$_COOKIE["id_usuario"].'.json';
			if (file_put_contents($archivo_json, $json_data)) {
				//echo "Los datos se han guardado en $archivo_json";
			} else {
				//echo "Error al guardar los datos en $archivo_json";
		...
		if ($json_data === false) {
			...
			// Guarda el JSON en un archivo
			$archivo_json = $rutaEfs.'secciones_distrito_federal_2018_'.$id_distrito_federal.'-'.$_COOKIE["id_usuario"].'.json';
			if (file_put_contents($archivo_json, $json_data)) {
				//echo "Los datos se han guardado en $archivo_json";
			} else {
				//echo "Error al guardar los datos en $archivo_json";
