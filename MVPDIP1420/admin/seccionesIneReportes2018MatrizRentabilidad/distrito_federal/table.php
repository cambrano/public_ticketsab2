...
?> 
	<script type="text/javascript">
		...
		function verMasSeccion(valor){
			link="casillasVotosReportes2018/distrito_federal/index.php?id="+valor; 
			var link2="casillasVotosReportes2018/distrito_federal/index.php";
		...
		function verMasDistritoFederal(valor){
			link="seccionesIneReportes2018MatrizRentabilidad/distrito_federal/index.php?id="+valor; 
			var link2="seccionesIneReportes2018MatrizRentabilidad/distrito_federal/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
		...
		function verMasDistritoFederalMatrizRentabilidad2018(valor){
			link="seccionesIneReportes2018MatrizRentabilidad/distrito_federal/index.php?id=<?= $id_distrito_federal ?>"; 
			var link2="seccionesIneReportes2018MatrizRentabilidad/distrito_federal/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
		...
		function downloadExcel(){
			...
			?>
			var link="seccionesIneReportes2018MatrizRentabilidad/distrito_federal/excel/index.php?cot=<?=$_COOKIE['pageService']?>";
			//window.open(link);
		...
		function printPdf() {
			...
			?>
			var link="seccionesIneReportes2018MatrizRentabilidad/distrito_federal/print/index.php?cot=<?=$_COOKIE['pageService']?>";
			//window.open(link);
