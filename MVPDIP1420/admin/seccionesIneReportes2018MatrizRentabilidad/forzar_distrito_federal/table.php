...
?> 
	<script type="text/javascript">
		$(document).ready(function() {
			var dataTable = $('#secciones_reportes-tabla').DataTable( {
				...
				"aoColumnDefs": [
									...
									{ "targets": [ 0,1,2,3,14 ],"visible": false}
								],
		...
		function verMasSeccion(valor){
			link="casillasVotosReportes2018/forzar_distrito_federal/index.php?id="+valor; 
			var link2="casillasVotosReportes2018/forzar_distrito_federal/index.php";
		...
		function verMasMunicipio(valor){
			link="seccionesIneReportes2018MatrizRentabilidad/forzar_distrito_federal/index.php?id="+valor; 
			var link2="seccionesIneReportes2018MatrizRentabilidad/forzar_distrito_federal/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
		...
		function verMasMunicipioMatrizRentabilidad2018(valor){
			link="seccionesIneReportes2018MatrizRentabilidad/forzar_distrito_federal/index.php?id=<?= $id_municipio ?>"; 
			var link2="seccionesIneReportes2018MatrizRentabilidad/forzar_distrito_federal/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
		...
		function downloadExcel(){
			...
			?>
			var link="seccionesIneReportes2018MatrizRentabilidad/forzar_distrito_federal/excel/index.php?cot=<?=$_COOKIE['pageService']?>";
			//window.open(link);
		...
		function printPdf() {
			...
			?>
			var link="seccionesIneReportes2018MatrizRentabilidad/forzar_distrito_federal/print/index.php?cot=<?=$_COOKIE['pageService']?>";
			//window.open(link);
				...
				foreach ($datos_secciones_ine as $key => $value) {
					...
					$informacion_primera_fuerza = "
								<div style='text-transform: none;'>
									<img style='width:45px; height:45px' class='bntImageSize' src='images/logos_partidos/".$datos_primera_fuerza['logo']."'>&nbsp;
										<b>".$partidos[$primera_fuerza]['nombre_corto']."</b><br>
					...
					if(!empty($datos_primera_fuerza['coaliciones_orden_votos_individual'])){
						$informacion_primera_fuerza .="
								...
								foreach ($datos_primera_fuerza['coaliciones_orden_votos_individual'] as $keyPartido => $valueVoto) {
									...
									$informacion_primera_fuerza .="
												<tr>
													<td style='border:1px solid;padding: 2px;background-color: #f8f9fb'>".$partidos[$keyPartido]['nombre_corto']."</td>
					...
					$informacion_segunda_fuerza = "
								<div style='text-transform: none;'>
									<img style='width:45px; height:45px' class='bntImageSize' src='images/logos_partidos/".$datos_segunda_fuerza['logo']."'>&nbsp;
										<b>".$partidos[$segunda_fuerza]['nombre_corto']."</b><br>
					...
					$informacion_social1 = "
							<table  style='width:100%;border: none !important;' >
								<tr>
									<td style='padding: 2px;border: none !important;'>Prog. Gob.</td>
									<td style='padding: 2px;border: none !important;'><b>".number_format($value['apoyos_programas'], 0, '.', ',')."</b></td>
								</tr>
								<tr>
									<td style='padding: 2px;border: none !important;'>Prog. Inv.</td>
									<td style='padding: 2px;border: none !important;'><b>".number_format($value['acciones_obras'], 0, '.', ',')."</b></td>
								</tr>
							</table>
							<br>
							<table   style='width:100%;border: none !important;'>
								<tr>
									<td style='padding: 2px;border: none !important;'>Grupo Interes.</td>
									<td style='padding: 2px;border: none !important;'><b>".number_format($value['grupos_interes'], 0, '.', ',')."</b></td>
								</tr>
								<tr>
									<td style='padding: 2px;border: none !important;'>Ciudadanos.</td>
									<td style='padding: 2px;border: none !important;'><b>".number_format($value['ciudadanos_registrados'], 0, '.', ',')."</b></td>
								</tr>
								<tr>
									<td style='padding: 2px;border: none !important;'>Militantes.</td>
									<td style='padding: 2px;border: none !important;'><b>".number_format($value['militantes'], 0, '.', ',')."</b></td>
								</tr>
								<tr>
									<td style='padding: 2px;border: none !important;'>Funcionarios.</td>
									<td style='padding: 2px;border: none !important;'><b>".number_format($value['funcionarios'], 0, '.', ',')."</b></td>
								</tr>
							</table>
