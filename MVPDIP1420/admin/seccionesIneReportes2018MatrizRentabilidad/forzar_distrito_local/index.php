...
?>
	...
	<div id="bodymanager" class="bodymanager">
		...
		if($tipo_uso_plataforma=='all'){
			echo '<div class="submenux" onclick="subConfiguracionF_Distrito_LocalReportes2018()">F_Distrito_Local Reporte '.$ano.'</div> / ';
			echo '<div class="submenux" onclick="subConfiguracionF_Distrito_LocalSeccionesIneReportes2018()">Secciones INE Reportes '.$ano.'</div> / ';
		}else{
			echo '<div class="submenux" onclick="subConfiguracionF_Distrito_LocalSeccionesIneReportes2018()">Secciones INE Reportes '.$ano.'</div> / ';
		}
		?>
