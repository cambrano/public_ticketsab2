...
?> 
	<script type="text/javascript">
		...
		function verMasSeccion(valor){
			link="casillasVotosReportes2018/forzar_distrito_local/index.php?id="+valor; 
			var link2="casillasVotosReportes2018/forzar_distrito_local/index.php";
		...
		function verMasMunicipio(valor){
			link="seccionesIneReportes2018MatrizRentabilidad/forzar_distrito_local/index.php?id="+valor; 
			var link2="seccionesIneReportes2018MatrizRentabilidad/forzar_distrito_local/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
		...
		function verMasMunicipioMatrizRentabilidad2018(valor){
			link="seccionesIneReportes2018MatrizRentabilidad/forzar_distrito_local/index.php?id=<?= $id_municipio ?>"; 
			var link2="seccionesIneReportes2018MatrizRentabilidad/forzar_distrito_local/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
		...
		function downloadExcel(){
			...
			?>
			var link="seccionesIneReportes2018MatrizRentabilidad/forzar_distrito_local/excel/index.php?cot=<?=$_COOKIE['pageService']?>";
			//window.open(link);
		...
		function printPdf() {
			...
			?>
			var link="seccionesIneReportes2018MatrizRentabilidad/forzar_distrito_local/print/index.php?cot=<?=$_COOKIE['pageService']?>";
			//window.open(link);
