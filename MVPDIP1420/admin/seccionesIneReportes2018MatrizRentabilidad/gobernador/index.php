...
?>
	...
	<div id="bodymanager" class="bodymanager">
		...
		if($tipo_uso_plataforma=='all'){
			echo '<div class="submenux" onclick="subConfiguracionGobernadorReportes2018()">Gobernador Reporte '.$ano.'</div> / ';
			echo '<div class="submenux" onclick="subConfiguracionGobernadorSeccionesIneReportes2018()">Secciones INE Reportes '.$ano.'</div> / ';
		}else{
			echo '<div class="submenux" onclick="subConfiguracionGobernadorSeccionesIneReportes2018()">Secciones INE Reportes '.$ano.'</div> / ';
		}
		?>
