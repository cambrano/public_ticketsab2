...
?> 
	<script type="text/javascript">
		...
		function verMasSeccion(valor){
			link="casillasVotosReportes2018/gobernador/index.php?id="+valor; 
			var link2="casillasVotosReportes2018/gobernador/index.php";
		...
		function verMasMunicipio(valor){
			link="seccionesIneReportes2018MatrizRentabilidad/gobernador/index.php?id="+valor; 
			var link2="seccionesIneReportes2018MatrizRentabilidad/gobernador/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
		...
		function verMasMunicipioMatrizRentabilidad2018(valor){
			link="seccionesIneReportes2018MatrizRentabilidad/gobernador/index.php?id=<?= $id_municipio ?>"; 
			var link2="seccionesIneReportes2018MatrizRentabilidad/gobernador/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
		...
		function downloadExcel(){
			...
			?>
			var link="seccionesIneReportes2018MatrizRentabilidad/gobernador/excel/index.php?cot=<?=$_COOKIE['pageService']?>";
			//window.open(link);
		...
		function printPdf() {
			...
			?>
			var link="seccionesIneReportes2018MatrizRentabilidad/gobernador/print/index.php?cot=<?=$_COOKIE['pageService']?>";
			//window.open(link);
