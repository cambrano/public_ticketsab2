...
?> 
	<script type="text/javascript">
		...
		function verMasMunicipio(valor){
			link="seccionesIneReportes2021/forzar_distrito_federal/index.php?id="+valor; 
			var link2="seccionesIneReportes2021/forzar_distrito_federal/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
