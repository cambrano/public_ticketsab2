...
?> 
	<script type="text/javascript">
		...
		function verMasDistritoFederal(valor){
			link="seccionesIneReportes2021MatrizRentabilidad/distrito_federal/index.php?id="+valor; 
		...
		function verMasDistritoFederalMatrizRentabilidad2021(valor){
		...
		function downloadExcel(){
			...
			?>
			var link="seccionesIneReportes2021MatrizRentabilidad/distrito_federal/excel/index.php?cot=<?=$_COOKIE['pageService']?>";
			//window.open(link);
		...
		function printPdf() {
			...
			?>
			var link="seccionesIneReportes2021MatrizRentabilidad/distrito_federal/print/index.php?cot=<?=$_COOKIE['pageService']?>";
			//window.open(link);
