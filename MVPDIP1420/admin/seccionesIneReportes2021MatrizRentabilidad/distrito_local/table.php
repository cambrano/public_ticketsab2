...
?> 
	<script type="text/javascript">
		...
		function verMasSeccion(valor){
			link="casillasVotosReportes2021/distrito_local/index.php?id="+valor; 
			var link2="casillasVotosReportes2021/distrito_local/index.php";
		...
		function verMasDistritoLocal(valor){
			link="seccionesIneReportes2021MatrizRentabilidad/distrito_local/index.php?id="+valor; 
			var link2="seccionesIneReportes2021MatrizRentabilidad/distrito_local/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
		...
		function verMasDistritoLocalMatrizRentabilidad2021(valor){
			link="seccionesIneReportes2021MatrizRentabilidad/distrito_local/index.php?id=<?= $id_distrito_local ?>"; 
			var link2="seccionesIneReportes2021MatrizRentabilidad/distrito_local/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
		...
		function printPdf() {
			...
			?>
			var link="seccionesIneReportes2021MatrizRentabilidad/distrito_local/print/index.php?cot=<?=$_COOKIE['pageService']?>";
			//window.open(link);
