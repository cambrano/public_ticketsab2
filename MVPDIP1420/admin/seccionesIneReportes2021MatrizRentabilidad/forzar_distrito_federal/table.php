...
?> 
	<script type="text/javascript">
		...
		function verMasSeccion(valor){
			link="casillasVotosReportes2021/forzar_distrito_federal/index.php?id="+valor; 
			var link2="casillasVotosReportes2021/forzar_distrito_federal/index.php";
		...
		function verMasMunicipio(valor){
			link="seccionesIneReportes2021MatrizRentabilidad/forzar_distrito_federal/index.php?id="+valor; 
			var link2="seccionesIneReportes2021MatrizRentabilidad/forzar_distrito_federal/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
		...
		function verMasMunicipioMatrizRentabilidad2021(valor){
			link="seccionesIneReportes2021MatrizRentabilidad/forzar_distrito_federal/index.php?id=<?= $id_municipio ?>"; 
			var link2="seccionesIneReportes2021MatrizRentabilidad/forzar_distrito_federal/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
		...
		function downloadExcel(){
			...
			?>
			var link="seccionesIneReportes2021MatrizRentabilidad/forzar_distrito_federal/excel/index.php?cot=<?=$_COOKIE['pageService']?>";
			//window.open(link);
		...
		function printPdf() {
			...
			?>
			var link="seccionesIneReportes2021MatrizRentabilidad/forzar_distrito_federal/print/index.php?cot=<?=$_COOKIE['pageService']?>";
			//window.open(link);
