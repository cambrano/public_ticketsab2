...
?> 
	<script type="text/javascript">
		...
		function verMasSeccion(valor){
			link="casillasVotosReportes2021/gobernador/index.php?id="+valor; 
			var link2="casillasVotosReportes2021/gobernador/index.php";
		...
		function verMasMunicipio(valor){
			link="seccionesIneReportes2021MatrizRentabilidad/gobernador/index.php?id="+valor; 
		...
		function verMasMunicipioMatrizRentabilidad2021(valor){
			link="seccionesIneReportes2021MatrizRentabilidad/gobernador/index.php?id=<?= $id_municipio ?>"; 
			var link2="seccionesIneReportes2021MatrizRentabilidad/gobernador/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
		...
		function downloadExcel(){
			...
			?>
			var link="seccionesIneReportes2021MatrizRentabilidad/gobernador/excel/index.php?cot=<?=$_COOKIE['pageService']?>";
			//window.open(link);
		...
		function printPdf() {
			...
			?>
			var link="seccionesIneReportes2021MatrizRentabilidad/gobernador/print/index.php?cot=<?=$_COOKIE['pageService']?>";
			//window.open(link);
