<?php
	...
	if(!empty($_POST)){
		...
		$id_partido_2021 = $configuracion_matriz_rentabilidad_secciones_ine_2021Datos['id_partido_2021_distrito_federal'];// Partidos 2021 PRI
		//$id_partido_2021 = $configuracion_matriz['id_partido_2021'] = '1';// Partidos 2021
		$id_partido_legado = $configuracion_matriz_rentabilidad_secciones_ine_2021Datos['id_partido_legado'];// Partidos Legados
		#$tipo = $configuracion_matriz_rentabilidad_secciones_ine_2021Datos['tipo_eleccion'] = '1';// 0 - Ayuntamiento | 1 - Distrito Federal | 2 - Distrito Federal
