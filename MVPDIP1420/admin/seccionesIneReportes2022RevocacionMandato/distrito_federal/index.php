...
?>
	...
	<div id="bodymanager" class="bodymanager">
		...
		if($tipo_uso_plataforma=='distrito_federal'){
			echo '<div class="submenux" onclick="subConfiguracionDistritosFederalesSeccionesIneReportes2018()">Secciones INE Reportes 2019</div> / ';
		}else{
			echo '<div class="submenux" onclick="subConfiguracionDistritosFederalesReportes2018()">Distritos Federales Reporte 2019</div> /';
		}
		?>
		<br>
