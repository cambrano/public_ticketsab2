<?php
	...
	$sql = "SELECT 
				t.votos_validos,
				(SELECT SUM(votos_nulos) FROM casillas_votos_2024 WHERE id_distrito_local={$id_distrito_local} AND tipo = '{$tipo}' {$sqlSeccionesIne} {$sqlDistritos} ) votos_nulos,
				(SELECT SUM(votos_can_nreg) FROM casillas_votos_2024 WHERE id_distrito_local={$id_distrito_local} AND tipo = '{$tipo}' {$sqlSeccionesIne} {$sqlDistritos} ) votos_can_nreg,
				...
				(SELECT COUNT(id) FROM casillas_votos_2024 WHERE id_distrito_local={$id_distrito_local} AND tipo = '{$tipo}' {$sqlSeccionesIne} {$sqlDistritos} ) casillas,
				(SELECT SUM(lista_nominal) FROM casillas_votos_2024 WHERE id_distrito_local={$id_distrito_local} AND tipo = '{$tipo}' {$sqlSeccionesIne} {$sqlDistritos} ) total_lista_nominal,
			...
			FROM
				(SELECT SUM(votos) votos_validos FROM  casillas_votos_partidos_2024 WHERE id_distrito_local={$id_distrito_local} AND tipo =  '{$tipo}' {$sqlSeccionesIne} {$sqlDistritos} )t
