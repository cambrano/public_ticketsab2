...
?>
	<script type="text/javascript">
		function searchTable(value){
			...
			*/
			$.ajax({
				type: "POST",
				url: "seccionesIneReportes2024/forzar_distrito_federal/mapa.php",
				data: {searchTable: searchTable,mapa:mapa},
				async: true,
				success: function(data) {
					$("#mapaLoad").html(data);
			...
			$.ajax({
				type: "POST",
				url: "seccionesIneReportes2024/forzar_distrito_federal/totales.php",
				data: {searchTable: searchTable,mapa:mapa},
				async: true,
				success: function(data) {
	...
	<div style="width: 100%;">
		<button class="btn btn-info"  onClick="verMasMunicipioMatrizRentabilidad2024()">
