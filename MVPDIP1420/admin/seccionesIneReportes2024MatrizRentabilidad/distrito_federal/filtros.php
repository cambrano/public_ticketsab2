...
?>
	<script type="text/javascript">
		...
		function searchTable(value) {
			...
			if(id_municipio==""){
				$('#secciones_reportes-tabla').DataTable().column(5).search(id_municipio).draw();
			}else{
				//$('#secciones_reportes-tabla').DataTable().column(0).search("(^"+id_seccion_ine+"$)",true,false).draw();
				$('#secciones_reportes-tabla').DataTable().column(5).search(id_municipio_array_table.join('|'), true, false).draw();
			}
			...
			if(id_distrito_local==""){
				$('#secciones_reportes-tabla').DataTable().column(7).search(id_distrito_local).draw();
			}else{
				//$('#secciones_reportes-tabla').DataTable().column(0).search("(^"+id_seccion_ine+"$)",true,false).draw();
				$('#secciones_reportes-tabla').DataTable().column(7).search(id_distrito_local_array_table.join('|'), true, false).draw();
			}
			...
			if(id_distrito_federal==""){
				$('#secciones_reportes-tabla').DataTable().column(8).search(id_distrito_federal).draw();
			}else{
				//$('#secciones_reportes-tabla').DataTable().column(0).search("(^"+id_seccion_ine+"$)",true,false).draw();
				$('#secciones_reportes-tabla').DataTable().column(8).search(id_distrito_federal_array_table.join('|'), true, false).draw();
			}
			...
			// Aplicar el filtro en DataTables
			if (tipo_seccion === "") {
				$('#secciones_reportes-tabla').DataTable().column(10).search("").draw();
			} else {
				$('#secciones_reportes-tabla')
					.DataTable()
					.column(10)
			...
			// Aplicar el filtro en DataTables
			if (prioridad === "") {
				$('#secciones_reportes-tabla').DataTable().column(14).search("").draw();
			} else {
				$('#secciones_reportes-tabla')
					.DataTable()
					.column(14)
