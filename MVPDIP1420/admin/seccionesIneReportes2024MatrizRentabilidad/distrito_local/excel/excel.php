<?php
	...
	$rutaEfs = rutaEfs();
	$archivo_json = $rutaEfs . 'titulos_distrito_local_2024_-'.$id_municipio.'-'.$_COOKIE["id_usuario"].'.json';
	...
	$archivo_json = $rutaEfs . 'distrito_local_2024_'.$id_municipio.'-'.$_COOKIE["id_usuario"].'.json';
	if (file_exists($archivo_json)) {
		// Lee el contenido del archivo JSON
		$json_data = file_get_contents($archivo_json);
	...
	*/
	...
	$keywords = array('Matriz de Rentabilidad Distrito Local','Data','Información');
	$writer->setTitle('Matriz de Rentabilidad Distrito Local');
