...
?>
	...
	<div id="bodymanager" class="bodymanager">
		...
		if($tipo_uso_plataforma=='all'){
			echo '<div class="submenux" onclick="subConfiguracionDistritosLocalesReportes2024()">Distritos Locales Reporte '.$ano.'</div> / ';
			echo '<div class="submenux" onclick="subConfiguracionDistritosLocalesSeccionesIneReportes2024()">Secciones INE Reportes '.$ano.'</div> / ';
		}else{
			echo '<div class="submenux" onclick="subConfiguracionDistritosLocalesSeccionesIneReportes2024()">Secciones INE Reportes '.$ano.'</div> / ';
		}
		?>
