...
?> 
	<script type="text/javascript">
		...
		function verMasSeccion(valor){
			link="casillasVotosReportes2024/distrito_local/index.php?id="+valor; 
			var link2="casillasVotosReportes2024/distrito_local/index.php";
		...
		function verMasDistritoLocal(valor){
			link="seccionesIneReportes2024MatrizRentabilidad/distrito_local/index.php?id="+valor; 
			var link2="seccionesIneReportes2024MatrizRentabilidad/distrito_local/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
		...
		function verMasDistritoLocalMatrizRentabilidad2024(valor){
			link="seccionesIneReportes2024MatrizRentabilidad/distrito_local/index.php?id=<?= $id_distrito_local ?>"; 
			var link2="seccionesIneReportes2024MatrizRentabilidad/distrito_local/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
		...
		function downloadExcel(){
			...
			?>
			var link="seccionesIneReportes2024MatrizRentabilidad/distrito_local/excel/index.php?cot=<?=$_COOKIE['pageService']?>";
			//window.open(link);
		...
		function printPdf() {
			...
			?>
			var link="seccionesIneReportes2024MatrizRentabilidad/distrito_local/print/index.php?cot=<?=$_COOKIE['pageService']?>";
			//window.open(link);
