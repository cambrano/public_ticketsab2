...
?> 
	<script type="text/javascript">
		...
		function verMasSeccion(valor){
			link="casillasVotosReportes2024/forzar_distrito_federal/index.php?id="+valor; 
			var link2="casillasVotosReportes2024/forzar_distrito_federal/index.php";
		...
		function verMasMunicipio(valor){
			link="seccionesIneReportes2024MatrizRentabilidad/forzar_distrito_federal/index.php?id="+valor; 
			var link2="seccionesIneReportes2024MatrizRentabilidad/forzar_distrito_federal/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
		...
		function verMasMunicipioMatrizRentabilidad2024(valor){
			link="seccionesIneReportes2024MatrizRentabilidad/forzar_distrito_federal/index.php?id=<?= $id_municipio ?>"; 
			var link2="seccionesIneReportes2024MatrizRentabilidad/forzar_distrito_federal/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
		...
		function downloadExcel(){
			...
			?>
			var link="seccionesIneReportes2024MatrizRentabilidad/forzar_distrito_federal/excel/index.php?cot=<?=$_COOKIE['pageService']?>";
			//window.open(link);
		...
		function printPdf() {
			...
			?>
			var link="seccionesIneReportes2024MatrizRentabilidad/forzar_distrito_federal/print/index.php?cot=<?=$_COOKIE['pageService']?>";
			//window.open(link);
