<?php
	...
	$moduloAccionPermisos = moduloAccionPermisos('sistema_unico_beneficiarios','cartografias_municipios_2024',$_COOKIE["id_usuario"]);
	...
	$rutaEfs = rutaEfs();
	$archivo_json = $rutaEfs . 'titulos_municipio_2024_-'.$id_municipio.'-'.$_COOKIE["id_usuario"].'.json';
	...
	$filename = 'MatrizRentabilidadMunicipio_'.str_replace(" ", "_", $datos_generales['territorio_nombre']).'_-_'.date("Ymd-His").'-'.$gen_id3.$mk_id.'.xlsx';
