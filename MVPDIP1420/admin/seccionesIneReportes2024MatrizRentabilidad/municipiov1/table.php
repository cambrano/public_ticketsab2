...
?> 
	<script type="text/javascript">
		...
		function verMasMunicipio(valor){
			link="seccionesIneReportes2024MatrizRentabilidad/municipio/index.php?id="+valor; 
			var link2="seccionesIneReportes2024MatrizRentabilidad/municipio/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
		...
		function verMasMunicipioMatrizRentabilidad2024(valor){
			link="seccionesIneReportes2024MatrizRentabilidad/municipio/index.php?id=<?= $id_municipio ?>"; 
			var link2="seccionesIneReportes2024MatrizRentabilidad/municipio/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
		...
		function downloadExcel(){
			...
			?>
			var link="seccionesIneReportes2024MatrizRentabilidad/municipio/excel/index.php?cot=<?=$_COOKIE['pageService']?>";
			//window.open(link);
		...
		function printPdf() {
			...
			?>
			var link="seccionesIneReportes2024MatrizRentabilidad/municipio/print/index.php?cot=<?=$_COOKIE['pageService']?>";
			//window.open(link);
			...
			<?php
				foreach ($datos_secciones_ine as $key => $value) {
					...
					$informacion_social = " 
						...
						Eventos Agenda Gobierno:<b>".number_format($value['eventos_agenda_gobierno'], 0, '.', ',')."</b><br>
					";
