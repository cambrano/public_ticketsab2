...
?>
	...
	<div id="bodymanager" class="bodymanager">
		...
		if($tipo_uso_plataforma=='all'){
			echo '<div class="submenux" onclick="subConfiguracionSenadorReportes2024()">Senador Reporte '.$ano.'</div> / ';
			echo '<div class="submenux" onclick="subConfiguracionSenadorSeccionesIneReportes2024()">Secciones INE Reportes '.$ano.'</div> / ';
		}else{
			echo '<div class="submenux" onclick="subConfiguracionSenadorSeccionesIneReportes2024()">Secciones INE Reportes '.$ano.'</div> / ';
		}
		?>
