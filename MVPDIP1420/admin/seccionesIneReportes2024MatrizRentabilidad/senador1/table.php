...
?> 
	<script type="text/javascript">
		...
		function verMasSeccion(valor){
			link="casillasVotosReportes2024/senador/index.php?id="+valor; 
			var link2="casillasVotosReportes2024/senador/index.php";
		...
		function verMasMunicipio(valor){
			link="seccionesIneReportes2024MatrizRentabilidad/senador/index.php?id="+valor; 
			var link2="seccionesIneReportes2024MatrizRentabilidad/senador/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
		...
		function verMasMunicipioMatrizRentabilidad2024(valor){
			link="seccionesIneReportes2024MatrizRentabilidad/senador/index.php?id=<?= $id_municipio ?>"; 
			var link2="seccionesIneReportes2024MatrizRentabilidad/senador/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
		...
		function downloadExcel(){
			...
			?>
			var link="seccionesIneReportes2024MatrizRentabilidad/senador/excel/index.php?cot=<?=$_COOKIE['pageService']?>";
			//window.open(link);
		...
		function printPdf() {
			...
			?>
			var link="seccionesIneReportes2024MatrizRentabilidad/senador/print/index.php?cot=<?=$_COOKIE['pageService']?>";
			//window.open(link);
