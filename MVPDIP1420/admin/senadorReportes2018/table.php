...
?>
	<script type="text/javascript">
		...
		function verMasMunicipio(valor) {
			link = "seccionesIneReportes2018/senador/index.php?id=" + valor;
			var link2 = "seccionesIneReportes2018/senador/index.php";
		...
		function verMasMunicipioMatrizRentabilidad(valor) {
			link = "seccionesIneReportes2018MatrizRentabilidad/senador/index.php?id=" +
					valor;
