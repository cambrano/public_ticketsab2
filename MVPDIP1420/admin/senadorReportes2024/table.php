...
?>
	<script type="text/javascript">
		...
		function verMasMunicipio(valor) {
			link = "seccionesIneReportes2024/senador/index.php?id=" + valor;
			var link2 = "seccionesIneReportes2024/senador/index.php";
		...
		function verMasMunicipioMatrizRentabilidad(valor) {
			link = "seccionesIneReportes2024MatrizRentabilidad/senador/index.php?id=" +
					valor;
		...
		function verMasMunicipioMandato2022(valor) {
			link = "seccionesIneReportes2022RevocacionMandato/senador/index.php?id=" + valor;
			var link2 = "seccionesIneReportes2022RevocacionMandato/senador/index.php";
			dataString = 'urlink=' + link2;
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
