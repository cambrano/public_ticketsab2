...
?>
	<script type="text/javascript">
		function searchTable(){
			...
			$.ajax({
				type: "POST",
				url: "servidoresCorreos/table.php",
	...
	<div class="sucForm">
		<label class="labelForm" id="labeltemaname">Dominio</label><br>
		<input data-column="1" id="sufijo" autocomplete="off" type="text" onkeyup="searchTable();" > <br>
	</div>
	<style type="text/css">
		.ui-autocomplete {
			max-height: 180px;
