<?php
	...
	$tablasRelacionadas = tablasRelacionadas('sistemas_operativos',$id);
...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "sistemasOperativos/db_delete.php",
				data: dataString,
				success: function(data) { 
					if(data=="SI"){
						document.getElementById("mensaje").classList.remove("mensajeError"); 
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Eliminar Sistema Operativo</font>
				</label>
			</div>
		</div>
		<div class="bodyinput">
			...
			<label class="descripcionForm">
				<strong><?= $sistema_operativoDatos['nombre']?></strong>
			</label><br>
			<?php
			if($registros_tablas!=''){
