...
?>
	...
	<div class="sucForm">
		<label class="labelForm" id="labeltemaname">Tipo Estructura Ciudadano</label><br>
		<select name="id_tipo_estructura_ciudadano" id="id_tipo_estructura_ciudadano" class='myselect' onchange="searchTable();" >
			<?php
			echo tipos_estructuras_ciudadanos('','');
			?>
		</select>
	</div>
	<style type="text/css">
