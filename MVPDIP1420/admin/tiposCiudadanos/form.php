...
?>
	<div style=" width: 100%; display:inline-block; text-align: left;">
		...
		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Tipo Estructura Ciudadano<font color="#FF0004">*</font></label><br>
			<select name="id_tipo_estructura_ciudadano" id="id_tipo_estructura_ciudadano" class='myselect'>  
				<?php echo tipos_estructuras_ciudadanos($tipo_ciudadanoDatos['id_tipo_estructura_ciudadano']) ?>
			</select>
		</div>
