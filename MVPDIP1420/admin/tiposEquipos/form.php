...
?>
	<div style=" width: 100%; display:inline-block; text-align: left;">
		<div class="sucFormTitulo">
			<label class="labelForm" id="labeltemaname">Datos Tipo de Equipo</label>
		</div>
		<div class="sucForm">
		...
		<div class="sucForm">
			...
			<input class="inputlogin" type="text" style="width: 100%" name="nombre" autocomplete="off"  id="nombre" value="<?= $tipo_equipoDatos['nombre'] ?>" placeholder="Nombre" /><br>
		</div>
