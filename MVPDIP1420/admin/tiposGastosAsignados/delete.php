<?php
	...
	echo $redirectSecurity=redirectSecurity($id,'tipos_gastos_asignados','tiposGastos','index');
	if($redirectSecurity!=""){
		die;
	}
	...
	$tablasRelacionadas = tablasRelacionadas('tipos_gastos_asignados',$id);
...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "tiposGastosAsignados/db_delete.php",
				data: dataString,
				success: function(data) { 
					if(data=="SI"){
						document.getElementById("mensaje").classList.remove("mensajeError"); 
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Eliminar Tipo de Gasto Asignado</font>
				</label>
			</div>
		</div>
		<div class="bodyinput">
			<label class="labelForm" id="labeltemaname">Tipo de Gasto Asignado</label><br>
			<label class="descripcionForm">
				<strong><?= $tipo_gasto_asignadoDatos['nombre']?></strong>
			</label><br>
			<?php
			if($registros_tablas!=''){
