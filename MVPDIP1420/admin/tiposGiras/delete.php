<?php
	...
	$tablasRelacionadas = tablasRelacionadas('tipos_giras',$id);
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Eliminar Tipo Agenda</font>
				</label>
			</div>
		</div>
		<div class="bodyinput">
			<label class="labelForm" id="labeltemaname">Tipo Gira</label><br>
			<label class="descripcionForm">
				<strong><?= $tipo_giraDatos['nombre']?></strong>
			</label><br>
			<?php
			if($registros_tablas!=''){
