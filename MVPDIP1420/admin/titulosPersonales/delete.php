<?php
	...
	$tablasRelacionadas = tablasRelacionadas('titulos_personales',$id);
...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "titulosPersonales/db_delete.php",
				data: dataString,
				success: function(data) { 
					if(data=="SI"){
						document.getElementById("mensaje").classList.remove("mensajeError"); 
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Eliminar Titulo Personal</font>
				</label>
			</div>
		</div>
		<div class="bodyinput">
			<label class="labelForm" id="labeltemaname">Titulo Personal</label><br>
			<label class="descripcionForm">
				<strong><?= $titulo_personalDatos['nombre']?></strong>
			</label><br>
			<?php
			if($registros_tablas!=''){
