<?php
	...
	$sql = "SELECT count(*) total FROM titulos_personales WHERE 1 = 1   ";
	...
	////////////////////////////
	////////////////////////////
	$sql = "SELECT id,clave,nombre FROM titulos_personales WHERE 1 = 1  "; 
	...
	if($post_search){
		$sqlContadorScript = "SELECT count(*) total FROM titulos_personales WHERE 1 = 1   "; 
