<?php
	...
	$sql = "SELECT count(*) total FROM ubicaciones WHERE 1 = 1   ";
	...
	////////////////////////////
	////////////////////////////
	$sql = "SELECT id,clave,nombre FROM ubicaciones WHERE 1 = 1  "; 
	...
	if($post_search){
		$sqlContadorScript = "SELECT count(*) total FROM ubicaciones WHERE 1 = 1   "; 
