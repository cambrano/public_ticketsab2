...
?>
	<script type="text/javascript">
		...
		function searchTable(value){
			...
			$.ajax({
				type: "POST",
				url: "usuarioDependencias/table.php",
	...
	<div class="sucForm">
		...
		<select class="selectpicker" data-live-search="true" data-size="5" data-actions-box="true" title="Seleccione" id="id_dependencia" onchange="searchTable(1);">
		<?php
			echo dependencias();
		?>
		</select><br>
