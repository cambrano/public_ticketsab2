<?php
	...
	$tablasRelacionadas = tablasRelacionadas('zonas_importantes',$id);
...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "zonasImportantes/db_delete.php",
				data: dataString,
				success: function(data) { 
					if(data=="SI"){
						document.getElementById("sumbmit").disabled = true;
	...
	<div class="bodymanager" id="bodymanager"> 
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Eliminar Zona Importante</font>
				</label><br>
		...
		<div class="bodyinput">
			...
			<label class="descripcionForm">
				<strong><?=$zona_importanteDatos['nombre']; ?></strong>
			</label><br><br>
