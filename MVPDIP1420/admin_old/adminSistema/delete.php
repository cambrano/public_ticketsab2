<?php
	...
	@session_start();
	$_SESSION['Paguinasub']="adminSistema/delete.php";
	if(!empty($_GET)){
...
?>
	...
	<script language="javascript" type="text/javascript">
		function cerrar(){
			$("#homebody").load('adminSistema/index.php');
		}
		function guardar() { 
			...
			$.ajax({
				type: "POST",
				url: "adminSistema/db_delete.php",
				data: dataString,
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Eliminar Administrador Sistema</font>
				</label><br>
			</div>
		</div>
		<div class="bodyinput">
