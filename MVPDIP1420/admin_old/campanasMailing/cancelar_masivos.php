<?php
	...
	@session_start(); 
	$_SESSION['Paguinasub']="campanasMailing/cancelar_masivos.php";
	if(!empty($_GET)){
...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "campanasMailing/db_cancelar_masivos.php",
				data: dataString,
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Cancelar Correos Masivos </font>
				</label>
			</div>
		</div>
		<div class="bodyinput">
