<?php
	...
	@session_start(); 
	$_SESSION['Paguinasub']="campanasMailing/reenviar_masivos_segmentada.php";
	if(!empty($_GET)){
...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "campanasMailing/db_reenviar_masivos_segmentada.php",
				data: {campana_mailing: campana_mailing,campana_mailing_cartografia:campana_mailing_cartografia,campana_mailing_encuesta:campana_mailing_encuesta,campana_mailing_tipo_ciudadano:campana_mailing_tipo_ciudadano,campana_mailing_tipo_categoria_ciudadano:campana_mailing_tipo_categoria_ciudadano},
				success: function(data) {
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Correos Masivos Segmentados</font>
				</label>
			</div>
		</div>
		<div class="bodyinput">
