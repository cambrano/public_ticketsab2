<?php
	...
	@session_start(); 
	$_SESSION['Paguinasub']="campanasWhatsapp/cancelar_masivos.php";
	if(!empty($_GET)){
...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "campanasWhatsapp/db_cancelar_masivos.php",
				data: dataString,
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Cancelar Whatsapp Masivos </font>
				</label>
			</div>
		</div>
		<div class="bodyinput">
