<?php
	...
	if(!empty($_POST)){
		...
		$id_api_whatsapp = $_POST['correo_electronico_prueba'][0]['id_api_whatsapp'];
		$correo_whatsappDatos = correo_whatsappDatos($id_api_whatsapp);
		...
		$correo_electronico = array(
			"[*__Correo_Electronico_Repuesta__*]" => $correo_whatsappDatos['correo_electronico'],
			"[*__Correo_Electronico_Envio__*]" => $correo_whatsappDatos['usuario'],
		...
		echo $correoEnvioMailing = correoEnvioMailing($correo_whatsappDatos,$bodyHTML,$asuntoHTML,$para,'',$unsubscribe);
	}