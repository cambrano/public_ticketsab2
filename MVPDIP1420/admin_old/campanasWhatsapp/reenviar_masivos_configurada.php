<?php
	...
	@session_start(); 
	$_SESSION['Paguinasub']="campanasWhatsapp/reenviar_masivos_configurada.php";
	if(!empty($_GET)){
	...
	foreach ($tablasRelacionadas['tablas'] as $key => $value) {
		if($value['registros']>0 && $value['tabla']!='campanas_whatsapp_cuerpos' && $value['tabla']!='campanas_whatsapp_programadas' && $value['tabla']!='campanas_whatsapp_cartografias' ){
...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "campanasWhatsapp/db_reenviar_masivos_configurada.php",
				data: dataString,
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Reenviar Whatsapp Masivos </font>
				</label>
			</div>
		</div>
		<div class="bodyinput">
