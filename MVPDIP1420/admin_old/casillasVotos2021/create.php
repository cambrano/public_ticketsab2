<?php
	...
	@session_start(); 
	$_SESSION['Paguinasub']="casillasVotos2021/create.php";
	unset($_SESSION['paguinaId']);
	if(!empty($_GET)){
		$tipo=$_SESSION['tipo']=$_GET['tipo'];
	}else{
		$tipo=$_SESSION['tipo'];
	}
	...
	$casilla_voto_2021Datos['id_estado'] = $id_estado;
	$casilla_voto_2021Datos['id_municipio'] = 2349;
	$casilla_voto_2021Datos['id_localidad'] = 290086;
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "casillasVotos2021/db_add.php",
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Crear Casilla Voto 2021<br></font>
					<?php
				...
				<label class="descripcionForm">
					<font style="font-size: 13px;">Campos para registrar y dar de codigoa a casilla voto 2021.</font><br><br>
				</label><br>
