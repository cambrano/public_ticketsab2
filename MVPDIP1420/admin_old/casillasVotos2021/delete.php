<?php
	...
	@session_start(); 
	$_SESSION['Paguinasub']="casillasVotos2021/delete.php";
	if(!empty($_GET)){
	...
	$tablasRelacionadas = tablasRelacionadas('casillas_votos_2021',$id);
...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "casillasVotos2021/db_delete.php",
				data: dataString,
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Eliminar Casilla Voto 2021</font>
				</label>
			</div>
		</div>
		<div class="bodyinput">
			...
			<label class="descripcionForm">
				<strong><?= $casilla_voto_2021Datos['clave']?></strong>
			</label><br>
			<label class="labelForm" id="labeltemaname">Código</label><br>
			<label class="descripcionForm">
				<strong><?= $casilla_voto_2021Datos['codigo']?></strong>
			</label><br>
			<?php
			if($registros_tablas!=''){
