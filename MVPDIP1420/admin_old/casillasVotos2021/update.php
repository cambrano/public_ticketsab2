<?php
	...
	@session_start(); 
	$_SESSION['Paguinasub']="casillasVotos2021/update.php";  
	if(!empty($_GET)){
		$id=$_SESSION['paguinaId']=$_GET['id'];
	}else{
		$id=$_SESSION['paguinaId'];
	}
	$redirectSecurity=redirectSecurity($id,'casillas_votos_2021','casillasVotos2021','index');
	...
	$casilla_voto_2021Datos=casilla_voto_2021Datos($id);
	if($casilla_voto_2021Datos['clave']==""){
		$casilla_voto_2021Datos['clave']=$claveF['clave'];
	}

	$tipo = $casilla_voto_2021Datos['tipo'];

	$partidos_2021Datos = partidos_2021Datos('','',$tipo);

	$casillas_votos_partidos_2021Datos = casillas_votos_partidos_2021Datos('',$id,'');
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Modificar Casilla Voto 2021<br></font>
					<?php
				...
				<label class="descripcionForm">
					<font style="font-size: 13px;">Campos para modificar a casilla voto 2021.</font><br><br>
				</label><br>
