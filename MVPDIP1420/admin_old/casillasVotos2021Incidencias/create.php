<?php
	...
	$_SESSION['Paguinasub']="casillasVotos2021Incidencias/create.php";
	...
	$permiso='insert';
	$casilla_voto_2021_incidenciaDatos['fecha'] = $fechaSF;
	$casilla_voto_2021_incidenciaDatos['hora'] = $fechaSH;
...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "casillasVotos2021Incidencias/db_add.php",
