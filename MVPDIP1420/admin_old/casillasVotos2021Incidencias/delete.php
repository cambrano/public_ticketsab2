<?php
	...
	if(!empty($_GET)){
		$_SESSION['Paguinasub']="casillasVotos2021Incidencias/delete.php";
		$id=$_SESSION['paguinaId']=$_GET['id'];
	}else{
		$id=$_SESSION['paguinaId'];
	}
	$id_casilla_voto_2021=$_SESSION['id_casilla_voto_2021']; 
	echo $redirectSecurity=redirectSecurity($id,'casillas_votos_2021_incidencias','casillasVotos2021Incidencias','index');
	if($redirectSecurity!=""){
		die;
	}
...
?>
	...
	<script language="javascript" type="text/javascript">
		function cerrar(){
			$("#homebody").load('casillasVotos2021Incidencias/index.php');
		}
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "casillasVotos2021Incidencias/db_delete.php",
				data: dataString,
