<?php
	...
	@session_start(); 
	$_SESSION['Paguinasub']="casillasVotos2021Incidencias/update.php";  
	...
	$redirectSecurity=redirectSecurity($id,'casillas_votos_2021_incidencias','casillasVotos2021Incidencias','index');
	if($redirectSecurity!=""){
		die;
	}
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "casillasVotos2021Incidencias/db_edit.php",
