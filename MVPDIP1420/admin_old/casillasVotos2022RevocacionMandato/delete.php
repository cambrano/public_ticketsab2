<?php
	...
	@session_start(); 
	$_SESSION['Paguinasub']="casillasVotos2022RevocacionMandato/delete.php";
	if(!empty($_GET)){
	...
	$tablasRelacionadas = tablasRelacionadas('casillas_votos_2022_revocacion_mandato',$id);
...
?>
	...
	<script language="javascript" type="text/javascript">
		function cerrar(){
			$("#homebody").load('casillasVotos2022RevocacionMandato/index.php');
		}
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "casillasVotos2022RevocacionMandato/db_delete.php",
				data: dataString,
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Eliminar Casilla 2020 Revocación de mandato</font>
				</label>
			</div>
		</div>
		<div class="bodyinput">
			...
			<label class="descripcionForm">
				<strong><?= $casilla_voto_2022_revocacion_mandatoDatos['clave']?></strong>
			</label><br>
			<label class="labelForm" id="labeltemaname">Código</label><br>
			<label class="descripcionForm">
				<strong><?= $casilla_voto_2022_revocacion_mandatoDatos['codigo']?></strong>
			</label><br>
			<?php
			if($registros_tablas!=''){
