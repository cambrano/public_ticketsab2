<?php
	...
	@session_start(); 
	$_SESSION['Paguinasub']="casillasVotos2022RevocacionMandato/update.php";  
	if(!empty($_GET)){
		$id=$_SESSION['paguinaId']=$_GET['id'];
	}else{
		$id=$_SESSION['paguinaId'];
	}
	$redirectSecurity=redirectSecurity($id,'casillas_votos_2022_revocacion_mandato','casillasVotos2022RevocacionMandato','index');
