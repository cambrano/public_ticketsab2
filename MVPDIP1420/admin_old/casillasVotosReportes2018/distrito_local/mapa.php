	...
	<script type="text/javascript">
		function myMap(){
			...
			foreach ($secciones_ine_parametrosDatosMapa as $key => $value) {
				...
				$primera_fuerza = $datos_secciones_ine[$key]['orden_votos_individual']['primera_fuerza'];
				$color_background = $datos_secciones_ine[$key]['partidos'][$primera_fuerza]['color_background'] ;
				$color_border = $datos_secciones_ine[$key]['partidos'][$primera_fuerza]['color_border'] ;
		...
		function verMasDistritoLocal(valor){
			link="seccionesIneReportes2018/distrito_local/index.php?id="+valor; 
			var link2="seccionesIneReportes2018/distrito_local/index.php";
