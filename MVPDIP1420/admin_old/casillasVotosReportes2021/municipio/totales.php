<?php
	...
	$sql="
		...
		GROUP BY cvp.id_municipio,cvp.id_seccion_ine,cvp.id_casilla_voto_2021,cvp.id_partido_2021
	";
	$sql;
	...
	while($row=$result->fetch_assoc()){
		...
		if($row['clave_partidos_coaliciones'] != ''){
			$partidos_coaliciones[$row['id_casilla_voto_2021']][$row['nombre_corto']]=$row;
		}else{
			$partidos_sin_coaliciones[$row['id_casilla_voto_2021']][$row['nombre_corto']]=$row;
		} 
		$num=$num+1;
	}
