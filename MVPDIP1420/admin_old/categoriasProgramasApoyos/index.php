<?php
	...
	@session_start();
	$_SESSION['Paguinasub']="categoriasProgramasApoyos/index.php";
	...
	?>
	<title>Categorías Programas Apoyos</title>
	<div id="bodymanager" class="bodymanager">
		...
		<label class="tituloForm">
			Categorías Programas Apoyos
		</label><br>
		<div style="float: right; width: 100%; text-align: left;"> 
			<?php
				if( $moduloAccionPermisos['insert'] || $moduloAccionPermisos['all']){
					?>
					<input type="button" value="Nueva categoría apoyo" onClick="add();"> 
					<?php
				}
			?>
		</div>
