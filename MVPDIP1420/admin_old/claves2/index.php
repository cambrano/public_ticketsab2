<?php
	...
	@session_start();
	$_SESSION['Paguinasub']="claves2/index.php";
	$clave2Datos=clave2Datos();
	$id=$clave2Datos['id']; 
	if($id!=""){
		$permiso="update";
	}else{
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Configuración de las claves 2</font>
				</label><br>
				<label class="descripcionForm">
					<font style="font-size: 13px;">Formulario para configurar claves 2.</font><br>
				</label>
