	...
	<div style=" width: 100%; display:inline-block; text-align: left;">
		...
		<div class="sucForm">
			...
			<input class="inputlogin" type="text" name="votos_semaforo_amarillo" autocomplete="off"  id="votos_semaforo_amarillo" value="<?= $configuracion_matriz_rentabilidad_secciones_ine_2021Datos['votos_semaforo_amarillo'] ?>" placeholder="" onkeypress="return CheckNumeric()" /><br>
		</div>
