<?php
	...
	@session_start();
	$_SESSION['Paguinasub']="correosElectronicos/create.php";  
	if($_SESSION['reset']!="x"){
	...
	$correo_electronicoDatos['id_identidad'] = $id_identidad;
	$correo_electronicoDatos['fecha_emision'] = $fechaSF;
	$correo_electronicoDatos['hora_emision'] = $fechaSH;
	if($id_identidad!=""){
	...
	$correo_electronicoDatos['usuario'] = strtolower($correo_sugerido);
	$correo_electronicoDatos['password'] = $correo_sugerido;
...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "correosElectronicos/db_add.php",
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Crear Correo Eléctronico</font>
				</label><br>
				<label class="descripcionForm">
					<font style="font-size: 13px;">Campos para registrar y dar de alta a correo eléctronico.</font><br><br>
				</label><br>
