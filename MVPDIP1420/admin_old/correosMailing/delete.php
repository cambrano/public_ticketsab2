<?php
	...
	@session_start(); 
	$_SESSION['Paguinasub']="correosMailing/delete.php";
	if(!empty($_GET)){
...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "correosMailing/db_delete.php",
				data: dataString,
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Eliminar Correo Mailing</font>
				</label>
			</div>
		</div>
		<div class="bodyinput">
			...
			<label class="descripcionForm">
				<strong><?= $correo_mailingDatos['nombre']?></strong>
			</label><br>
			<?php
			if($registros_tablas!=''){
