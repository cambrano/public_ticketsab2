<?php
	...
	$sql = "SELECT count(*) total FROM distritos_federales WHERE 1 = 1   "; 
	...
	////////////////////////////
	////////////////////////////
	$sql = "SELECT id,clave,numero,latitud,longitud FROM distritos_federales WHERE 1 = 1  "; 
	...
	$numero=$_SESSION['searchTable']['numero'];
	if( $numero!="" ){   //name
		$post_search=true;
	...
	if($post_search){
		$sqlContadorScript = "SELECT count(*) total FROM distritos_federales WHERE 1 = 1   "; 
