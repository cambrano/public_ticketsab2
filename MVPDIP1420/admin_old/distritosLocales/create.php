<?php
	...
	@session_start();
	$_SESSION['Paguinasub']="distritosLocales/create.php";  
	$permiso="insert";
	unset($_SESSION['limites']);
	unset($_SESSION['limites_num']);
	$distritos_locales_parametrosDatosMapa = distritos_locales_parametrosDatosMapa('','',' id_distrito_local,orden ASC');
...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "distritosLocales/db_add.php",
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Crear Distrito Local</font>
				</label><br>
				<label class="descripcionForm">
					<font style="font-size: 13px;">Campos para registrar y dar de alta a distrito local.</font><br><br>
				</label><br>
