<?php
	...
	$sql = "SELECT count(*) total FROM distritos_locales WHERE 1 = 1   "; 
	...
	////////////////////////////
	////////////////////////////
	$sql = "SELECT id,clave,numero,latitud,longitud FROM distritos_locales WHERE 1 = 1  "; 
	...
	if($post_search){
		$sqlContadorScript = "SELECT count(*) total FROM distritos_locales WHERE 1 = 1   "; 
