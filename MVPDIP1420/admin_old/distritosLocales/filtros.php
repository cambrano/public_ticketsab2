...
?>
	<script type="text/javascript">
		function searchTable(value){
			...
			$.ajax({
				type: "POST",
				url: "distritosLocales/table.php",
	...
	<div class="sucForm">
		<label class="labelForm" id="labeltemaname">Numéro<br>
		<input data-column="1" id="numero" autocomplete="off" type="text" onkeyup="searchTable();" > <br>
	</div>
	<style type="text/css">
		.ui-autocomplete {
			max-height: 180px;
