<?php
	...
	$zoom="8";
	if($distrito_localDatos['longitud']=="" || $distrito_localDatos['latitud']=="" ){
	}else{
		$longitud=$distrito_localDatos['longitud'];
		$latitud=$distrito_localDatos['latitud'];
	}
?>
	<script type="text/javascript">
	...
	<div style=" width: 100%; display:inline-block; text-align: left;">
		<div class="sucFormTitulo">
			<label class="labelForm" id="labeltemaname">Datos Distrito Local</label>
		</div>
		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Clave<font color="#FF0004">*</font></label><br>
			<input class="inputlogin" <?= $claveF['input'] ?> type="text" name="clave" autocomplete="off"  id="clave" value="<?= $distrito_localDatos['clave'] ?>" placeholder="" maxlength="120" onkeyup="clave(this.value)"/><br>
		</div>

		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Número<font color="#FF0004">*</font></label><br>
			<input class="inputlogin" type="text" name="numero" autocomplete="off"  id="numero" value="<?= $distrito_localDatos['numero'] ?>" placeholder="" onkeypress="return CheckNumeric()" /><br>
		</div>
		<div class="sucFormTitulo">
		...
		<div class="sucForm">
			...
			<input type="text" name="latitud" id="latitud" value="<?= $distrito_localDatos['latitud'] ?>" placeholder="latitud" onkeypress="return CheckNumeric()" ><br>
		</div>
		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Longitud<font color="#FF0004">*</font></label><br>
			<input type="text" name="longitud" id="longitud" value="<?= $distrito_localDatos['longitud'] ?>" placeholder="longitud" onkeypress="return CheckNumeric()" >
		</div>
		<div id="mapa">
		...
		<script type="text/javascript">
			function generar_limite(){
				...
				$.ajax({
					type: "POST",
					url: "distritosLocales/form_limite.php",
			...
			function editarLimite(value){
				...
				var ruta = "distritosLocales/form_ajax.php";
				$.ajax({
					url: ruta,
					type: "POST",
					data: dataString, 
			...
			function eliminarLimite(value){
				...
				var ruta = "distritosLocales/form_limite.php";
				$.ajax({
					url: ruta,
					type: "POST",
					data: dataString, 
		...
		<div id="form_limite">
			...
			<div class="sucForm">
				<label class="labelForm" id="labeltemaname">Latitud<font color="#FF0004">*</font></label><br>
				<input type="text" name="latitud" id="latitud_limite" value="<?= $distrito_localDatos['latitud'] ?>" placeholder="latitud" autocomplete="off" onkeypress="return CheckNumeric()" ><br>
			</div>
			<div class="sucForm">
				<label class="labelForm" id="labeltemaname">Longitud<font color="#FF0004">*</font></label><br>
				<input type="text" name="longitud" id="longitud_limite" value="<?= $distrito_localDatos['longitud'] ?>" placeholder="longitud" autocomplete="off" onkeypress="return CheckNumeric()" >
			</div>
