<?php
		...
		//var_dump($_POST);
		if(!empty($_POST)){
			include '../functions/distritos_locales_reportes.php';
...
?>
	<script type="text/javascript">
		...
		function verMasDistritoLocal(valor) {
			link = "seccionesIneReportes2021/distrito_local/index.php?id=" + valor;
			var link2 = "seccionesIneReportes2021/distrito_local/index.php";
		...
		function verMasDistritoLocalMatrizRentabilidad(valor) {
			link = "seccionesIneReportes2021MatrizRentabilidad/distrito_local/index.php?id=" +
					valor;
