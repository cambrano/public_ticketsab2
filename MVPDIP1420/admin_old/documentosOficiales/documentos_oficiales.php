<?php
	...
	if($id_identidad !=""){
		$post_search=true;
		$sql.= " AND e.id_identidad = '{$id_identidad}'";
		$sqlContador.= " AND e.id_identidad = '{$id_identidad}'";
	}
	...
	$fecha_vigencia_1=$_SESSION['searchTable']['fecha_vigencia_1'];
	$fecha_vigencia_2=$_SESSION['searchTable']['fecha_vigencia_2'];
