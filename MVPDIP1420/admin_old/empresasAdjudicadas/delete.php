<?php
	...
	@session_start(); 
	$_SESSION['Paguinasub']="empresasAdjudicadas/delete.php";
	if(!empty($_GET)){
	...
	$tablasRelacionadas = tablasRelacionadas('empresas_adjudicadas',$id);
...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "empresasAdjudicadas/db_delete.php",
				data: dataString,
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Eliminar Empresa Adjudicada</font>
				</label>
			</div>
		</div>
		<div class="bodyinput">
			<label class="labelForm" id="labeltemaname">Empresa Adjudicada</label><br>
			<label class="descripcionForm">
				<strong><?= $empresa_adjudicadaDatos['nombre']?></strong>
			</label><br>
			<?php
			if($registros_tablas!=''){
