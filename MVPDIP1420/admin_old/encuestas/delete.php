<?php
	...
	@session_start(); 
	$_SESSION['Paguinasub']="encuestas/delete.php";
	if(!empty($_GET)){
	...
	$tablasRelacionadas = tablasRelacionadas('encuestas',$id);
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Eliminar Encuesta</font>
				</label>
			</div>
		</div>
		<div class="bodyinput">
			<label class="labelForm" id="labeltemaname">Encuesta</label><br>
