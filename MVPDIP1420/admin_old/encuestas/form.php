...
?>
	<div style=" width: 100%; display:inline-block; text-align: left;">
		...
		<div class="sucForm">
			...
			<input class="inputlogin" <?= $claveF['input'] ?> type="text" style="width: 100%" name="clave" autocomplete="off"  id="clave" value="<?= $encuestaDatos['clave'] ?>" placeholder="Clave" onkeyup="clave(this.value)" /><br>
		</div>
		<div class="sucForm" style="width: 100%">
			<label class="labelForm" id="labeltemaname">Nombre<font color="#FF0004">*</font></label><br>
			<input class="inputlogin" type="text" style="width: 100%" name="nombre" autocomplete="off" maxlength="255"  id="nombre" value="<?= $encuestaDatos['nombre'] ?>" placeholder="Nombre" /><br> 
		</div>
		<div class="sucForm" style="width: 100%">
			...
			<?php
				echo statusGeneralForm($encuestaDatos['status']);
			?>
			</select><br><br> 
		</div>
		<div class="sucForm" style="width: 100%">
