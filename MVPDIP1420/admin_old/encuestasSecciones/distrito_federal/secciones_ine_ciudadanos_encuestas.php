<?php
	...
	if( $id_distrito_federal != "" ){   //name
		...
		$sqlContador .= " AND e.id_distrito_federal = '{$id_distrito_federal}' ";
	}
	...
	$sql = "SELECT 
				...
				(SELECT m.numero FROM distritos_federales m WHERE m.id = e.id_distrito_federal) distrito
...
//////////////////////////////////////////////////////////////////
	...
	if( $id_distrito_federal != "" ){   //name
		...
		$sql.=" AND e.id_distrito_federal = '{$id_distrito_federal}' ";
		$sqlContador .= " AND e.id_distrito_federal = '{$id_distrito_federal}' ";
		$sqlexcel .= " AND sice.id_distrito_federal = '{$id_distrito_federal}' ";
	}
