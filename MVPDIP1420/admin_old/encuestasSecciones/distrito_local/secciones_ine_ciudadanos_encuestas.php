<?php
	...
	if( $id_distrito_local != "" ){   //name
		...
		$sqlContador .= " AND e.id_distrito_local = '{$id_distrito_local}' ";
	}
	...
	$sql = "SELECT 
				...
				(SELECT m.numero FROM distritos_locales m WHERE m.id = e.id_distrito_local) distrito
...
//////////////////////////////////////////////////////////////////
	...
	$sqlexcel= "
		SELECT 
			...
			(SELECT m.numero FROM distritos_locales m WHERE m.id = sice.id_distrito_local) distrito,
...
//////////////////////////////////////////////////////////////////
	...
	if( $id_distrito_local != "" ){   //name
		...
		$sql.=" AND e.id_distrito_local = '{$id_distrito_local}' ";
		$sqlContador .= " AND e.id_distrito_local = '{$id_distrito_local}' ";
		$sqlexcel .= " AND sice.id_distrito_local = '{$id_distrito_local}' ";
	}
	...
	if( $id_distrito_local!="" ){
		...
		$sqlexcel .= " AND sice.id_distrito_local IN ($id_distrito_local) ";
	}
