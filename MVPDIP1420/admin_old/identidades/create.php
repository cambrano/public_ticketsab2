<?php
	...
	@session_start();
	$_SESSION['Paguinasub']="identidades/create.php";  
...
?>
	...
	<script language="javascript" type="text/javascript">
		function cerrar(){
			$("#homebody").load('identidades/index.php');
		}
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Crear Identidad</font>
				</label><br>
				<label class="descripcionForm">
					<font style="font-size: 13px;">Campos para registrar y dar de alta a identidad.</font><br><br>
				</label><br>
