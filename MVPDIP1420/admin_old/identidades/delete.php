<?php
	...
	@session_start();
	$_SESSION['Paguinasub']="identidades/delete.php";
	if(!empty($_GET)){
	...
	<div class="bodymanager" id="bodymanager"> 
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Eliminar Identidad </font>
				</label><br>
		...
		<div class="bodyinput">
			...
			<label class="descripcionForm">
				<strong><?=$identidadDatos['nombre_completo']; ?></strong>
			</label><br><br>
