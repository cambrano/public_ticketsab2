...
<script type="text/javascript">
	function guardarImportacion(){
		...
		var ruta = "importacionesSistema/casillas_votos_2022_revocacion_mandato/casillas_votos_2022_revocacion_mandato_db_edit.php";
...
<?php
	...
	if($tabla=="casillas_votos_2022_revocacion_mandato"){
		$columnData = array(
			...
			'clave_tipos_casillas'=>array('alfanumerico','','buscar_clave','mayuscula'),
			'clave_secciones_ine'=>array('alfanumerico','','buscar_clave','mayuscula'),
			'municipio'=>array('alfanumerico',''),
			'clave_distritos_locales'=>array('alfanumerico','','buscar_clave','mayuscula'),
			'clave_distritos_federales'=>array('alfanumerico','','buscar_clave','mayuscula'),
			'codigo'=>array('alfanumerico',''),
			'votos_can_nreg'=>array('alfanumerico',''),
			'votos_nulos'=>array('alfanumerico',''),
			'lista_nominal'=>array('alfanumerico',''),
			'status'=>array('alfanumerico',''),
