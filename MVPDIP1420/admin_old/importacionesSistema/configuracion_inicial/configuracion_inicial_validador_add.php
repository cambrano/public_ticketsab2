...
<script type="text/javascript">
	function guardarImportacion(){
		...
		var ruta = "importacionesSistema/configuracion_inicial/configuracion_inicial_db_add.php";
...
<?php
	...
	if($tabla=="configuracion"){
		$columnData = array(
					...
					'slogan'=>array('alfanumerico','requerido'),
					'url_base'=>array('alfanumerico','requerido'),
