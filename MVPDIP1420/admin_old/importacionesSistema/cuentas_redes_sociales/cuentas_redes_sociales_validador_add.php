...
<script type="text/javascript">
	function guardarImportacion(){
		...
		var ruta = "importacionesSistema/cuentas_redes_sociales/cuentas_redes_sociales_db_add.php";
...
<?php
	...
	if($tabla=="cuentas_redes_sociales"){
		$columnData = array(
			...
			'usuario'=>array('alfanumerico','requerido'),
			...
			'verificado'=>array('alfanumerico','requerido'),
		);
	}
