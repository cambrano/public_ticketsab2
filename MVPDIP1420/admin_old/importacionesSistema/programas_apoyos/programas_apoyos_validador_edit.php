...
<script type="text/javascript">
	function guardarImportacion(){
		...
		var ruta = "importacionesSistema/programas_apoyos/programas_apoyos_db_edit.php";
...
<?php
	...
	if($tabla=="programas_apoyos"){
		$columnData = array(
			...
			'folio' =>array('alfanumerico','','mayuscula'),
			'nombre' =>array('alfanumerico',''),
			'tipo'=>array('alfanumerico','','minuscula'),
			'fecha_inicio'=>array('fecha',''),
			'fecha_final'=>array('fecha',''),
			'descripcion'=>array('alfanumerico',''),
		);
	}
