<?php
	...
	if(!empty($_POST)){
		...
		foreach ($data as $key => $value) {
			...
			if($array_tipos_territorios[$value['clave_tipos_territorios']] ==""){
				$value['id_tipo_territorio'] = claveId($value['clave_tipos_territorios'],'tipos_territorios');
				$array_tipos_territorios[$value['clave_tipos_territorios']] = $value['id_tipo_territorio'];
				unset($value['clave_tipos_territorios']);
			}else{
				$value['id_tipo_territorio'] = $array_tipos_territorios[$value['clave_tipos_territorios']];
				unset($value['clave_tipos_territorios']);
			}
