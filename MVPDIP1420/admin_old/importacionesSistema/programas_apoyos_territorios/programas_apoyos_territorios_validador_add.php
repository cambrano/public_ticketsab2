...
<script type="text/javascript">
	function guardarImportacion(){
		...
		var ruta = "importacionesSistema/programas_apoyos_territorios/programas_apoyos_territorios_db_add.php";
...
<?php
	...
	if($tabla=="programas_apoyos_territorios"){
		$columnData = array(
			'clave_programas_apoyos'=>array('alfanumerico','requerido','buscar_clave','mayuscula'),
			'clave_tipos_territorios'=>array('alfanumerico','requerido','buscar_clave','mayuscula'),
		);
	}
