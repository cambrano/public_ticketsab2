...
<script type="text/javascript">
	function guardarImportacion(){
		...
		var ruta = "importacionesSistema/secciones_ine_actividades/secciones_ine_actividades_db_edit.php";
...
<?php
	...
	if($tabla=="secciones_ine_actividades"){
		$columnData = array(
			...
			'numero_contrato' =>array('alfanumerico',''),
			'cedula' =>array('alfanumerico',''),
			'clave_empresas_adjudicadas'=>array('alfanumerico','','buscar_clave','mayuscula'),
			'clave_supervisores'=>array('alfanumerico','','buscar_clave','mayuscula'),

			'tipo'=>array('alfanumerico',''),
			'id_tipo_infraestructura'=>array('alfanumerico',''),
			'fecha_inicio'=>array('fecha',''),
			'fecha_final'=>array('fecha',''),
