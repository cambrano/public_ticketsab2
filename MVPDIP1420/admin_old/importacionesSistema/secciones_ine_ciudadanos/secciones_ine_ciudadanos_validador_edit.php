...
<script type="text/javascript">
	function guardarImportacion(){
		...
		var ruta = "importacionesSistema/secciones_ine_ciudadanos/secciones_ine_ciudadanos_db_edit.php";
...
<?php
	...
	if($tabla=="secciones_ine_ciudadanos"){
		$columnData = array(
				...
				'clave_tipos_ciudadanos'=>array('alfanumerico','','buscar_clave','mayuscula'),
				...
				'usuario'=>array('alfanumerico','','','unique_db_usuario',''),
