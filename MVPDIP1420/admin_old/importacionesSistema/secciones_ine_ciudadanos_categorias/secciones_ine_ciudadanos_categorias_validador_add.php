...
<script type="text/javascript">
	function guardarImportacion(){
		...
		var ruta = "importacionesSistema/secciones_ine_ciudadanos_categorias/secciones_ine_ciudadanos_categorias_db_add.php";
...
<?php
	...
	if($tabla=="secciones_ine_ciudadanos_categorias"){
		$columnData = array(
