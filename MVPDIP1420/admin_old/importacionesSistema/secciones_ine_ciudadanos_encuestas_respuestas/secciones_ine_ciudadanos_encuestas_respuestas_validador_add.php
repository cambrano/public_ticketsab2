...
<script type="text/javascript">
	function guardarImportacion(){
		...
		var ruta = "importacionesSistema/secciones_ine_ciudadanos_encuestas_respuestas/secciones_ine_ciudadanos_encuestas_respuestas_db_add.php";
...
<?php
	...
	if($tabla=="secciones_ine_ciudadanos_encuestas_respuestas"){
		$columnData = array(
			...
			if($countdraw > 1){
				...
				foreach ($columnData as $key => $value) {
					...
					if(in_array("buscar_clave", $value)){
						...
						if($tb=="cuestionarios_respuestas"){
							if($line_valor!="NOTIENE"){
