...
<script type="text/javascript">
	function guardarImportacion(){
		...
		var ruta = "importacionesSistema/secciones_ine_ciudadanos_grupos/secciones_ine_ciudadanos_grupos_db_add.php";
...
<?php
	...
	if($tabla=="secciones_ine_ciudadanos_grupos"){
		$columnData = array(
				...
				'clave_secciones_ine_grupos'=>array('alfanumerico','requerido','buscar_clave','mayuscula'),
				...
				'id_tipo_nombramiento'=>array('alfanumerico','requerido'),
