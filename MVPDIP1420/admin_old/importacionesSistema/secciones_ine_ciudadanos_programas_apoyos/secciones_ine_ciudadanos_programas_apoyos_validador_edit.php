...
<script type="text/javascript">
	function guardarImportacion(){
		...
		var ruta = "importacionesSistema/secciones_ine_ciudadanos_programas_apoyos/secciones_ine_ciudadanos_programas_apoyos_db_edit.php";
...
<?php
	...
	if($tabla=="secciones_ine_ciudadanos_programas_apoyos"){
		$columnData = array(
			...
			'clave_programas_apoyos'=>array('alfanumerico','','buscar_clave','mayuscula'),
