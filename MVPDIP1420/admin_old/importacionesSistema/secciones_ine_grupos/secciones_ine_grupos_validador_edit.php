...
<script type="text/javascript">
	function guardarImportacion(){
		...
		var ruta = "importacionesSistema/secciones_ine_grupos/secciones_ine_grupos_db_edit.php";
...
<?php
	...
	if($tabla=="secciones_ine_grupos"){
		$columnData = array(
			...
			'id_tipo_seccion_ine_grupo'=>array('alfanumerico',''),
			'id_tipo_interes'=>array('alfanumerico',''),
			'id_tipo_relacion'=>array('alfanumerico',''),
			'clave_partidos_legados'=>array('alfanumerico','','buscar_clave','mayuscula'),
