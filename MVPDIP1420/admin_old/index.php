...
?>
		...
		<!--[if gt IE 8]><!--> <html lang="es" class="no-js"> <!--<![endif]-->
			<head>
				...
				<title>RADAR - WEB APP</title>
				<!-- Meta Google -->

				<meta name="google" content="notranslate" />
				<!-- Meta Description -->
				<meta property="og:title" content="RADAR - WEB APP" />
				<meta property="og:description" content="RADAR - WEB APP, para el manejo de información">
				<meta name="keywords" content="RADAR - WEB APP, ">
				...
				<div class="loader">
					<div class="loaderContenedor">
						...
						<div class="loaderTextRow">
							...
							<div class="loaderTextColText"><img src="ftpFiles/files/logo_principal.png" width="90" ></div>
