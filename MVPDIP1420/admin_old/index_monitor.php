...
?>
		...
		<!--[if gt IE 8]><!--> <html lang="es" class="no-js"> <!--<![endif]-->
			<head>
				...
				<title>Monitor - WEB APP</title>
				<!-- Meta Google -->

				<meta name="google" content="notranslate" />
				<!-- Meta Description -->
				<meta property="og:title" content="Monitor - WEB APP" />
				<meta property="og:description" content="Monitor - WEB APP, para el manejo de información">
				<meta name="keywords" content="Monitor - WEB APP, ">
