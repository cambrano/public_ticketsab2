			...
			function myMap(){
				...
				var infoWindowContent_ciudadanos = [
					...
					foreach ($lista_nominalDatosArray as $key => $value){
						...
						$gps = "https://www.google.com/maps?q={$value['latitud']},{$value['longitud']}";
						$militante_partido = ($value['militante_partido'] !='') ? $value['militante_partido'] : '-';
						$militante_reg = ($value['militante_registro'] !='') ? $value['militante_registro'] : '-';
						$div = '<div class="divMapa">
										<div class="info_content">
											...
											<div class="info_seccion_ganador">
												<h5>'.$value['clave_elector'].'</h5>
											</div>
											<div class="info_seccion_ganador_button">
												<a href="https://www.google.com/maps?q='.$value['latitud'].','.$value['longitud'].'" target="_blank"><button>Ver en Google Maps</button></a>
											</div>
										</div>
										<div class="datos">
											<p>
												D. Local: <b>'.$value['distrito_local'].'</b><br>	
												D. Federal: <b>'.$value['distrito_federal'].'</b><br>	
												Sección: <b>'.$value['seccion'].'</b><br>
												Manzana: <b>'.$value['manzana'].'</b><br>
												<br>
												Militante Partido: <b>'.$militante_partido.'</b><br>
												Fecha Reg.: <b>'.$militante_reg.'</b><br><br>
												Clave Elector: <b>'.$value['clave_elector'].'</b><br>
												C.U.R.P: <b>'.$value['curp'].'</b><br><br>
												Fecha Nacimiento: <b>'.$value['fecha_nacimiento'].'</b><br>
