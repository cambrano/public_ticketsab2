<?php
	...
	include __DIR__."/../functions/log_sesiones.php";
	include '../functions/usuario_permisos.php';
	@session_start();
	$_SESSION['Paguinasub']="logSesiones/index.php";
	$moduloAccionPermisos = moduloAccionPermisos('security','tracking_sesion',$_COOKIE["id_usuario"]);
	?>
