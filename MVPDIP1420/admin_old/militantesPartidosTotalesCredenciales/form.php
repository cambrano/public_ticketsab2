	...
	<div style=" width: 100%; display:inline-block; text-align: left;">
		...
		<script>
			function comprobante(){
				var link="militantesPartidosTotalesCredenciales/print/index.php?cot=<?= $otra_variable ?>";
				//window.open(link);
		...
		<div class="left">
			...
			<br>
			<br>
			<table style="width:auto;table-layout: fixed;padding:10px" >
				<tr>
				...
				<tr>
					...
					<td style="text-align: left;padding:10px;font-size:18px">
						<button class="btn btn-primary bt_responsive" onClick="credencialDigital();">Credencial Digital</button>
					</td>
					<td style="text-align: left;padding:10px;font-size:18px">
						<button class="btn btn-primary bt_responsive" onClick="comprobante();">Comprobante</button>
					</td>
				</tr>
			</table>
		</div>
