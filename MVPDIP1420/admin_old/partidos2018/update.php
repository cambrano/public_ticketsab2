<?php
	...
	@session_start(); 
	$_SESSION['Paguinasub']="partidos2018/update.php";  
	...
	$redirectSecurity=redirectSecurity($id,'partidos_2018','partidos2018','index');
