<?php
	...
	@session_start(); 
	$_SESSION['Paguinasub']="partidos2021/delete.php";
	if(!empty($_GET)){
...
?>
	...
	<script language="javascript" type="text/javascript">
		function cerrar(){
			$("#homebody").load('partidos2021/index.php');
		}
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "partidos2021/db_delete.php",
				data: dataString,
	...
	<div class="bodymanager" id="bodymanager"> 
		...
		<div class="bodyinput">
			...
			<label class="descripcionForm">
				<strong><?= $partido_2021Datos['nombre']?></strong>
			</label><br>
			<?php
			if($registros_tablas!=''){
