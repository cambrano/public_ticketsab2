...
?>
	<div style=" width: 100%; display:inline-block; text-align: left;">
		...
		<div class="sucForm">
			...
			<input class="inputlogin" <?= $claveF['input'] ?> type="text" name="clave" autocomplete="off"  id="clave" value="<?= $partido_Datos['clave'] ?>" placeholder="" maxlength="120" onkeyup="clave(this.value)"/><br>
		</div>
		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Nombre Corto<font color="#FF0004">*</font></label><br>
			<input class="inputlogin" type="text" style="width: 100%" name="nombre_corto" autocomplete="off"  id="nombre_corto" value="<?= $partido_Datos['nombre_corto'] ?>" placeholder="Nombre" onblur="aMays(event, this)"/><br>
		</div>
		<div class="sucForm" style="width: 100%">
			<label class="labelForm" id="labeltemaname">Nombre<font color="#FF0004">*</font></label><br>
			<input class="inputlogin" type="text" style="width: 100%" name="nombre" autocomplete="off"  id="nombre" value="<?= $partido_Datos['nombre'] ?>" placeholder="Nombre" /><br>
		</div>
		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Tipo<font color="#FF0004">*</font></label><br>
			<?php
			$select[$partido_Datos['tipo']] = 'selected="selected"';
			?>
		...
		<div class="sucForm">
			...
			<input class="inputlogin" type="text" style="width: 100%" name="icono" autocomplete="off"  id="icono" value="<?= $partido_Datos['icono'] ?>" placeholder="Nombre" /><br>
		</div>

		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Logo<font color="#FF0004">*</font></label><br>
			<input class="inputlogin" type="text" style="width: 100%" name="logo" autocomplete="off"  id="logo" value="<?= $partido_Datos['logo'] ?>" placeholder="Nombre" /><br>
		</div>

		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Border Color<font color="#FF0004">*</font></label><br>
			<input class="inputlogin" type="text" style="width: 100%" name="color_border" autocomplete="off"  id="color_border" value="<?= $partido_Datos['color_border'] ?>" placeholder="Nombre" /><br>
		</div>

		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Background Color<font color="#FF0004">*</font></label><br>
			<input class="inputlogin" type="text" style="width: 100%" name="color_background" autocomplete="off"  id="color_background" value="<?= $partido_Datos['color_background'] ?>" placeholder="Nombre" /><br>
		</div>
		...
		<div class="sucForm">
			...
			<select name="principal" id="principal" class='myselect'>
				<?php
					$principal_slct[$partido_Datos['principal']] = 'selected="selected"';
				?>
