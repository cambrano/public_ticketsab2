<?php
	...
	@session_start(); 
	$_SESSION['Paguinasub']="partidos/update.php";  
	...
	$redirectSecurity=redirectSecurity($id,'partidos_','partidos','index');
	...
	if($partido_Datos['clave']==""){
		$partido_Datos['clave']=$claveF['clave'];
	}
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "partidos/db_edit.php",
				data: {partido_: partido_},
