<?php
	...
	@session_start(); 
	$_SESSION['Paguinasub']="preguntas2022RevocacionMandato/create.php";
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "preguntas2022RevocacionMandato/db_add.php",
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Crear Pregunta Consulta</font>
				</label><br>
				<label class="descripcionForm">
					<font style="font-size: 13px;">Campos para registrar y dar alta pregunta consulta.</font><br><br>
				</label><br>
