<?php
	...
	@session_start(); 
	$_SESSION['Paguinasub']="preguntas2022RevocacionMandato/update.php";  
	...
	$redirectSecurity=redirectSecurity($id,'preguntas_2022_revocacion_mandato','preguntas2022RevocacionMandato','index');
	...
	/*
	if($pregunta_2022_revocacion_mandatoDatos['clave']==""){
		$pregunta_2022_revocacion_mandatoDatos['clave']=$claveF['clave'];
	}
	*/
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			var pregunta_2022_revocacion_mandato = [];
			var data = {
					'id' : id,
					'clave' : clave,
			...
			pregunta_2022_revocacion_mandato.push(data);
			$.ajax({
				type: "POST",
				url: "preguntas2022RevocacionMandato/db_edit.php",
				data: {pregunta_2022_revocacion_mandato: pregunta_2022_revocacion_mandato},
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Modificar Pregunta Consulta</font>
				</label><br>
				<label class="descripcionForm">
					<font style="font-size: 13px;">Campos para modificar a pregunta consulta.</font><br><br>
				</label><br>
