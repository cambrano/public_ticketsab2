<?php
	...
	@session_start(); 
	$_SESSION['Paguinasub']="programasApoyos/create.php";
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "programasApoyos/db_add.php",
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Crear Programa Apoyos</font>
				</label><br>
				<label class="descripcionForm">
					<font style="font-size: 13px;">Campos para registrar y dar de nombrea a programa apoyos.</font><br><br>
				</label><br>
