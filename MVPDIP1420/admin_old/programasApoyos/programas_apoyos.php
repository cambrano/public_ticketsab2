<?php
	...
	$id_tipo_territorio=$_SESSION['searchTable']['id_tipo_territorio'];
	...
	$id_dependencia=$_SESSION['searchTable']['id_dependencia'];
	if( $id_dependencia!="" ){
		$post_search=true;
	...
	$sql.=" ORDER BY pa.". $columns[$requestData['order'][0]['column']]."  ".$requestData['order'][0]['dir'];
