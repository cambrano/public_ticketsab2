<?php
	...
	$sql = "SELECT count(*) total FROM redes_sociales WHERE 1 = 1   "; 
	...
	////////////////////////////
	////////////////////////////
	$sql = "SELECT id,clave,nombre,icono FROM redes_sociales WHERE 1 = 1  "; 
	...
	while($row=$result->fetch_assoc()){
		...
		$nestedData[] = "<li class='".$row['icono']." fa-4x'></li><div style='text-transform: none;'>".$row["icono"]."<div>";
		if($option_delete){
	...
	if($post_search){
		$sqlContadorScript = "SELECT count(*) total FROM redes_sociales WHERE 1 = 1   "; 
