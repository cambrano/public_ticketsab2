<?php
	...
	if(!empty($_POST)){
		...
		$secciones_ineDatosArray=secciones_ineDatosArray($_POST['searchTable'][0],$orderby,$limit);

		$secciones_ine_parametrosDatos = secciones_ine_parametrosDatos('','',' id_seccion_ine,orden ASC',$limit);
