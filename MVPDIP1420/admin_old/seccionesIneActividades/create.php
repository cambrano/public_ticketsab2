<?php
	...
	@session_start();
	$_SESSION['Paguinasub']="seccionesIneActividades/create.php";  
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Crear Acción u Obras</font>
				</label><br>
				<label class="descripcionForm">
					<font style="font-size: 13px;">Campos para registrar y dar de alta a acción u obras.</font><br><br>
				</label><br>
