<?php
	...
	$zoom = 14;
	if($seccion_ine_actividadDatos['longitud']=="" || $seccion_ine_actividadDatos['latitud']=="" ){
		$zoom = 14;
	}else{
		$longitud=$seccion_ine_actividadDatos['longitud'];
		$latitud=$seccion_ine_actividadDatos['latitud'];
	}
	if($id_municipio!=''){
...
?>
	...
	<div style=" width: 100%; display:inline-block; text-align: left;">
		...
		<div class="sucForm">
			...
			<input class="inputlogin" type="text" name="clave" autocomplete="off" <?= $claveF['input'] ?> id="clave" value="<?= $seccion_ine_actividadDatos['clave'] ?>" onkeyup="clave(this.value)" /><br>
		</div>

		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Folio<font color="#FF0004">*</font></label><br>
			<input class="inputlogin" type="text" name="folio" autocomplete="off"  id="folio" value="<?= $seccion_ine_actividadDatos['folio'] ?>" onkeyup="aMays(event, this)" /><br>
		</div>
		<div class="sucFormTitulo">
			<label class="labelForm" id="labeltemaname">Datos Acción u Obras</label>
		</div>
		<div class="sucForm" style="width: 100%">
			<label class="labelForm" id="labeltemaname">Nombre<font color="#FF0004">*</font></label><br>
			<input maxlength="350" max="350" class="inputlogin" type="text" name="nombre" autocomplete="off"  id="nombre" value="<?= $seccion_ine_actividadDatos['nombre'] ?>" onkeyup="aMays(event, this)" /><br>
		</div>

		<div class="sucForm" style="width: 100%">
			<label class="labelForm" id="labeltemaname">Número Contrato<font color="#FF0004">*</font></label><br>
			<input maxlength="350" max="350" class="inputlogin" type="text" name="numero_contrato" autocomplete="off"  id="numero_contrato" value="<?= $seccion_ine_actividadDatos['numero_contrato'] ?>" onkeyup="aMays(event, this)" /><br>
		</div>

		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Cédula<font color="#FF0004">*</font></label><br>
			<input maxlength="350" max="350" class="inputlogin" type="text" name="cedula" autocomplete="off"  id="cedula" value="<?= $seccion_ine_actividadDatos['cedula'] ?>" onkeyup="aMays(event, this)" /><br>
		</div>

		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Empresa Adjudicada<font color="#FF0004">*</font></label><br>
			<select class="myselect" id="id_empresa_adjudicada" >
				<?php
				echo empresas_adjudicadas($seccion_ine_actividadDatos['id_empresa_adjudicada']);
				?>
			</select><br>
		</div>
		...
		<div class="sucForm">
			...
			<input class="inputlogin" type="text" name="fecha_inicio" autocomplete="off"  id="fecha_inicio" value="<?= $seccion_ine_actividadDatos['fecha_inicio'] ?>" placeholder="" /><br>
		</div>

		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Fecha Final<font color="#FF0004">*</font></label><br>
			<input class="inputlogin" type="text" name="fecha_final" autocomplete="off"  id="fecha_final" value="<?= $seccion_ine_actividadDatos['fecha_final'] ?>" placeholder="" /><br>
		</div>
		...
		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Monto Total<font color="#FF0004">*</font></label><br>
			<input type="text" name="monto_total" autocomplete="off"  id="monto_total" value="<?= $seccion_ine_actividadDatos['monto_total'] ?>" placeholder="0.00" onkeypress="return CheckNumeric()" onkeyup="FormatCurrency(this)"/><br>
		</div>
		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Beneficiarios<font color="#FF0004">*</font></label><br>
			<input type="text" name="beneficiarios" autocomplete="off"  id="beneficiarios" value="<?= $seccion_ine_actividadDatos['beneficiarios'] ?>" placeholder="0" onkeypress="return CheckNumeric()" onkeyup="FormatCurrency(this)"/><br>
		</div>
		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Meta(Cantidad)<font color="#FF0004">*</font></label><br>
			<input type="text" name="meta_cantidad" autocomplete="off"  id="meta_cantidad" value="<?= $seccion_ine_actividadDatos['meta_cantidad'] ?>" placeholder="0" onkeypress="return CheckNumeric()" onkeyup="FormatCurrency(this)"/><br>
		</div>
		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Meta(Unidad)<font color="#FF0004">*</font></label><br>
			<select name="id_unidad_medida" id="id_unidad_medida" class='myselect'>  
				<?php echo unidades_medidas($seccion_ine_actividadDatos['id_unidad_medida']) ?>
			</select>
		</div>
		<div class="sucForm" style="width: 100%"></div>
		<?php
			$slctTipo[$seccion_ine_actividadDatos['tipo']] = 'selected="selected"';
		?>
		<div class="sucForm">
			...
			<select class="myselect" id="tipo" >
				...
				<option <?= $slctTipo['apoyo'] ?> value="apoyo">Apoyo</option>
				<option <?= $slctTipo['obra'] ?> value="obra">Obra</option>
				<option <?= $slctTipo['accion'] ?> value="accion">Accion</option>
			</select><br>
		</div>
		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Tipo Infruestructura<font color="#FF0004">*</font></label><br>
			<select class="myselect" id="id_tipo_infraestructura" >
				<?= tipos_infraestructuras($seccion_ine_actividadDatos['id_tipo_infraestructura']) ?>
			</select><br>
		</div>


		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Supervisor<font color="#FF0004">*</font></label><br>
			<select name="id_supervisor" id="id_supervisor" class='myselect'>  
				<?php echo supervisores($seccion_ine_actividadDatos['id_supervisor']) ?>
			</select>
		</div>
		...
		<div class="sucForm" style="width: 100%">
			...
			<textarea id="observaciones" style="width: 99%;height: 150px"><?= $seccion_ine_actividadDatos['observaciones'] ?></textarea> <br>
		</div>
		...
		<div class="sucForm">
			...
			<select class="myselect" id="id_seccion_ine" >
				<?php
				echo secciones_ine($seccion_ine_actividadDatos['id_seccion_ine']);
				?>
			</select><br>
		</div>
		...
		<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px;display: none;">
			...
			<select   name="id_pais" id="id_pais" class='myselect' disabled="disabled" >
				<?php
				echo paises($seccion_ine_actividadDatos['id_pais']);
				?>
			</select>
		</div>
		...
		<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px;display: none;">
			...
			<select   name="id_estado" id="id_estado" class='myselect' onchange="locationEstado(this);" disabled="disabled" >  
				<?php
				echo estados($seccion_ine_actividadDatos['id_estado']);
				?>
			</select>
		</div>
		<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px;">
			...
			<select   name="id_municipio" id="id_municipio" class='myselect' onchange="locationMunicipio(this)">  
				<?php
				echo municipios($seccion_ine_actividadDatos['id_municipio'],$seccion_ine_actividadDatos['id_estado']);
				?>
			</select>
		</div>
		<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px">
			...
			<select   name="id_localidad" id="id_localidad" class='myselect' onchange="locationLocalidad(this)">  
				<?php
				echo localidades($seccion_ine_actividadDatos['id_localidad'],$seccion_ine_actividadDatos['id_municipio'],$seccion_ine_actividadDatos['id_estado']);
				?>
			</select>
		</div>
		<div class="sucForm">
		...
		<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px;width: 100%">
			...
			<input class="inputlogin" type="text" name="calle" autocomplete="off" id="calle" value="<?= $seccion_ine_actividadDatos['calle'] ?>" placeholder="" maxlength="120" onkeyup="aMays(event, this)" /><br>
		</div>

		<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px">
			<label class="labelForm" id="labeltemaname">Num Ext.</label><br>
			<input class="inputlogin" type="text" name="num_ext" autocomplete="off"  id="num_ext" value="<?= $seccion_ine_actividadDatos['num_ext'] ?>" placeholder="" maxlength="120" onkeyup="aMays(event, this)" /><br>
		</div>

		<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px">
			<label class="labelForm" id="labeltemaname">Num Int.</label><br>
			<input class="inputlogin" type="text" name="num_int" autocomplete="off"  id="num_int" value="<?= $seccion_ine_actividadDatos['num_int'] ?>" placeholder="" maxlength="120" onkeyup="aMays(event, this)" /><br>
		</div>

		<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px">
			<label class="labelForm" id="labeltemaname">Colonia<font color="#FF0004">*</font></label><br>
			<input class="inputlogin" type="text" name="colonia" autocomplete="off"  id="colonia" value="<?= $seccion_ine_actividadDatos['colonia'] ?>" placeholder="" maxlength="120" onkeyup="aMays(event, this)" /><br>
		</div> 


		<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px">
			<label class="labelForm" id="labeltemaname">Código Postal<font color="#FF0004">*</font></label><br>
			<input class="inputlogin" type="text" name="codigo_postal" autocomplete="off"  id="codigo_postal" value="<?= $seccion_ine_actividadDatos['codigo_postal'] ?>" placeholder="" maxlength="120" onkeypress="return CheckNumeric()" /><br>
		</div>
		<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px">
		...
		<div class="sucForm" style="width: 100%">
			...
			<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px">
				...
				<input class="inputlogin" type="text" name="latitud" autocomplete="off"  id="latitud" value="<?= $seccion_ine_actividadDatos['latitud'] ?>" placeholder="" maxlength="120" onkeypress="" /><br>
			</div>

			<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px">
				<label class="labelForm" id="labeltemaname">Longitud<font color="#FF0004">*</font></label><br>
				<input class="inputlogin" type="text" name="longitud" autocomplete="off"  id="longitud" value="<?= $seccion_ine_actividadDatos['longitud'] ?>" placeholder="" maxlength="120" onkeypress=" " /><br>
			</div>
