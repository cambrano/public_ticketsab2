<?php
	...
	//unset($_COOKIE["searchOpcionesSIC"]);
		...
		<div style="float: right; width: 100%; text-align: left;"> 
			<?php
					...
					if( $moduloAccionPermisos['download'] || $moduloAccionPermisos['all']){
						...
						<!--<input id="btn_secciones_ine_ciudadanos_mapa_calor" type="button" value="Mapa de calor" onClick="SeccionesIneCiudadanoMapaCalor();">---->
						<?php
					}else{
						?>
