<?php
	...
	if(!empty($_POST)){
		...
		*/
		...
		$manzanas_ineDatosMapa = manzanas_ineDatosMapa();
		$manzanas_ine_parametrosDatosMapa = manzanas_ine_parametrosDatosMapa();
	...
	if($searchOpciones['tipo_mapa']!='sin_mapa' || $searchOpciones['tipo_mapa']=='' && !empty($_POST['searchOpciones']) ){
		...
		<div style="width:100%;padding:10px;font-size:18px">
			Registros Mostrados Color: <b><?= number_format(count($secciones_ine_ciudadanosDatosArray),0,",",".") ?></b>
		</div>
