<?php
	...
	$sql = "SELECT 
				...
				l.codigo_postal
			FROM secciones_ine_ciudadanos l WHERE 1"; 
	...
	while($row=$result->fetch_assoc()){
		...
		$nestedData[] = "<div style='text-transform: none;'>".$row["codigo_postal"]."<div>"; 
		if($option_delete){
	...
	if($post_search){
		$sqlContadorScript = "SELECT count(*) total FROM secciones_ine_ciudadanos WHERE 1 = 1   "; 
