<?php
	...
	@session_start(); 
	$_SESSION['Paguinasub']="seccionesIneCiudadanosCampanasMailingProgramadas/cancelar_masivos.php";
	if(!empty($_GET)){
		$id=$_SESSION['paguinaId']=$_GET['id'];
	}else{
		$id=$_SESSION['paguinaId'];
	}
	echo $redirectSecurity=redirectSecurity($id,'secciones_ine_ciudadanos_campanas_mailing_programadas','seccionesIneCiudadanosCampanasMailingProgramadas','index');
	if($redirectSecurity!=""){
		die;
	}
	...
	$tablasRelacionadas = tablasRelacionadas('secciones_ine_ciudadanos_campanas_mailing_programadas',$id);
...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "seccionesIneCiudadanosCampanasMailingProgramadas/db_cancelar_masivos.php",
				data: dataString,
	...
	<div class="bodymanager" id="bodymanager"> 
		...
		<div class="bodyinput">
			...
			<label class="descripcionForm">
				<strong><?= $seccion_ine_ciudadano_campana_mailing_programadaDatos['nombre']?></strong>
			</label><br>
			<?php
			if($registros_tablas!=''){
