<?php
	...
	@session_start(); 
	$_SESSION['Paguinasub']="seccionesIneCiudadanosCampanasSMSProgramadas/cancelar_masivos.php";
	if(!empty($_GET)){
		$id=$_SESSION['paguinaId']=$_GET['id'];
	}else{
		$id=$_SESSION['paguinaId'];
	}
	echo $redirectSecurity=redirectSecurity($id,'secciones_ine_ciudadanos_campanas_sms_programadas','seccionesIneCiudadanosCampanasSMSProgramadas','index');
	if($redirectSecurity!=""){
		die;
	}
	...
	$tablasRelacionadas = tablasRelacionadas('secciones_ine_ciudadanos_campanas_sms_programadas',$id);
...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "seccionesIneCiudadanosCampanasSMSProgramadas/db_cancelar_masivos.php",
				data: dataString,
	...
	<div class="bodymanager" id="bodymanager"> 
		...
		<div class="bodyinput">
			...
			<label class="descripcionForm">
				<strong><?= $seccion_ine_ciudadano_campana_sms_programadaDatos['nombre']?></strong>
			</label><br>
			<?php
			if($registros_tablas!=''){
