<?php
	...
	if(
		moduloAccion('sistema_unico_beneficiarios','secciones_ine_ciudadanos',$_COOKIE["id_usuario"],$permiso) ||
		moduloAccion('sistema_unico_beneficiarios','secciones_ine_ciudadanos',$_COOKIE["id_usuario"],'All') ){
		$permiso_usuario_action = true;
	}else{
		if(moduloAccion('sistema_unico_beneficiarios','secciones_ine_ciudadanos',$_COOKIE["id_usuario"],'View')){
...
?>
	...
	<div style=" width: 100%; display:inline-block; text-align: left;">
		...
		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Ciudadano Relacionado<font color="#FF0004">*</font></label><br>
			<select class="myselect" id="id_seccion_ine_ciudadano_compartido" >
				<?php
				echo secciones_ine_ciudadanos($seccion_ine_ciudadanoDatos['id_seccion_ine_ciudadano_compartido']);
				?>
			</select><br>
		</div>
		<div class="sucForm" style="width: 100%"></div>
