<?php
	...
	@session_start();
	$_SESSION['Paguinasub']='seccionesIneCiudadanosEncuestas/update.php';
	if(!empty($_GET['id'])){
		$id_encuesta=$_GET['id'];
	...
	$seccion_ine_ciudadano_encuestaDatos = seccion_ine_ciudadano_encuestaDatos('',$id_encuesta,$id_seccion_ine_ciudadano);
...
?>
	...
	<script language="javascript" type="text/javascript">
		function cerrar(){
			$("#homebody").load('seccionesIneCiudadanosEncuestas/index.php');
		}
		function guardar() {
