<?php
	...
	if(!empty($_GET)){
		$_SESSION['Paguinasub']="seccionesIneCiudadanosGiras/delete.php";
	...
	echo $redirectSecurity=redirectSecurity($id,'secciones_ine_ciudadanos_giras','seccionesIneCiudadanosGiras','index');
	if($redirectSecurity!=""){
		die;
	}
	$seccion_ine_ciudadano_giraDatos=seccion_ine_ciudadano_giraDatos($id,$id_seccion_ine_ciudadano);
	$id = $seccion_ine_ciudadano_giraDatos['id'];



	$moduloAccionPermisos = moduloAccionPermisos('sistema_unico_beneficiarios','secciones_ine_ciudadanos_giras',$_COOKIE["id_usuario"]);

	$tablasRelacionadas = tablasRelacionadas('secciones_ine_ciudadanos_giras',$id);
...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "seccionesIneCiudadanosGiras/db_delete.php",
				data: dataString,
	...
	<div class="bodymanager" id="bodymanager"> 
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Eliminar Participación</font>
				</label><br>
		...
		<div class="bodyinput">
			...
			<label class="descripcionForm">
				<strong><?=$seccion_ine_ciudadano_giraDatos['fecha_hora']; ?></strong>
			</label><br><br>
			<label class="labelForm" id="labeltemaname">Gira</label><br>
			<label class="descripcionForm">
				<strong><?=$seccion_ine_ciudadano_giraDatos['nombre_gira']; ?></strong>
			</label><br><br>
