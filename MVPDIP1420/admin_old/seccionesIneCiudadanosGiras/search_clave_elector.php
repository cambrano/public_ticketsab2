<?php
	...
	if(!empty($_POST)){
		...
		$id_seccion_ine_gira = $_POST['id_seccion_ine_gira'];
		...
		$sqlClave = "SELECT count(*) contador FROM secciones_ine_ciudadanos_giras WHERE id_seccion_ine_ciudadano = '{$id_seccion_ine_ciudadano}' AND id_seccion_ine_gira='{$id_seccion_ine_gira}' ";
