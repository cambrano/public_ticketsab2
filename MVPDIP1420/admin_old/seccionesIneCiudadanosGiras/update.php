<?php
	...
	@session_start(); 
	$_SESSION['Paguinasub']="seccionesIneCiudadanosGiras/update.php";  
	...
	$redirectSecurity=redirectSecurity($id,'secciones_ine_ciudadanos_giras','seccionesIneCiudadanosGiras','index');
	if($redirectSecurity!=""){
		die;
	}
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "seccionesIneCiudadanosGiras/db_edit.php",
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Modificar Participación</font>
				</label><br>
