<?php
	...
	if(!empty($_GET)){
		$_SESSION['Paguinasub']="seccionesIneCiudadanosGirasTotales/delete.php";
		$id=$_SESSION['paguinaId']=$_GET['id'];
	}else{
		$id=$_SESSION['paguinaId'];
	}
	$id_seccion_ine_gira=$_SESSION['id_seccion_ine_gira']; 
	echo $redirectSecurity=redirectSecurity($id,'secciones_ine_ciudadanos_giras','programasApoyos','index');
	if($redirectSecurity!=""){
		die;
	}
...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "seccionesIneCiudadanosGirasTotales/db_delete.php",
				data: dataString,
