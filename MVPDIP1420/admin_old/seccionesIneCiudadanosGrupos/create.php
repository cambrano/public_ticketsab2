<?php
	...
	@session_start();
	$_SESSION['Paguinasub']="seccionesIneCiudadanosGrupos/create.php";
	...
	$seccion_ine_ciudadano_grupoDatos['correo_electronico'] = $seccion_ine_ciudadanoDatos['correo_electronico'];
	$seccion_ine_ciudadano_grupoDatos['whatsapp'] = $seccion_ine_ciudadanoDatos['whatsapp'];
	$seccion_ine_ciudadano_grupoDatos['telefono'] = $seccion_ine_ciudadanoDatos['telefono'];
	$seccion_ine_ciudadano_grupoDatos['celular'] = $seccion_ine_ciudadanoDatos['celular'];
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			*/
			...
			$.ajax({
				type: "POST",
				url: "seccionesIneCiudadanosGrupos/db_add.php",
