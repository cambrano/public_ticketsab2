<?php
	...
	if(!empty($_GET)){
		$_SESSION['Paguinasub']="seccionesIneCiudadanosGrupos/delete.php";
	...
	echo $redirectSecurity=redirectSecurity($id,'secciones_ine_ciudadanos_grupos','seccionesIneCiudadanosGrupos','index');
	if($redirectSecurity!=""){
		die;
	}
...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "seccionesIneCiudadanosGrupos/db_delete.php",
				data: dataString,
