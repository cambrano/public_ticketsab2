<?php
	...
	if(!empty($_POST)){
		...
		$sqlClave = "SELECT count(*) contador FROM secciones_ine_ciudadanos_grupos WHERE id_seccion_ine_ciudadano = '{$id_seccion_ine_ciudadano}' AND id_programa_apoyo='{$id_programa_apoyo}' ";
