	...
	<script type="text/javascript" language="javascript" >
		$(document).ready(function() {
			...
			var dataTable = $('#secciones_ine_ciudadanos_grupos-tabla').DataTable( {
				...
				"ajax":{
					url :"seccionesIneCiudadanosGrupos/secciones_ine_ciudadanos_grupos.php", // json datasource
			...
			$('#selectCheckbox').on("click", function(event){ // triggering delete one by one
				if( $('.checkselected:checked').length > 0 ){  // at-least one checkbox checked
					...
					var link="seccionesIneCiudadanosGrupos/index.php?cot="+ids_string;   
		...
		function edit(valor){
			link="seccionesIneCiudadanosGrupos/update.php?id="+valor; 
			var link2="seccionesIneCiudadanosGrupos/update.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
		...
		function add(){
			////ajax
			link="seccionesIneCiudadanosGrupos/create.php";
			var link2="seccionesIneCiudadanosGrupos/create.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
		...
		function borrar(valor){
			link="seccionesIneCiudadanosGrupos/delete.php?id="+valor; 
			var link2="seccionesIneCiudadanosGrupos/delete.php";
			dataString = 'urlink='+link2; 
			/*
			$.ajax({
				type: "POST",
