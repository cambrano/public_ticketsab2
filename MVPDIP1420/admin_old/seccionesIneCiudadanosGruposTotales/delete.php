<?php
	...
	if(!empty($_GET)){
		$_SESSION['Paguinasub']="seccionesIneCiudadanosGruposTotales/delete.php";
		$id=$_SESSION['paguinaId']=$_GET['id'];
	}else{
		$id=$_SESSION['paguinaId'];
	}
	$id_seccion_ine_grupo=$_SESSION['id_seccion_ine_grupo']; 
	echo $redirectSecurity=redirectSecurity($id,'secciones_ine_ciudadanos_grupos','militantesPartidos','index');
	if($redirectSecurity!=""){
		die;
	}
	$seccion_ine_ciudadano_grupoDatos=seccion_ine_ciudadano_grupoDatos($id);
	$id = $seccion_ine_ciudadano_grupoDatos['id'];
	...
	$tablasRelacionadas = tablasRelacionadas('secciones_ine_ciudadanos_grupos',$id);
...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "seccionesIneCiudadanosGruposTotales/db_delete.php",
				data: dataString,
	...
	<div class="bodymanager" id="bodymanager"> 
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Eliminar Miembro</font>
				</label><br>
		...
		<div class="bodyinput">
			...
			<label class="descripcionForm">
				<strong><?=$seccion_ine_ciudadano_grupoDatos['nombre_grupo']; ?></strong>
			</label><br><br>
