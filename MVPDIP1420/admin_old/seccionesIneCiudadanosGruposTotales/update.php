<?php
	...
	@session_start(); 
	$_SESSION['Paguinasub']="seccionesIneCiudadanosGruposTotales/update.php";  
	...
	$redirectSecurity=redirectSecurity($id,'secciones_ine_ciudadanos_grupos','militantesPartidos','index');
	if($redirectSecurity!=""){
		die;
	}
	...
	if($id_seccion_ine_grupo!=""){
		...
		$nombre_completo = $seccion_ine_grupoDatos['nombre_completo'];
		$id_seccion_ine = $seccion_ine_grupoDatos['id_seccion_ine'];
	}else{
	...
	$id_seccion_ine_ciudadano = $seccion_ine_ciudadano_grupoDatos['id_seccion_ine_ciudadano'];
	$row = seccion_ine_ciudadanoDatos($id_seccion_ine_ciudadano);

	$seccion_ine_ciudadano_grupoDatos['clave_elector'] = $row['clave_elector'];
	...
	<script language="javascript" type="text/javascript">
		function cerrar(){
			$("#homebody").load('seccionesIneCiudadanosGruposTotales/index.php');
		}
		...
		function guardar() {
			...
			*/
			...
			$.ajax({
				type: "POST",
				url: "seccionesIneCiudadanosGruposTotales/db_edit.php",
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Modificar Miembro</font>
				</label><br>
				<h2><?= $row['nombre_completo']; ?></h2>
				<label class="descripcionForm">
					<font style="font-size: 13px;">Campos para modificar miembro.</font><br><br>
				</label><br>
