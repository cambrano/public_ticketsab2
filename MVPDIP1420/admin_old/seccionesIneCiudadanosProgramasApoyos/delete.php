<?php
	...
	if(!empty($_GET)){
		$_SESSION['Paguinasub']="seccionesIneCiudadanosProgramasApoyos/delete.php";
	...
	$tablasRelacionadas = tablasRelacionadas('secciones_ine_ciudadanos_programas_apoyos',$id);
