<?php
	...
	if($post_search){
		$sqlContadorScript = "SELECT count(*) total FROM secciones_ine_ciudadanos_programas_apoyos sicpa WHERE 1 = 1 AND sicpa.id_seccion_ine_ciudadano ='{$id_seccion_ine_ciudadano}'   "; 
