<?php
	...
	if(!empty($_POST)){
		...
		$_POST["seccion_ine_ciudadano_programa_apoyo"][0]['id_seccion_ine_ciudadano'] = seccion_ine_ciudadanoClaveElectorVerificacion($_POST["seccion_ine_ciudadano_programa_apoyo"][0]['clave_elector']);
		unset($_POST["seccion_ine_ciudadano_programa_apoyo"][0]['clave_elector']);
		if($_POST["seccion_ine_ciudadano_programa_apoyo"][0]['id_seccion_ine_ciudadano']==''){
