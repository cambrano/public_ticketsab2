<?php
	...
	if(!empty($_GET)){
		$_SESSION['Paguinasub']="seccionesIneCiudadanosProgramasApoyosTotales/delete.php";
		$id=$_SESSION['paguinaId']=$_GET['id'];
	}else{
		$id=$_SESSION['paguinaId'];
	}
	$id_programa_apoyo=$_SESSION['id_programa_apoyo']; 
	echo $redirectSecurity=redirectSecurity($id,'secciones_ine_ciudadanos_programas_apoyos','programasApoyos','index');
	if($redirectSecurity!=""){
		die;
	}
