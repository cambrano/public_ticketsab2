<?php
	...
	validar_plataforma_vista($id,'secciones_ine_ciudadanos','seccionesIneCiudadanosSeccion','index',$codigo_plataforma);
	...
	$tablasRelacionadas = tablasRelacionadas('secciones_ine_ciudadanos',$id);

	$registros_titutlo = 'Este registro esta ligado a : <br>';
	foreach ($tablasRelacionadas['tablas'] as $key => $value) {
		if($value['registros']>0 && $value['tabla']!='usuarios' && $value['tabla']!='secciones_ine_ciudadanos_permisos'  && $value['tabla']!='secciones_ine_ciudadanos_categorias' && $value['tabla']!='secciones_ine_ciudadanos_check_2021' && $value['tabla']!='secciones_ine_ciudadanos_seguimientos'){
...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "seccionesIneCiudadanosSeccion/db_delete.php",
				data: dataString,
