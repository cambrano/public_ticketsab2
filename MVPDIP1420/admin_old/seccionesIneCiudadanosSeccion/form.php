<?php
	...
	$manzanas_ine_parametrosDatosMapa = manzanas_ine_parametrosDatosMapa('','',$id_seccion_ine,$id_municipio,$id_distrito_local,$id_distrito_federal,'','');
...
?>
	...
	<div style=" width: 100%; display:inline-block; text-align: left;">
		...
		<div class="sucFormTitulo sucFormTituloBoton" onclick="buscadorArea()"  >
			<label class="labelForm sucFormTituloBoton" id="labeltemaname">Buscador Datos Amigos</label><br>
		</div>
