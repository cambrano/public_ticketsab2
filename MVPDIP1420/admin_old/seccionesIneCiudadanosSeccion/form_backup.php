...
?>
	...
	<script type="text/javascript">
		...
		function myMap(coordenadas=null,zoomCoordenada=null) {
				...
				*/
				...
				if($tipo_uso_plataforma=='municipio'){
					if ($secciones_ineDatosMapa[$key]['id_municipio'] == $id_municipio ){
						if ($secciones_ineDatosMapa[$key]['id'] == $id_seccion_ine) {
							$strokeColor='#000000';
							$fillColor='#000000';
						}else{
							$strokeColor='#001A36';
			...
			foreach ($manzanas_ine_parametrosDatosMapa as $key => $value) {
				...
				*/
				...
				if($tipo_uso_plataforma=='municipio'){
					if ($manzanas_ineDatosMapa[$key]['id_municipio'] == $id_municipio ){
						if ($manzanas_ineDatosMapa[$key]['id_seccion_ine'] == $id_seccion_ine) {
							$strokeColor='#000000';
							$fillColor='#000000';
						}else{
							$strokeColor='#001A36';
					...
					if ($manzanas_ineDatosMapa[$key]['id_distrito_local'] == $id_distrito_local ){
						if ($manzanas_ineDatosMapa[$key]['id_seccion_ine'] == $id_seccion_ine) {
							$strokeColor='#000000';
							$fillColor='#000000';
						}else{
					...
					if ($manzanas_ineDatosMapa[$key]['id_distrito_federal'] == $id_distrito_federal ){
						if ($manzanas_ineDatosMapa[$key]['id_seccion_ine'] == $id_seccion_ine) {
							$strokeColor='#000000';
							$fillColor='#000000';
						}else{
		...
		function buscar_clave_electoral(){
			...
			$.ajax({
				type: "POST",
				url: "seccionesIneCiudadanosSeccion/search_clave_elector.php",
				data: dataString,
				dataType: 'json',
				success: function(data) {
					//console.log(data);
	...
	<div style=" width: 100%; display:inline-block; text-align: left;">
		<div class="sucFormTitulo">
			<label class="labelForm" id="labeltemaname">Buscador Datos Amigos</label><br>
		</div>
		...
		<script>
		<div class="sucFormTitulo">
			<label class="labelForm" id="labeltemaname">Datos del ciudadano</label><br>
		</div>
		...
		*/
		...
		<div class="sucForm" style="width: 100%"></div>
		<div class="sucFormTitulo">
			<label class="labelForm" id="labeltemaname">Datos Personales</label><br>
		</div>
		<div class="sucForm" style="width: 100%"></div>
		<div class="sucForm">
		...
		<div class="sucForm">
			...
			<input class="inputlogin" type="text" name="whatsapp" autocomplete="off"  id="whatsapp" value="<?= $seccion_ine_ciudadanoDatos['whatsapp'] ?>" placeholder="9991742151" onkeypress="return CheckNumeric()" /><br>
		</div>
		...
		<div class="sucForm">
			...
			<input class="inputlogin" type="text" name="celular" autocomplete="off"  id="celular" value="<?= $seccion_ine_ciudadanoDatos['celular'] ?>" placeholder="9991742151" onkeypress="return CheckNumeric()" /><br>
		</div>

		<div class="sucFormTitulo">
			<label class="labelForm" id="labeltemaname">Dirección Actual</label><br>
		</div>
		...
		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Vigencia INE</label><br>
