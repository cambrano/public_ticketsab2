...
?>
	<script type="text/javascript" language="javascript" >
		...
		function printPdf(valor){
			//var link="seccionesIneCiudadanosSeccion/print/index.php?cot=<?=$_SESSION['pageService']?>"; 
		...
		function ciudadano_categoria(valor){
			link="seccionesIneCiudadanosSeccionCategorias/index.php?cot="+valor; 
			var link2="seccionesIneCiudadanosSeccionCategorias/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
		...
		function encuestas(valor){
			link="seccionesIneCiudadanosSeccionEncuestas/index.php?cot="+valor; 
			var link2="seccionesIneCiudadanosSeccionEncuestas/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
		...
		function seguimientos(valor){
			link="seccionesIneCiudadanosSeccionSeguimientos/index.php?cot="+valor; 
			var link2="seccionesIneCiudadanosSeccionSeguimientos/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
		...
		function campanas_mailing_ciudadano(valor){
			link="seccionesIneCiudadanosSeccionMailing/index.php?cot="+valor; 
			var link2="seccionesIneCiudadanosSeccionMailing/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
		...
		function campanas_sms_ciudadano(valor){
			link="seccionesIneCiudadanosSeccionSMS/index.php?cot="+valor; 
			var link2="seccionesIneCiudadanosSeccionSMS/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
		...
		function campanas_whatsapp_ciudadano(valor){
			link="seccionesIneCiudadanosSeccionWhatsapp/index.php?cot="+valor; 
			var link2="seccionesIneCiudadanosSeccionWhatsapp/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
		...
		function programas_apoyos(valor){
			link="seccionesIneCiudadanosSeccionProgramasApoyos/index.php?cot="+valor; 
			var link2="seccionesIneCiudadanosSeccionProgramasApoyos/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
