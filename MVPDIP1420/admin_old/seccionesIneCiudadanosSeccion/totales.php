<?php
	...
	$sql = "
		SELECT 
			(SELECT COUNT(*) FROM secciones_ine_ciudadanos WHERE id_seccion_ine = '{$id_seccion_ine}' ) ciudadanos_totales,
			(SELECT SUM(lista_nominal) FROM manzanas_ine WHERE id_seccion_ine = '{$id_seccion_ine}' ) total_lista_nominal_2021,
		...
		FROM   secciones_ine_ciudadanos sice WHERE sice.id_seccion_ine = '{$id_seccion_ine}' ";
	...
	$sql = "
		SELECT 
			tc.nombre,
			(SELECT COUNT(*) FROM secciones_ine_ciudadanos sic WHERE sic.id_tipo_ciudadano = tc.id AND sic.id_seccion_ine = '{$id_seccion_ine}' ) ciudadanos
		FROM tipos_ciudadanos tc ";
	...
	$sql = "
		SELECT 
			tc.nombre,
			(SELECT COUNT(*) FROM secciones_ine_ciudadanos_categorias sic WHERE sic.id_tipo_categoria_ciudadano = tc.id AND sic.id_seccion_ine = '{$id_seccion_ine}' ) ciudadanos
		FROM tipos_categorias_ciudadanos tc ";
	...
	$sql = "
		SELECT 'sin categoría' nombre,COUNT(*) ciudadanos FROM secciones_ine_ciudadanos sic WHERE NOT EXISTS (SELECT * FROM secciones_ine_ciudadanos_categorias sicc WHERE sicc.id_seccion_ine_ciudadano = sic.id ) AND sic.id_seccion_ine = '{$id_seccion_ine}' ";
