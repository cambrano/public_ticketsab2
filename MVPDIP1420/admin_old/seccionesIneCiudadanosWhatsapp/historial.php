<?php
	...
	@session_start(); 
	$_SESSION['Paguinasub']="seccionesIneCiudadanosWhatsapp/historial.php";  
	if(!empty($_GET)){
	...
	$api_whatsapp_mensajesWhatsappDatos = api_whatsapp_mensajesIdSeccionCiudadanoDatos($id,' id DESC');
	...
	<script language="javascript" type="text/javascript">
		function cerrar(){
			$("#homebody").load('seccionesIneCiudadanosWhatsapp/index.php');
		}
	</script>
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Mensajes</font><br>
					<?= $seccion_ine_ciudadanoDatos['nombre_completo'] ?><br><br>
					<i class="fab fa-whatsapp" style="color: #00bb2d;font-size: 28px;font-weight: bold;"></i><?= $seccion_ine_ciudadanoDatos['whatsapp'] ?>
				</label><br>
				...
				<div style="background-color:rgba(0, 0, 0,0.8);">
					<div class="chat" style="padding: 20px 0px 20px 0px">
						...
						foreach ($api_whatsapp_mensajesWhatsappDatos as $key => $value) {
							...
							if($value['MediaUrl0']!=''){
								if($value['MediaContentType0']==''){
									$headers = get_headers($value['MediaUrl0'], 1);
									$value['MediaContentType0'] = $headers["Content-Type"];
								}
								if( 
