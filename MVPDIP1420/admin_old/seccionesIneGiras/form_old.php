...
?>
	...
	<div style=" width: 100%; display:inline-block; text-align: left;">
		...
		<div id="datos_response" class="sucForm" style="width: 100%">
		alex
		</div>
		<div class="sucForm" style="width: 100%">
			<div class="sucForm" style="float: left;position: relative;margin-right: 5px;margin-bottom: 5px">
				<label class="labelForm" id="labeltemaname"><br></label><br>
				<input type="button" value="Agregar Punto" id="puntero_opcion" onclick="agregar_puntos()">
			</div>
			<br><br>
		</div>
		<script>
			function agregar_puntos(){
				document.getElementById("puntero_opcion").disabled = true;
				var espacios_invalidos= /\s+/g;
				var latitud = document.getElementById("latitud").value; 
				latitud = latitud.replace(espacios_invalidos, '');
				if(latitud == ""){
					document.getElementById("latitud").focus(); 
					document.getElementById("puntero_opcion").disabled = false;
					return false;
				}
				var longitud = document.getElementById("longitud").value; 
				longitud = longitud.replace(espacios_invalidos, '');
