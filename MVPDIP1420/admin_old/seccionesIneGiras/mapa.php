<?php
	...
	if(!empty($_POST)){
		...
		include '../functions/secciones_ine_giras_puntos.php';
		$punto=false;
		...
		$secciones_ine_girasDatosArray=secciones_ine_girasDatosArray($_POST['searchTable'][0],$orderby,$limit);
		...
		if($punto==false){
			$zoom = 14;
			if($secciones_ine_girasDatosArray[0]['latitud'] != '' ){
				$latitud = $secciones_ine_girasDatosArray[0]['latitud'];
				$longitud = $secciones_ine_girasDatosArray[0]['longitud'];
			}
		}else{
			$zoom = 14;
		}
