<?php
	@session_start();
	$_SESSION['Paguinasub']="seccionesIneGiras/update.php";
	if($_GET['refresh']==1){
	...
	foreach ($secciones_ine_giras_puntosDatos as $key => $value) {
		$value['status'] = 1;
		$_SESSION['puntos_line'][$key] = $value;
	}
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Modificar Gira</font>
				</label><br>
				<label class="descripcionForm">
					<font style="font-size: 13px;">Campos para modificar a gira.</font><br><br>
				</label><br>
