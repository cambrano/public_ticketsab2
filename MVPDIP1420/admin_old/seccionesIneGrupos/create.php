<?php
	...
	@session_start();
	$_SESSION['Paguinasub']="seccionesIneGrupos/create.php";  
	$claveF= clave('secciones_ine_grupos');
	$seccion_ine_grupoDatos['clave']=$claveF['clave'];
	$permiso="insert";

	$seccion_ine_grupoDatos['id_estado'] = $id_estado;
	$seccion_ine_grupoDatos['id_municipio'] = $id_municipio;
	$seccion_ine_grupoDatos['id_localidad'] = 290086;
	$seccion_ine_grupoDatos['fecha'] = date("Y-m-d");
	$seccion_ine_grupoDatos['hora'] = date("H:i:s");
...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "seccionesIneGrupos/db_add.php",
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Crear Grupo de Interes</font>
				</label><br>
				<label class="descripcionForm">
					<font style="font-size: 13px;">Campos para registrar y dar de alta a grupo de interes.</font><br><br>
				</label><br>
