...
?>
	<script type="text/javascript">
		...
		function searchTable(value){
			...
			console.log(id_seccion_ine_array_table);
			...
			if(tipo_seccion==""){
				$('#secciones_reportes-tabla').DataTable().column(8).search(tipo_seccion).draw();
			}else{
				//$('#secciones_reportes-tabla').DataTable().column(0).search("(^"+tipo_seccion+"$)",true,false).draw();
				$('#secciones_reportes-tabla').DataTable().column(8).search(tipo_seccion_array_table.join('|'), true, false).draw();
			}
