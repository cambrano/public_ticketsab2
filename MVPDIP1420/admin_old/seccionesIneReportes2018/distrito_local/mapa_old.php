	...
	if(!empty($_POST)){
		...
		*/
		...
		$sql="
			 SELECT
				...
				dl.latitud,
				dl.longitud,
				(SELECT SUM(cvp2018.votos)  FROM casillas_votos_partidos_2018 cvp2018 WHERE cvp2018.tipo = 1 AND cvp2018.id_distrito_local = dl.id GROUP BY cvp2018.id_partido_2018 ORDER BY SUM(cvp2018.votos) DESC LIMIT 1) partido_ganador_votos,

				(SELECT cvp2018.id_partido_2018  FROM casillas_votos_partidos_2018 cvp2018 WHERE cvp2018.tipo = 1 AND cvp2018.id_distrito_local = dl.id GROUP BY cvp2018.id_partido_2018 ORDER BY SUM(cvp2018.votos) DESC LIMIT 1) partido_ganador_id,

				(SELECT p2018Ganador.color_background  FROM casillas_votos_partidos_2018 cvp2018 LEFT JOIN partidos_2018 p2018Ganador ON p2018Ganador.id= cvp2018.id_partido_2018  WHERE cvp2018.tipo = 1 AND p2018Ganador.tipo = 1 AND cvp2018.id_distrito_local = dl.id GROUP BY cvp2018.id_partido_2018 ORDER BY SUM(cvp2018.votos) DESC LIMIT 1) partido_ganador_background,

				(SELECT p2018Ganador.color_border  FROM casillas_votos_partidos_2018 cvp2018 LEFT JOIN partidos_2018 p2018Ganador ON p2018Ganador.id= cvp2018.id_partido_2018  WHERE cvp2018.tipo = 1 AND p2018Ganador.tipo = 1 AND cvp2018.id_distrito_local = dl.id GROUP BY cvp2018.id_partido_2018 ORDER BY SUM(cvp2018.votos) DESC LIMIT 1) partido_ganador_border,

				(SELECT p2018Ganador.nombre_corto  FROM casillas_votos_partidos_2018 cvp2018 LEFT JOIN partidos_2018 p2018Ganador ON p2018Ganador.id= cvp2018.id_partido_2018  WHERE cvp2018.tipo = 1 AND p2018Ganador.tipo = 1 AND cvp2018.id_distrito_local = dl.id GROUP BY cvp2018.id_partido_2018 ORDER BY SUM(cvp2018.votos) DESC LIMIT 1) partido_ganador_nombre_corto,

				(SELECT p2018Ganador.icono  FROM casillas_votos_partidos_2018 cvp2018 LEFT JOIN partidos_2018 p2018Ganador ON p2018Ganador.id= cvp2018.id_partido_2018  WHERE cvp2018.tipo = 1 AND p2018Ganador.tipo = 1 AND cvp2018.id_distrito_local = dl.id GROUP BY cvp2018.id_partido_2018 ORDER BY SUM(cvp2018.votos) DESC LIMIT 1) partido_ganador_icono,

				(SELECT p2018Ganador.logo  FROM casillas_votos_partidos_2018 cvp2018 LEFT JOIN partidos_2018 p2018Ganador ON p2018Ganador.id= cvp2018.id_partido_2018  WHERE cvp2018.tipo = 1 AND p2018Ganador.tipo = 1 AND cvp2018.id_distrito_local = dl.id GROUP BY cvp2018.id_partido_2018 ORDER BY SUM(cvp2018.votos) DESC LIMIT 1) partido_ganador_logo,

				p2018Sistema.id partido_sistema_id,
				p2018Sistema.nombre_corto partido_sistema_corto,

				p2018Sistema.color_border partido_sistema_border,

				p2018Sistema.color_background partido_sistema_background,

				p2018Sistema.logo partido_sistema_logo,

				(SELECT SUM(cvp2018.votos)  FROM casillas_votos_partidos_2018 cvp2018 WHERE cvp2018.tipo = 1 AND cvp2018.id_distrito_local = dl.id AND cvp2018.id_partido_2018 = p2018Sistema.id ) partido_sistema_votos,

				(SELECT SUM(cv2018.votos_nulos) FROM casillas_votos_2018 cv2018 WHERE cv2018.tipo = 1 AND cv2018.id_distrito_local = dl.id ) votos_nulos,

				(SELECT SUM(cv2018.votos_can_nreg) FROM casillas_votos_2018 cv2018 WHERE cv2018.tipo = 1 AND cv2018.id_distrito_local = dl.id ) votos_can_nreg,

				(SELECT SUM(cv2018.lista_nominal) FROM casillas_votos_2018 cv2018 WHERE cv2018.tipo = 1 AND cv2018.id_distrito_local = dl.id ) lista_nominal,

				(SELECT SUM(cvp2018.votos) FROM casillas_votos_partidos_2018 cvp2018 WHERE cvp2018.tipo = 1 AND cvp2018.id_distrito_local = dl.id ) votos_validos

			FROM distritos_locales dl
			LEFT JOIN partidos_2018 p2018Sistema
			ON p2018Sistema.principal = 1
			WHERE p2018Sistema.tipo = 1
		";
		if($id_distrito_local !=''){
			$sql .= " AND dl.id = {$id_distrito_local} ";
		}
			...
			SELECT
				...
				FROM(
					SELECT 
						...
						si.latitud,
						si.longitud,
						(SELECT SUM(cvp2018.votos) FROM casillas_votos_partidos_2018 cvp2018 WHERE cvp2018.tipo = 1 AND cvp2018.id_seccion_ine = si.id AND cvp2018.id_distrito_local = '{$id_distrito_local}' GROUP BY cvp2018.id_partido_2018 ORDER BY SUM(cvp2018.votos) DESC limit 1 ) partido_ganador_votos,

						(SELECT cvp2018.id_partido_2018 FROM casillas_votos_partidos_2018 cvp2018 WHERE cvp2018.tipo = 1 AND cvp2018.id_seccion_ine = si.id AND cvp2018.id_distrito_local = '{$id_distrito_local}' GROUP BY cvp2018.id_partido_2018 ORDER BY SUM(cvp2018.votos) DESC limit 1 ) partido_ganador_id,

						(SELECT p2018.id  FROM partidos_2018 p2018 WHERE p2018.principal = '1' AND p2018.tipo = 1 LIMIT 1) partido_sistema_id,
						(SELECT p2018.nombre_corto  FROM partidos_2018 p2018 WHERE p2018.principal = '1' AND p2018.tipo = 1 LIMIT 1) partido_sistema_corto,
						(SELECT p2018.color_border  FROM partidos_2018 p2018 WHERE p2018.principal = '1' AND p2018.tipo = 1 LIMIT 1) partido_sistema_border,
						(SELECT p2018.color_background  FROM partidos_2018 p2018 WHERE p2018.principal = '1' AND p2018.tipo = 1 LIMIT 1) partido_sistema_background,
						(SELECT p2018.logo  FROM partidos_2018 p2018 WHERE p2018.principal = '1' AND p2018.tipo = 1 LIMIT 1) partido_sistema_logo,
						(SELECT SUM(cvp2018.votos)  FROM casillas_votos_partidos_2018 cvp2018 WHERE cvp2018.tipo = 1 AND cvp2018.id_distrito_local = '{$id_distrito_local}' AND EXISTS (SELECT p.id  FROM partidos_2018 p WHERE p.principal = '1' AND p.id = cvp2018.id_partido_2018 AND p.tipo = 1 ) AND cvp2018.id_seccion_ine=si.id) partido_sistema_votos,
						(SELECT SUM(IFNULL(cv2018.votos_nulos,0)) FROM casillas_votos_2018 cv2018 WHERE cv2018.tipo = 1 AND cv2018.id_seccion_ine = si.id AND cv2018.id_distrito_local = '{$id_distrito_local}') votos_nulos,
						(SELECT SUM(IFNULL(cv2018.votos_can_nreg,0)) FROM casillas_votos_2018 cv2018 WHERE cv2018.tipo = 1 AND cv2018.id_seccion_ine = si.id AND cv2018.id_distrito_local = '{$id_distrito_local}' ) votos_can_nreg,
						(SELECT SUM(IFNULL(cv2018.lista_nominal,0)) FROM casillas_votos_2018 cv2018 WHERE cv2018.tipo = 1 AND cv2018.id_seccion_ine = si.id AND cv2018.id_distrito_local = '{$id_distrito_local}' ) lista_nominal,
						(SELECT SUM(IFNULL(cvp2018.votos,0)) FROM casillas_votos_partidos_2018 cvp2018 WHERE cvp2018.tipo = 1 AND cvp2018.id_seccion_ine = si.id AND cvp2018.id_distrito_local = '{$id_distrito_local}' ) votos_validos,
						(SELECT COUNT(cv2018.id) FROM casillas_votos_2018 cv2018 WHERE cv2018.tipo = 1 AND cv2018.id_seccion_ine = si.id AND cv2018.id_distrito_local = '{$id_distrito_local}' ) casillas ,si.tipo
		...
		*/
		...
		$sql="
			...
			LEFT JOIN partidos_2018 p2018Sistema
			ON p2018Sistema.principal = 1
			/*WHERE dl.id = '{$id_distrito_local}' AND p2018Sistema.tipo = 1 */
			WHERE  p2018Sistema.tipo = 1 
		";
		if($id_distrito_local !=''){
			$sql .= " AND dl.id = {$id_distrito_local} ";
			...
			SELECT
				...
				FROM(
					SELECT 
						...
						(SELECT p2018.id  FROM partidos_2018 p2018 WHERE p2018.tipo = 1 AND  p2018.principal = '1' LIMIT 1) partido_sistema_id,
						(SELECT p2018.nombre_corto  FROM partidos_2018 p2018 WHERE  p2018.tipo = 1 AND   p2018.principal = '1' LIMIT 1) partido_sistema_corto,
						(SELECT p2018.color_border  FROM partidos_2018 p2018 WHERE p2018.tipo = 1 AND   p2018.principal = '1' LIMIT 1) partido_sistema_border,
						(SELECT p2018.color_background  FROM partidos_2018 p2018 WHERE p2018.tipo = 1 AND   p2018.principal = '1' LIMIT 1) partido_sistema_background,
						(SELECT p2018.logo  FROM partidos_2018 p2018 WHERE p2018.tipo = 2 AND p2018.principal = '1' LIMIT 1) partido_sistema_logo,
						(SELECT SUM(cvp2018.votos)  FROM casillas_votos_partidos_2018 cvp2018 WHERE cvp2018.tipo = 1 AND   cvp2018.id_distrito_local = '{$id_distrito_local}' AND EXISTS (SELECT p.id  FROM partidos_2018 p WHERE p.tipo = 1 AND p.principal = '1' AND p.id = cvp2018.id_partido_2018  ) AND cvp2018.id_seccion_ine=si.id) partido_sistema_votos,
						(SELECT SUM(IFNULL(cv2018.votos_nulos,0)) FROM casillas_votos_2018 cv2018 WHERE cv2018.tipo = 1 AND cv2018.id_seccion_ine = si.id AND cv2018.id_distrito_local = '{$id_distrito_local}') votos_nulos,
						(SELECT SUM(IFNULL(cv2018.votos_can_nreg,0)) FROM casillas_votos_2018 cv2018 WHERE cv2018.tipo = 1 AND cv2018.id_seccion_ine = si.id AND cv2018.id_distrito_local = '{$id_distrito_local}' ) votos_can_nreg,
						(SELECT SUM(IFNULL(cv2018.lista_nominal,0)) FROM casillas_votos_2018 cv2018 WHERE cv2018.tipo = 1 AND cv2018.id_seccion_ine = si.id AND cv2018.id_distrito_local = '{$id_distrito_local}' ) lista_nominal,
						(SELECT SUM(IFNULL(cvp2018.votos,0)) FROM casillas_votos_partidos_2018 cvp2018 WHERE cvp2018.tipo = 1 AND cvp2018.id_seccion_ine = si.id AND cvp2018.id_distrito_local = '{$id_distrito_local}' ) votos_validos,
	...
	<script type="text/javascript">
		function myMap(){
			...
			foreach ($distritos_locales_parametrosDatosMapa as $key => $value) {
				$distritos_localesDatosMapa[$key]['numero'];
				$distritos_localesDatosMapa[$key]['latitud'];
				$distritos_localesDatosMapa[$key]['longitud'];
				$paths = "";
						...
						if($value['id'] != $id_distrito_local){
							...
							$div = '<div class="divMapa">
										<div class="info_content">
											<h4>Distrito Local: '.$value['numero'].'</h4>
											...
											<div class="info_seccion_ganador_button">
												<button class="button button4" onclick="verMasDistritoLocal('.$value['id'].')">Ver Más</button>
											</div>
										</div>
