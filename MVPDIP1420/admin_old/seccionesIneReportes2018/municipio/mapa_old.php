	...
	if(!empty($_POST)){
		...
		*/
		...
		$sql="
			 SELECT
				...
				dl.latitud,
				dl.longitud,
				(SELECT SUM(cvp2018.votos)  FROM casillas_votos_partidos_2018 cvp2018 WHERE cvp2018.tipo = 1 AND cvp2018.id_municipio = dl.id GROUP BY cvp2018.id_partido_2018 ORDER BY SUM(cvp2018.votos) DESC LIMIT 1) partido_ganador_votos,

				(SELECT cvp2018.id_partido_2018  FROM casillas_votos_partidos_2018 cvp2018 WHERE cvp2018.tipo = 1 AND cvp2018.id_municipio = dl.id GROUP BY cvp2018.id_partido_2018 ORDER BY SUM(cvp2018.votos) DESC LIMIT 1) partido_ganador_id,

				(SELECT p2018Ganador.color_background  FROM casillas_votos_partidos_2018 cvp2018 LEFT JOIN partidos_2018 p2018Ganador ON p2018Ganador.id= cvp2018.id_partido_2018  WHERE cvp2018.tipo = 1 AND p2018Ganador.tipo = 1 AND cvp2018.id_municipio = dl.id GROUP BY cvp2018.id_partido_2018 ORDER BY SUM(cvp2018.votos) DESC LIMIT 1) partido_ganador_background,
				...
				(SELECT SUM(cvp2018.votos)  FROM casillas_votos_partidos_2018 cvp2018 WHERE cvp2018.tipo = 1 AND cvp2018.id_municipio = dl.id AND cvp2018.id_partido_2018 = p2018Sistema.id ) partido_sistema_votos,

				(SELECT SUM(cv2018.votos_nulos) FROM casillas_votos_2018 cv2018 WHERE cv2018.tipo = 1 AND cv2018.id_municipio = dl.id ) votos_nulos,

				(SELECT SUM(cv2018.votos_can_nreg) FROM casillas_votos_2018 cv2018 WHERE cv2018.tipo = 1 AND cv2018.id_municipio = dl.id ) votos_can_nreg,

				(SELECT SUM(cv2018.lista_nominal) FROM casillas_votos_2018 cv2018 WHERE cv2018.tipo = 1 AND cv2018.id_municipio = dl.id ) lista_nominal,

				(SELECT SUM(cvp2018.votos) FROM casillas_votos_partidos_2018 cvp2018 WHERE cvp2018.tipo = 1 AND cvp2018.id_municipio = dl.id ) votos_validos
			...
			SELECT
				...
				FROM(
					SELECT 
						...
						si.latitud,
						si.longitud,
						(SELECT SUM(cvp2018.votos) FROM casillas_votos_partidos_2018 cvp2018 WHERE cvp2018.tipo = 1 AND cvp2018.id_seccion_ine = si.id AND cvp2018.id_municipio = '{$id_municipio}' GROUP BY cvp2018.id_partido_2018 ORDER BY SUM(cvp2018.votos) DESC limit 1 ) partido_ganador_votos,

						(SELECT cvp2018.id_partido_2018 FROM casillas_votos_partidos_2018 cvp2018 WHERE cvp2018.tipo = 1 AND cvp2018.id_seccion_ine = si.id AND cvp2018.id_municipio = '{$id_municipio}' GROUP BY cvp2018.id_partido_2018 ORDER BY SUM(cvp2018.votos) DESC limit 1 ) partido_ganador_id,
						...
						(SELECT SUM(cvp2018.votos)  FROM casillas_votos_partidos_2018 cvp2018 WHERE cvp2018.tipo = 1 AND cvp2018.id_municipio = '{$id_municipio}' AND EXISTS (SELECT p.id  FROM partidos_2018 p WHERE p.principal = '1' AND p.id = cvp2018.id_partido_2018 AND p.tipo = 1 ) AND cvp2018.id_seccion_ine=si.id) partido_sistema_votos,
						(SELECT SUM(IFNULL(cv2018.votos_nulos,0)) FROM casillas_votos_2018 cv2018 WHERE cv2018.tipo = 1 AND cv2018.id_seccion_ine = si.id AND cv2018.id_municipio = '{$id_municipio}') votos_nulos,
						(SELECT SUM(IFNULL(cv2018.votos_can_nreg,0)) FROM casillas_votos_2018 cv2018 WHERE cv2018.tipo = 1 AND cv2018.id_seccion_ine = si.id AND cv2018.id_municipio = '{$id_municipio}' ) votos_can_nreg,
						(SELECT SUM(IFNULL(cv2018.lista_nominal,0)) FROM casillas_votos_2018 cv2018 WHERE cv2018.tipo = 1 AND cv2018.id_seccion_ine = si.id AND cv2018.id_municipio = '{$id_municipio}' ) lista_nominal,
						(SELECT SUM(IFNULL(cvp2018.votos,0)) FROM casillas_votos_partidos_2018 cvp2018 WHERE cvp2018.tipo = 1 AND cvp2018.id_seccion_ine = si.id AND cvp2018.id_municipio = '{$id_municipio}' ) votos_validos,
						(SELECT COUNT(cv2018.id) FROM casillas_votos_2018 cv2018 WHERE cv2018.tipo = 1 AND cv2018.id_seccion_ine = si.id AND cv2018.id_municipio = '{$id_municipio}' ) casillas ,si.tipo
		...
		*/
		...
		$sql="
			...
			LEFT JOIN partidos_2018 p2018Sistema
			ON p2018Sistema.principal = 1
			/*WHERE dl.id = '{$id_municipio}' AND p2018Sistema.tipo = 1 */
			WHERE  p2018Sistema.tipo = 1 
		";
		if($id_municipio !=''){
			$sql .= " AND dl.id = {$id_municipio} ";
			...
			SELECT
				...
				FROM(
					SELECT 
						...
						(SELECT SUM(cvp2018.votos)  FROM casillas_votos_partidos_2018 cvp2018 WHERE cvp2018.tipo = 1 AND   cvp2018.id_municipio = '{$id_municipio}' AND EXISTS (SELECT p.id  FROM partidos_2018 p WHERE p.tipo = 1 AND p.principal = '1' AND p.id = cvp2018.id_partido_2018  ) AND cvp2018.id_seccion_ine=si.id) partido_sistema_votos,
						(SELECT SUM(IFNULL(cv2018.votos_nulos,0)) FROM casillas_votos_2018 cv2018 WHERE cv2018.tipo = 1 AND cv2018.id_seccion_ine = si.id AND cv2018.id_municipio = '{$id_municipio}') votos_nulos,
						(SELECT SUM(IFNULL(cv2018.votos_can_nreg,0)) FROM casillas_votos_2018 cv2018 WHERE cv2018.tipo = 1 AND cv2018.id_seccion_ine = si.id AND cv2018.id_municipio = '{$id_municipio}' ) votos_can_nreg,
						(SELECT SUM(IFNULL(cv2018.lista_nominal,0)) FROM casillas_votos_2018 cv2018 WHERE cv2018.tipo = 1 AND cv2018.id_seccion_ine = si.id AND cv2018.id_municipio = '{$id_municipio}' ) lista_nominal,
						(SELECT SUM(IFNULL(cvp2018.votos,0)) FROM casillas_votos_partidos_2018 cvp2018 WHERE cvp2018.tipo = 1 AND cvp2018.id_seccion_ine = si.id AND cvp2018.id_municipio = '{$id_municipio}' ) votos_validos,
