<?php
	...
	$_SESSION['Paguinasub']="seccionesIneReportes2018MatrizRentabilidad/distrito_federal/index.php";
...
?>
	...
	<div id="bodymanager" class="bodymanager">
		...
		if($tipo_uso_plataforma=='all'){
			echo '<div class="submenux" onclick="subConfiguracionDistritosFederalesReportes2018()">Distritos Federales Reporte '.$ano.'</div> / ';
			echo '<div class="submenux" onclick="subConfiguracionDistritosFederalesSeccionesIneReportes2018()">Secciones INE Reportes '.$ano.'</div> / ';
		}else{
			echo '<div class="submenux" onclick="subConfiguracionDistritosFederalesSeccionesIneReportes2018()">Secciones INE Reportes '.$ano.'</div> / ';
		}
		?>
