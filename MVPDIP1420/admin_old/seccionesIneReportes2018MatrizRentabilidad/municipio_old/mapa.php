<?php
	...
	if(!empty($_POST)){
		...
		$id_partido_legado = $configuracion_matriz_rentabilidad_secciones_ine_2018Datos['id_partido_legado'] = '1';// Partidos Legados
	...
	$columnas_titulos = array(
		...
		1 => array('row' => 'seccion_localidades' ,'nombre' => 'Localidad(es)' ,'tipo' => 'string', 'fill' =>'#397CB5' ),
		2 => array('row' => 'numero' ,'nombre' => 'Sección' ,'tipo' => 'integer', 'fill' =>'#397CB5'),
		3 => array('row' => 'tipo' ,'nombre' => 'Tipo Sección' ,'tipo' => 'string', 'fill' =>'#397CB5'),

		4 => array('row' => 'primera_fuerza' ,'nombre' => 'Primera Fuerza' ,'tipo' => 'string', 'fill' =>'#213415'),
		5 => array('row' => 'votos_primera_fuerza' ,'nombre' => 'Votos Primera Fuerza' ,'tipo' => 'integer', 'fill' =>'#213415'),

		6 => array('row' => 'segunda_fuerza' ,'nombre' => 'Segunda Fuerza' ,'tipo' => 'string', 'fill' =>'#355b7d'),
		7 => array('row' => 'votos_segunda_fuerza' ,'nombre' => 'Votos Segunda Fuerza' ,'tipo' => 'integer', 'fill' =>'#355b7d'),

		8 => array('row' => 'sistema' ,'nombre' => 'Sistema' ,'tipo' => 'string', 'fill' =>'#8B8000'),
		9 => array('row' => 'votos_sistema' ,'nombre' => 'Votos Sistema' ,'tipo' => 'integer', 'fill' =>'#8B8000'),
		//? partidps
		10 => array('row' => 'partidos' ,'tipo' => 'integer'),
		///
		11 => array('row' => 'votos_can_nreg' ,'nombre' => 'Votos Can Nrg' ,'tipo' => 'integer', 'fill' =>'#397CB5' ),
		12 => array('row' => 'votos_nulos' ,'nombre' => 'Votos Nulos' ,'tipo' => 'integer', 'fill' =>'#397CB5' ),
		13 => array('row' => 'votos_totales' ,'nombre' => 'Votos Totales' ,'tipo' => 'integer', 'fill' =>'#397CB5' ),
		14 => array('row' => 'lista_nominal' ,'nombre' => 'Lista Nominal' ,'tipo' => 'integer', 'fill' =>'#397CB5' ),
		15 => array('row' => 'rentabilidad' ,'nombre' => 'Rentabilidad Votos Validos - '.$searh_partido ,'tipo' => 'integer', 'fill' =>'#397CB5' ),
		16 => array('row' => 'rentabilidad_posicion' ,'nombre' => 'Rentabilidad' ,'tipo' => 'integer', 'fill' =>'#397CB5' ),
		17 => array('row' => 'competividad' ,'nombre' => 'Competividad Primera Fuerza - Segunda Fuerza' ,'tipo' => 'integer', 'fill' =>'#397CB5' ),
		18 => array('row' => 'competividad_posicion' ,'nombre' => 'Competividad' ,'tipo' => 'integer', 'fill' =>'#397CB5' ),
		19 => array('row' => 'semaforo' ,'nombre' => 'Semáforo' ,'tipo' => 'string', 'fill' =>'#397CB5' ),
		20 => array('row' => 'ciudadanos_registrados' ,'nombre' => 'Ciudadanos Registrados' ,'tipo' => 'integer', 'fill' =>'#397CB5' ),
		21 => array('row' => 'acciones_obras' ,'nombre' => 'Programas de Inversión' ,'tipo' => 'integer', 'fill' =>'#397CB5' ),
		22 => array('row' => 'apoyos_programas' ,'nombre' => 'Programas de Gobierno' ,'tipo' => 'integer', 'fill' =>'#397CB5' ),
		23 => array('row' => 'funcionarios' ,'nombre' => 'Funcionarios' ,'tipo' => 'integer', 'fill' =>'#397CB5' ),
		24 => array('row' => 'militantes' ,'nombre' => 'Militantes' ,'tipo' => 'integer', 'fill' =>'#397CB5' ),
		25 => array('row' => 'juntas' ,'nombre' => 'Juntas' ,'tipo' => 'integer', 'fill' =>'#397CB5' ),
		26 => array('row' => 'visitas' ,'nombre' => 'Visitas' ,'tipo' => 'integer', 'fill' =>'#397CB5' ),
		27 => array('row' => 'caminatas' ,'nombre' => 'Caminatas' ,'tipo' => 'integer', 'fill' =>'#397CB5' ),
	);
	...
	foreach ($datos_secciones_ine as $id_seccion_ine => $datos) {
		...
		if($colum['municipio']!=''){
			...
			$_SESSION['reporte_Sistema']['pdf']['secciones'][$id_seccion_ine] = $datos;
			//echo "</pre>";
		}
	}
	//unset($_SESSION['reporte_Sistema']['pdf']['secciones']);
	//$_SESSION['reporte_Sistema']['pdf']['secciones'] = $datos_secciones_ine;
	//echo "<textarea>";
