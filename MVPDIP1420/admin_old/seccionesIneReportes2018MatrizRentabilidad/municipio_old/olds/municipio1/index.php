<?php
	...
	$_SESSION['Paguinasub']="seccionesIneReportes2018MatrizRentabilidad/municipio/index.php";
...
?>
	...
	<div id="bodymanager" class="bodymanager">
		...
		if($tipo_uso_plataforma=='municipio'){
			echo '<div class="submenux" onclick="subConfiguracionMunicipiosSeccionesIneReportes2018()">Secciones INE Reportes 2018</div> / ';
		}else{
			echo '<div class="submenux" onclick="subConfiguracionMunicipiosReportes2018()">Municipios Reporte 2018</div> /';
		}
		?>
		...
		<label class="tituloForm">
			Matriz de rentabilidad electoral 2018
		</label><br>
		<label class="tituloForm">
