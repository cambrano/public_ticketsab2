<?php
	...
	$sql = "SELECT 
				...
				(SELECT SUM(votos_nulos) FROM casillas_votos_2021 WHERE id_distrito_federal={$id_distrito_federal} AND tipo = 1 ) votos_nulos_2021,
				(SELECT SUM(votos_can_nreg) FROM casillas_votos_2021 WHERE id_distrito_federal={$id_distrito_federal} AND tipo = 1 ) votos_can_nreg_2021,
				(SELECT COUNT(id) FROM secciones_ine WHERE id_distrito_federal={$id_distrito_federal} ) secciones,
				(SELECT COUNT(id) FROM casillas_votos_2021 WHERE id_distrito_federal={$id_distrito_federal} AND tipo = 1 ) casillas_2021,
				(SELECT SUM(lista_nominal) FROM casillas_votos_2021 WHERE id_distrito_federal={$id_distrito_federal} AND tipo = 1 ) total_lista_nominal_2021,

				( SELECT id_partido_2021 votos FROM casillas_votos_partidos_2021 WHERE id_distrito_federal={$id_distrito_federal} AND tipo = 1 GROUP BY id_partido_2021 ORDER by SUM(votos) DESC LIMIT 1) id_partido_ganador_2021,
			...
			FROM
				(SELECT SUM(votos) votos_validos_2021 FROM  casillas_votos_partidos_2021 WHERE id_distrito_federal={$id_distrito_federal} AND tipo =  1 )t
	...
	$sql = "SELECT
			*,
			(SELECT SUM(cpv2021.votos) FROM casillas_votos_partidos_2021 cpv2021 WHERE cpv2021.id_partido_2021 = p2021.id AND cpv2021.id_distrito_federal={$id_distrito_federal} AND cpv2021.tipo = 1 ) votos_totales_2021
	...
	$sql="
		...
		WHERE cvp2021.id_distrito_federal={$id_distrito_federal} AND cvp2021.tipo = 1
