<?php
	...
	$datos_partidos = $_SESSION['reporte_Sistema']['pdf']['partidos'];
	...
	$totales = array(
		"[__Lista_Nominal__]" => number_format($datos_generales['lista_nominal'], 0, '.', ','),
					...
					<tbody>
						...
						<tr>
							...
							<td
								style='text-align: right; width: 25%;padding: 0px 5px 0px 5px;background-color: rgba(176,176,176,0.3); border-bottom: 1px solid white'>
								<font class='fontDataReporte' style='font-size: 12px'>
									".number_format($datos_partidos['orden_votos_individual']['competitividad_votos_fuerzas'], 0, '.', ',')."
								</font>
							</td>
						</tr>
					</tbody>
	...
	$num=0;
	$contador=0;
	foreach ($_SESSION['reporte_Sistema']['pdf']['secciones'] as $key => $value) {
	...
	$paginas_reportes_secciones = '<img src="'.$datos_generales['territorio_nombre'].'.png" style="width:100%"><center><p style="text-align:center;background-color:#E4E4E4">Mapa de los resultados en las secciones del territorio, con logo del partido con mayoria.<p></center>';
	$num = 0;
