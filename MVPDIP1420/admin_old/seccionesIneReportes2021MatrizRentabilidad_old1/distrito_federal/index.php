<?php
	...
	$_SESSION['Paguinasub']="seccionesIneReportes2021MatrizRentabilidad/distrito_federal/index.php";
...
?>
	...
	<div id="bodymanager" class="bodymanager">
		...
		if($tipo_uso_plataforma=='distrito_federal'){
			echo '<div class="submenux" onclick="subConfiguracionDistritosFederalesSeccionesIneReportes2021()">Secciones INE Reportes Actual</div> / ';
		}else{
			echo '<div class="submenux" onclick="subConfiguracionDistritosFederalesReportes2021()">Distritos Federales Reporte Actual</div> /';
		}
		?>
		<br>
		...
		<label class="tituloForm">
			Matriz de Rentabilidad Electoral Actual
		</label><br>
		<label class="tituloForm">
