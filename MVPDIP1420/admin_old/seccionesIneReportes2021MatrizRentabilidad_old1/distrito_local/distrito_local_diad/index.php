<?php
	...
	$_SESSION['Paguinasub']="seccionesIneReportes2021MatrizRentabilidad/distrito_local/index.php";
...
?>
	...
	<div id="bodymanager" class="bodymanager">
		...
		if($tipo_uso_plataforma=='distrito_local'){
			echo '<div class="submenux" onclick="subConfiguracionDistritosLocalesSeccionesIneReportes2021()">Secciones INE Reportes Actual</div> / ';
		}else{
			echo '<div class="submenux" onclick="subConfiguracionDistritosLocalesReportes2021()">Distritos Locales Reporte Actual</div> /';
		}
		?>
		<br>
