	...
	if(!empty($_POST)){
		...
		*/
		...
		$sql="SELECT 
			...
			WHERE cp22rm.id_distrito_local = '{$id_distrito_local}'
		...
		$sql="SELECT 
			...
			ROUND(
				(
					(
						(SELECT SUM(cv2021.votos_nulos) FROM casillas_votos_2021 cv2021 WHERE cv2021.id_seccion_ine = si.id AND cv2021.tipo = '0' )
						+ 
						(SELECT SUM(cv2021.votos_can_nreg) FROM casillas_votos_2021 cv2021 WHERE cv2021.id_seccion_ine = si.id AND cv2021.tipo = '0' )
						+ 
						(SELECT SUM(cvp2021.votos) FROM casillas_votos_partidos_2021 cvp2021 WHERE cvp2021.id_seccion_ine = si.id AND cvp2021.tipo = '0' )
					)
					/
					(
