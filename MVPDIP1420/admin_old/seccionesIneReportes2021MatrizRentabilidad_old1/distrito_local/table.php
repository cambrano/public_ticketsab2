	...
	<script type="text/javascript">
		$(document).ready(function() {
			var dataTable = $('#secciones_reportes-tabla').DataTable( {
				...
				"aoColumnDefs": [
									{ "bSortable": false, "aTargets": [ 0,1,2,5,6,8,9,10 ] },
			...
			<?php
				foreach ($datos_secciones_ine as $key => $value) {
					...
					if(!empty($value['revocacion_mandato_2022'])){
						$participacion_ciudadana = ($value['consulta_rvm_2022_votos_totales'] / $value['consulta_rvm_2022_lista_nominal']) * 100;
						$porcenjate_siga = $value['revocacion_mandato_2022']['orden_preguntas']['SIGA'] / $value['consulta_rvm_2022_votos_totales'] * 100;
						$porcenjate_no_siga = $value['revocacion_mandato_2022']['orden_preguntas']['NO_SIGA'] / $value['consulta_rvm_2022_votos_totales'] * 100;
									...
									<table style='width: 100%;border:1px solid;text-align: left;font-size: 10px' >
										...
										<tr>
											<td style='border:1px solid;padding: 2px;background-color: #f8f9fb;text-align: center'>
												<img style='width:25px; height:25px' class='bntImageSize' src='images/logos_partidos/".$value['revocacion_mandato_2022']['preguntas']['SIGA']['logo']."'>
											</td>
											<td style='border:1px solid;padding: 2px;background-color: #f8f9fb;text-align: center'>
												<img style='width:25px; height:25px' class='bntImageSize' src='images/logos_partidos/".$value['revocacion_mandato_2022']['preguntas']['NO_SIGA']['logo']."'>
											</td>
										</tr>
										<tr>
											<td style='border:1px solid;padding: 2px;background-color: #f8f9fb;text-align: center'>
												Votos: <b>".number_format($value['revocacion_mandato_2022']['preguntas']['SIGA']['votos'], 0, '.', ',')."</b><br>
											</td>
											<td style='border:1px solid;padding: 2px;background-color: #f8f9fb;text-align: center'>
												Votos: <b>".number_format($value['revocacion_mandato_2022']['preguntas']['NO_SIGA']['votos'], 0, '.', ',')."</b><br>
											</td>
										</tr>
									</table>

									Votos Nulos: <b>".number_format($value['consulta_rvm_2022_votos_nulos'], 0, '.', ',')."</b>
									Votos Totales: <b>".number_format($value['consulta_rvm_2022_votos_totales'], 0, '.', ',')."</b>
					...
					<tr>
						...
						<td style="text-align: center;">
							<div style="background-color : <?= $color ?>; height: 70px; width: 100%; text-align: center;font-size:10px;padding:5px">
								<br>
								<b style="color:black;font-size:15px">
									<?= $value['orden_votos_individual']['semaforo']['diferencia'] ?>
								</b>
