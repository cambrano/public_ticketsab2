...
?>
	...
	<div id="bodymanager" class="bodymanager">
		...
		if($tipo_uso_plataforma=='municipio'){
			echo '<div class="submenux" onclick="subConfiguracionMunicipiosSeccionesIneReportes2021()">Secciones INE Reportes Actual</div> / ';
		}else{
			echo '<div class="submenux" onclick="subConfiguracionMunicipiosReportes2021()">Municipios Reporte Actual</div> /';
		}
		?>
		<br>
