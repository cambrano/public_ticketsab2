	...
	if(!empty($_POST)){
		...
		*/
		...
		$sql="SELECT 
			...
			WHERE cvp2021.tipo = '{$tipo_eleccion}'  AND cvp2021.id_municipio = '{$id_municipio}' {$sql_secciones_ine}
		...
		while($row=$result->fetch_assoc()){
			...
			$partido_secundario_id_partido_2021 = '';
			...
			$partido_ganador_id_partido_2021 = 'No Data';
			...
			if(empty($partidos_sin_coaliciones[$id_seccion_ine])){
				...
				*/ 
				...
				if($datos_secciones_ine[$id_seccion_ine]['ganador']['clave'] == 'No Data'){
					$datos_secciones_ine[$id_seccion_ine]['ganador'] = array(
																				'clave' => 'NOTIENE',
																				'nombre_corto' => 'NOTIENE',
																				'individual' => 0,
		...
		*/
		...
		$sql="SELECT 
			...
			FROM casillas_votos_partidos_2021 cvp2021 
			LEFT JOIN partidos_2021 p2021 ON cvp2021.id_partido_2021 = p2021.id
			WHERE cvp2021.tipo = '{$tipo_eleccion}'  AND cvp2021.id_municipio = '{$id_municipio}'
			GROUP BY cvp2021.id_seccion_ine,id_partido_2021 
			ORDER BY cvp2021.id_seccion_ine,SUM(cvp2021.votos) DESC
			";
		$result = $conexion->query($sql);
		...
		while($row=$result->fetch_assoc()){
			$partido_secundario_votos = '0';
			$partido_secundario_nombre_corto = 'No Data';
			$partido_secundario_clave = 'No Data';
			$partido_secundario_id_partido_2021 = '0';
			$partido_secundario_logo = 'no_data.png';

			$partido_secundario_color_background = '0';
			$partido_secundario_color_border = '0';

			$partido_secundario_coaliciones = '0';
			$partido_secundario_individual = '0';
			$partido_secundario_votos_coalicion = '0';
			...
			$partido_ganador_nombre_corto = 'No Data';
			$partido_ganador_clave = 'No Data';
			$partido_ganador_id_partido_2021 = '';
			$partido_ganador_logo = 'no_data.png';

			$partido_ganador_color_background = '';
			$partido_ganador_color_border = '';

			$partido_ganador_coaliciones = '0';
			$partido_ganador_individual = '0';
			$partido_ganador_votos_coalicion = '0';
			$partido_ganador_nombres_cortos_array = '0';
			//////
			$datos_secciones_ine[$row['id_seccion_ine']]=$row;
			$id_seccion_ine = $row['id_seccion_ine'];
			//////
