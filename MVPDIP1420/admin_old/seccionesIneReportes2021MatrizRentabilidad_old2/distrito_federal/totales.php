<?php
	...
	$tipo = $configuracion_matriz['tipo_eleccion'] = '1';// 0 - Ayuntamiento | 1 - Distrito Federal | 2 - Distrito Federal
...
<div class="totales">
	<div
		...
		<div style="background-color: white;padding: 5px;display: table;">
			<!--- fuerzas ----->
			<?php
		if(!empty($datos_partidos['orden_votos_totales']['sistema'])){
			$value = $datos_partidos['orden_votos_totales']['sistema'];
		?>
