		...
		*/
		...
		$sql="
			SELECT
				...
				(SELECT COUNT(sic.id) FROM secciones_ine_ciudadanos sic WHERE sic.id_distrito_local={$id_distrito_local} AND sic.id_seccion_ine = si.id ) ciudadanos_registrados,
