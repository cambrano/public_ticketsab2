	...
	if(!empty($_POST)){
		...
		*/
		...
		$sql="
			 SELECT
				...
				dl.latitud,
				dl.longitud,
				(SELECT SUM(cvp2021.votos)  FROM casillas_votos_partidos_2021 cvp2021 WHERE cvp2021.tipo = 2 AND cvp2021.id_distrito_federal = dl.id GROUP BY cvp2021.id_partido_2021 ORDER BY SUM(cvp2021.votos) DESC LIMIT 1) partido_ganador_votos,

				(SELECT cvp2021.id_partido_2021  FROM casillas_votos_partidos_2021 cvp2021 WHERE cvp2021.tipo = 2 AND cvp2021.id_distrito_federal = dl.id GROUP BY cvp2021.id_partido_2021 ORDER BY SUM(cvp2021.votos) DESC LIMIT 1) partido_ganador_id,

				(SELECT p2021Ganador.color_background  FROM casillas_votos_partidos_2021 cvp2021 LEFT JOIN partidos_2021 p2021Ganador ON p2021Ganador.id= cvp2021.id_partido_2021  WHERE cvp2021.tipo = 2 AND p2021Ganador.tipo = 2 AND cvp2021.id_distrito_federal = dl.id GROUP BY cvp2021.id_partido_2021 ORDER BY SUM(cvp2021.votos) DESC LIMIT 1) partido_ganador_background,
				...
				(SELECT SUM(cvp2021.votos)  FROM casillas_votos_partidos_2021 cvp2021 WHERE cvp2021.tipo = 2 AND cvp2021.id_distrito_federal = dl.id AND cvp2021.id_partido_2021 = p2021Sistema.id ) partido_sistema_votos,

				(SELECT SUM(cv2021.votos_nulos) FROM casillas_votos_2021 cv2021 WHERE cv2021.tipo = 2 AND cv2021.id_distrito_federal = dl.id ) votos_nulos,

				(SELECT SUM(cv2021.votos_can_nreg) FROM casillas_votos_2021 cv2021 WHERE cv2021.tipo = 2 AND cv2021.id_distrito_federal = dl.id ) votos_can_nreg,

				(SELECT SUM(cv2021.lista_nominal) FROM casillas_votos_2021 cv2021 WHERE cv2021.tipo = 2 AND cv2021.id_distrito_federal = dl.id ) lista_nominal,

				(SELECT SUM(cvp2021.votos) FROM casillas_votos_partidos_2021 cvp2021 WHERE cvp2021.tipo = 2 AND cvp2021.id_distrito_federal = dl.id ) votos_validos

			FROM distritos_federales dl
			LEFT JOIN partidos_2021 p2021Sistema
			ON p2021Sistema.principal = 1
			WHERE p2021Sistema.tipo = 2
		";
			...
			SELECT
				...
				FROM(
					SELECT 
						...
						(SELECT p2021.nombre_corto  FROM partidos_2021 p2021 WHERE p2021.principal = '1' AND p2021.tipo = 2 LIMIT 1) partido_sistema_corto,
						...
						(SELECT SUM(IFNULL(cv2021.votos_nulos,0)) FROM casillas_votos_2021 cv2021 WHERE cv2021.tipo = 2 AND cv2021.id_seccion_ine = si.id AND cv2021.id_distrito_federal = '{$id_distrito_federal}') votos_nulos,
						(SELECT SUM(IFNULL(cv2021.votos_can_nreg,0)) FROM casillas_votos_2021 cv2021 WHERE cv2021.tipo = 2 AND cv2021.id_seccion_ine = si.id AND cv2021.id_distrito_federal = '{$id_distrito_federal}' ) votos_can_nreg,
						(SELECT SUM(IFNULL(cv2021.lista_nominal,0)) FROM casillas_votos_2021 cv2021 WHERE cv2021.tipo = 2 AND cv2021.id_seccion_ine = si.id AND cv2021.id_distrito_federal = '{$id_distrito_federal}' ) lista_nominal,
						(SELECT SUM(IFNULL(cvp2021.votos,0)) FROM casillas_votos_partidos_2021 cvp2021 WHERE cvp2021.tipo = 2 AND cvp2021.id_seccion_ine = si.id AND cvp2021.id_distrito_federal = '{$id_distrito_federal}' ) votos_validos,
						(SELECT COUNT(cv2021.id) FROM casillas_votos_2021 cv2021 WHERE cv2021.tipo = 2 AND cv2021.id_seccion_ine = si.id AND cv2021.id_distrito_federal = '{$id_distrito_federal}' ) casillas ,si.tipo
		...
		*/
		...
		$sql="
			...
			LEFT JOIN partidos_2021 p2021Sistema
			ON p2021Sistema.principal = 1
			/*WHERE dl.id = '{$id_distrito_federal}' AND p2021Sistema.tipo = 2 */
			WHERE  p2021Sistema.tipo = 2 
		";
		if($id_distrito_federal !=''){
			$sql .= " AND dl.id = {$id_distrito_federal} ";
