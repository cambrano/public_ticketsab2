	...
	if(!empty($_POST)){
		...
		*/
		...
		$sql="
			 SELECT
				...
				dl.latitud,
				dl.longitud,
				(SELECT SUM(cvp2021.votos)  FROM casillas_votos_partidos_2021 cvp2021 WHERE cvp2021.tipo = 1 AND cvp2021.id_distrito_local = dl.id GROUP BY cvp2021.id_partido_2021 ORDER BY SUM(cvp2021.votos) DESC LIMIT 1) partido_ganador_votos,

				(SELECT cvp2021.id_partido_2021  FROM casillas_votos_partidos_2021 cvp2021 WHERE cvp2021.tipo = 1 AND cvp2021.id_distrito_local = dl.id GROUP BY cvp2021.id_partido_2021 ORDER BY SUM(cvp2021.votos) DESC LIMIT 1) partido_ganador_id,

				(SELECT p2021Ganador.color_background  FROM casillas_votos_partidos_2021 cvp2021 LEFT JOIN partidos_2021 p2021Ganador ON p2021Ganador.id= cvp2021.id_partido_2021  WHERE cvp2021.tipo = 1 AND p2021Ganador.tipo = 1 AND cvp2021.id_distrito_local = dl.id GROUP BY cvp2021.id_partido_2021 ORDER BY SUM(cvp2021.votos) DESC LIMIT 1) partido_ganador_background,
				...
				(SELECT SUM(cvp2021.votos)  FROM casillas_votos_partidos_2021 cvp2021 WHERE cvp2021.tipo = 1 AND cvp2021.id_distrito_local = dl.id AND cvp2021.id_partido_2021 = p2021Sistema.id ) partido_sistema_votos,

				(SELECT SUM(cv2021.votos_nulos) FROM casillas_votos_2021 cv2021 WHERE cv2021.tipo = 1 AND cv2021.id_distrito_local = dl.id ) votos_nulos,

				(SELECT SUM(cv2021.votos_can_nreg) FROM casillas_votos_2021 cv2021 WHERE cv2021.tipo = 1 AND cv2021.id_distrito_local = dl.id ) votos_can_nreg,

				(SELECT SUM(cv2021.lista_nominal) FROM casillas_votos_2021 cv2021 WHERE cv2021.tipo = 1 AND cv2021.id_distrito_local = dl.id ) lista_nominal,

				(SELECT SUM(cvp2021.votos) FROM casillas_votos_partidos_2021 cvp2021 WHERE cvp2021.tipo = 1 AND cvp2021.id_distrito_local = dl.id ) votos_validos
			...
			SELECT
				...
				FROM(
					SELECT 
						...
						si.latitud,
						si.longitud,
						(SELECT SUM(cvp2021.votos) FROM casillas_votos_partidos_2021 cvp2021 WHERE cvp2021.tipo = 1 AND cvp2021.id_seccion_ine = si.id AND cvp2021.id_distrito_local = '{$id_distrito_local}' GROUP BY cvp2021.id_partido_2021 ORDER BY SUM(cvp2021.votos) DESC limit 1 ) partido_ganador_votos,

						(SELECT cvp2021.id_partido_2021 FROM casillas_votos_partidos_2021 cvp2021 WHERE cvp2021.tipo = 1 AND cvp2021.id_seccion_ine = si.id AND cvp2021.id_distrito_local = '{$id_distrito_local}' GROUP BY cvp2021.id_partido_2021 ORDER BY SUM(cvp2021.votos) DESC limit 1 ) partido_ganador_id,
						...
						(SELECT SUM(cvp2021.votos)  FROM casillas_votos_partidos_2021 cvp2021 WHERE cvp2021.tipo = 1 AND cvp2021.id_distrito_local = '{$id_distrito_local}' AND EXISTS (SELECT p.id  FROM partidos_2021 p WHERE p.principal = '1' AND p.id = cvp2021.id_partido_2021 AND p.tipo = 1 ) AND cvp2021.id_seccion_ine=si.id) partido_sistema_votos,
						(SELECT SUM(IFNULL(cv2021.votos_nulos,0)) FROM casillas_votos_2021 cv2021 WHERE cv2021.tipo = 1 AND cv2021.id_seccion_ine = si.id AND cv2021.id_distrito_local = '{$id_distrito_local}') votos_nulos,
						(SELECT SUM(IFNULL(cv2021.votos_can_nreg,0)) FROM casillas_votos_2021 cv2021 WHERE cv2021.tipo = 1 AND cv2021.id_seccion_ine = si.id AND cv2021.id_distrito_local = '{$id_distrito_local}' ) votos_can_nreg,
						(SELECT SUM(IFNULL(cv2021.lista_nominal,0)) FROM casillas_votos_2021 cv2021 WHERE cv2021.tipo = 1 AND cv2021.id_seccion_ine = si.id AND cv2021.id_distrito_local = '{$id_distrito_local}' ) lista_nominal,
						(SELECT SUM(IFNULL(cvp2021.votos,0)) FROM casillas_votos_partidos_2021 cvp2021 WHERE cvp2021.tipo = 1 AND cvp2021.id_seccion_ine = si.id AND cvp2021.id_distrito_local = '{$id_distrito_local}' ) votos_validos,
						(SELECT COUNT(cv2021.id) FROM casillas_votos_2021 cv2021 WHERE cv2021.tipo = 1 AND cv2021.id_seccion_ine = si.id AND cv2021.id_distrito_local = '{$id_distrito_local}' ) casillas ,si.tipo
		...
		*/
		...
		$sql="
			...
			LEFT JOIN partidos_2021 p2021Sistema
			ON p2021Sistema.principal = 1
			/*WHERE dl.id = '{$id_distrito_local}' AND p2021Sistema.tipo = 1 */
			WHERE  p2021Sistema.tipo = 1 
		";
		if($id_distrito_local !=''){
			$sql .= " AND dl.id = {$id_distrito_local} ";
			...
			SELECT
				...
				FROM(
					SELECT 
						...
						(SELECT SUM(cvp2021.votos)  FROM casillas_votos_partidos_2021 cvp2021 WHERE cvp2021.tipo = 1 AND   cvp2021.id_distrito_local = '{$id_distrito_local}' AND EXISTS (SELECT p.id  FROM partidos_2021 p WHERE p.tipo = 1 AND p.principal = '1' AND p.id = cvp2021.id_partido_2021  ) AND cvp2021.id_seccion_ine=si.id) partido_sistema_votos,
						(SELECT SUM(IFNULL(cv2021.votos_nulos,0)) FROM casillas_votos_2021 cv2021 WHERE cv2021.tipo = 1 AND cv2021.id_seccion_ine = si.id AND cv2021.id_distrito_local = '{$id_distrito_local}') votos_nulos,
						(SELECT SUM(IFNULL(cv2021.votos_can_nreg,0)) FROM casillas_votos_2021 cv2021 WHERE cv2021.tipo = 1 AND cv2021.id_seccion_ine = si.id AND cv2021.id_distrito_local = '{$id_distrito_local}' ) votos_can_nreg,
						(SELECT SUM(IFNULL(cv2021.lista_nominal,0)) FROM casillas_votos_2021 cv2021 WHERE cv2021.tipo = 1 AND cv2021.id_seccion_ine = si.id AND cv2021.id_distrito_local = '{$id_distrito_local}' ) lista_nominal,
						(SELECT SUM(IFNULL(cvp2021.votos,0)) FROM casillas_votos_partidos_2021 cvp2021 WHERE cvp2021.tipo = 1 AND cvp2021.id_seccion_ine = si.id AND cvp2021.id_distrito_local = '{$id_distrito_local}' ) votos_validos,
