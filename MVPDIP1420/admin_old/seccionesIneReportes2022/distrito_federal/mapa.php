	...
	if(!empty($_POST)){
		...
		*/
		...
		$sql="
			 SELECT
				...
				dl.latitud,
				dl.longitud,
				(SELECT SUM(cvp2022.votos)  FROM casillas_votos_partidos_2022 cvp2022 WHERE cvp2022.tipo = 2 AND cvp2022.id_distrito_federal = dl.id GROUP BY cvp2022.id_partido_2022 ORDER BY SUM(cvp2022.votos) DESC LIMIT 1) partido_ganador_votos,

				(SELECT cvp2022.id_partido_2022  FROM casillas_votos_partidos_2022 cvp2022 WHERE cvp2022.tipo = 2 AND cvp2022.id_distrito_federal = dl.id GROUP BY cvp2022.id_partido_2022 ORDER BY SUM(cvp2022.votos) DESC LIMIT 1) partido_ganador_id,

				(SELECT p2022Ganador.color_background  FROM casillas_votos_partidos_2022 cvp2022 LEFT JOIN partidos_2022 p2022Ganador ON p2022Ganador.id= cvp2022.id_partido_2022  WHERE cvp2022.tipo = 2 AND p2022Ganador.tipo = 2 AND cvp2022.id_distrito_federal = dl.id GROUP BY cvp2022.id_partido_2022 ORDER BY SUM(cvp2022.votos) DESC LIMIT 1) partido_ganador_background,
				...
				(SELECT SUM(cvp2022.votos)  FROM casillas_votos_partidos_2022 cvp2022 WHERE cvp2022.tipo = 2 AND cvp2022.id_distrito_federal = dl.id AND cvp2022.id_partido_2022 = p2022Sistema.id ) partido_sistema_votos,

				(SELECT SUM(cv2022.votos_nulos) FROM casillas_votos_2022 cv2022 WHERE cv2022.tipo = 2 AND cv2022.id_distrito_federal = dl.id ) votos_nulos,

				(SELECT SUM(cv2022.votos_can_nreg) FROM casillas_votos_2022 cv2022 WHERE cv2022.tipo = 2 AND cv2022.id_distrito_federal = dl.id ) votos_can_nreg,

				(SELECT SUM(cv2022.lista_nominal) FROM casillas_votos_2022 cv2022 WHERE cv2022.tipo = 2 AND cv2022.id_distrito_federal = dl.id ) lista_nominal,

				(SELECT SUM(cvp2022.votos) FROM casillas_votos_partidos_2022 cvp2022 WHERE cvp2022.tipo = 2 AND cvp2022.id_distrito_federal = dl.id ) votos_validos

			FROM distritos_federales dl
			LEFT JOIN partidos_2022 p2022Sistema
			ON p2022Sistema.principal = 1
			WHERE p2022Sistema.tipo = 2
		";
			...
			SELECT
				...
				FROM(
					SELECT 
						...
						si.latitud,
						si.longitud,
						(SELECT SUM(cvp2022.votos) FROM casillas_votos_partidos_2022 cvp2022 WHERE cvp2022.tipo = 2 AND cvp2022.id_seccion_ine = si.id AND cvp2022.id_distrito_federal = '{$id_distrito_federal}' GROUP BY cvp2022.id_partido_2022 ORDER BY SUM(cvp2022.votos) DESC limit 1 ) partido_ganador_votos,

						(SELECT cvp2022.id_partido_2022 FROM casillas_votos_partidos_2022 cvp2022 WHERE cvp2022.tipo = 2 AND cvp2022.id_seccion_ine = si.id AND cvp2022.id_distrito_federal = '{$id_distrito_federal}' GROUP BY cvp2022.id_partido_2022 ORDER BY SUM(cvp2022.votos) DESC limit 1 ) partido_ganador_id,

						(SELECT p2022.id  FROM partidos_2022 p2022 WHERE p2022.principal = '1' AND p2022.tipo = 2 LIMIT 1) partido_sistema_id,
						(SELECT p2022.nombre_corto  FROM partidos_2022 p2022 WHERE p2022.principal = '1' AND p2022.tipo = 2 LIMIT 1) partido_sistema_corto,
						(SELECT p2022.color_border  FROM partidos_2022 p2022 WHERE p2022.principal = '1' AND p2022.tipo = 2 LIMIT 1) partido_sistema_border,
						(SELECT p2022.color_background  FROM partidos_2022 p2022 WHERE p2022.principal = '1' AND p2022.tipo = 2 LIMIT 1) partido_sistema_background,
						(SELECT p2022.logo  FROM partidos_2022 p2022 WHERE p2022.principal = '1' AND p2022.tipo = 2 LIMIT 1) partido_sistema_logo,
						(SELECT SUM(cvp2022.votos)  FROM casillas_votos_partidos_2022 cvp2022 WHERE cvp2022.tipo = 2 AND cvp2022.id_distrito_federal = '{$id_distrito_federal}' AND EXISTS (SELECT p.id  FROM partidos_2022 p WHERE p.principal = '1' AND p.id = cvp2022.id_partido_2022 AND p.tipo = 2 ) AND cvp2022.id_seccion_ine=si.id) partido_sistema_votos,
						(SELECT SUM(IFNULL(cv2022.votos_nulos,0)) FROM casillas_votos_2022 cv2022 WHERE cv2022.tipo = 2 AND cv2022.id_seccion_ine = si.id AND cv2022.id_distrito_federal = '{$id_distrito_federal}') votos_nulos,
						(SELECT SUM(IFNULL(cv2022.votos_can_nreg,0)) FROM casillas_votos_2022 cv2022 WHERE cv2022.tipo = 2 AND cv2022.id_seccion_ine = si.id AND cv2022.id_distrito_federal = '{$id_distrito_federal}' ) votos_can_nreg,
						(SELECT SUM(IFNULL(cv2022.lista_nominal,0)) FROM casillas_votos_2022 cv2022 WHERE cv2022.tipo = 2 AND cv2022.id_seccion_ine = si.id AND cv2022.id_distrito_federal = '{$id_distrito_federal}' ) lista_nominal,
						(SELECT SUM(IFNULL(cvp2022.votos,0)) FROM casillas_votos_partidos_2022 cvp2022 WHERE cvp2022.tipo = 2 AND cvp2022.id_seccion_ine = si.id AND cvp2022.id_distrito_federal = '{$id_distrito_federal}' ) votos_validos,
						(SELECT COUNT(cv2022.id) FROM casillas_votos_2022 cv2022 WHERE cv2022.tipo = 2 AND cv2022.id_seccion_ine = si.id AND cv2022.id_distrito_federal = '{$id_distrito_federal}' ) casillas ,si.tipo
					FROM secciones_ine si
					WHERE si.id_distrito_federal = '{$id_distrito_federal}'
				) as sit
			LEFT JOIN partidos_2022 p
			ON sit.partido_ganador_id = p.id AND p.tipo = 2
			WHERE 1 = 1 
		";
		...
		*/
		...
		$sql="
			...
			LEFT JOIN partidos_2022 p2022Sistema
			ON p2022Sistema.principal = 1
			/*WHERE dl.id = '{$id_distrito_federal}' AND p2022Sistema.tipo = 2 */
			WHERE  p2022Sistema.tipo = 2 
		";
		if($id_distrito_federal !=''){
			$sql .= " AND dl.id = {$id_distrito_federal} ";
