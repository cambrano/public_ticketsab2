...
?> 
	<script type="text/javascript">
		...
		function verMasSeccion(valor){
			link="casillasVotosReportes2022/distrito_federal/index.php?id="+valor; 
			var link2="casillasVotosReportes2022/distrito_federal/index.php";
		...
		function verMasDistritoFederal(valor){
			link="seccionesIneReportes2022/distrito_federal/index.php?id="+valor; 
			var link2="seccionesIneReportes2022/distrito_federal/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
		...
		function verMasDistritoFederalMatrizRentabilidad2022(valor){
			link="seccionesIneReportes2022MatrizRentabilidad/distrito_federal/index.php?id=<?= $id_distrito_federal ?>"; 
			var link2="seccionesIneReportes2022MatrizRentabilidad/distrito_federal/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
