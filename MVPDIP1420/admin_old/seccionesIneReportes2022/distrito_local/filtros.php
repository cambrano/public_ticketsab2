...
?>
	<script type="text/javascript">
		...
		function searchTable(value){
			...
			*/
			$.ajax({
				type: "POST",
				url: "seccionesIneReportes2022/distrito_local/mapa.php",
				data: {searchTable: searchTable,mapa:mapa},
				async: true,
				success: function(data) {
					$("#mapaLoad").html(data);
	...
	<div style="width: 100%;">
		<button class="btn btn-info"  onClick="verMasDistritoLocalMatrizRentabilidad2022()">
