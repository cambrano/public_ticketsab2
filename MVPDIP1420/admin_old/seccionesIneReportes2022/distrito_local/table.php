...
?> 
	<script type="text/javascript">
		...
		function verMasSeccion(valor){
			link="casillasVotosReportes2022/distrito_local/index.php?id="+valor; 
			var link2="casillasVotosReportes2022/distrito_local/index.php";
		...
		function verMasDistritoLocal(valor){
			link="seccionesIneReportes2022/distrito_local/index.php?id="+valor; 
			var link2="seccionesIneReportes2022/distrito_local/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
		...
		function verMasDistritoLocalMatrizRentabilidad2022(valor){
			link="seccionesIneReportes2022MatrizRentabilidad/distrito_local/index.php?id=<?= $id_distrito_local ?>"; 
			var link2="seccionesIneReportes2022MatrizRentabilidad/distrito_local/index.php";
			dataString = 'urlink='+link2;  
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
