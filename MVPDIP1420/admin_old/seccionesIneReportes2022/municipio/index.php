<?php
	...
	$_SESSION['Paguinasub']="seccionesIneReportes2022/municipio/index.php";
	...
	if($tipo_uso_plataforma=='all'){
		...
		$moduloAccionPermisos = moduloAccionPermisos('sistema_unico_beneficiarios','cartografias_municipios_2022',$_COOKIE["id_usuario"]);
...
?>
	...
	<div id="bodymanager" class="bodymanager">
		...
		<?php
		if($tipo_uso_plataforma=='all'){
			echo '<div class="submenux" onclick="subConfiguracionMunicipiosReportes2022()">Municipios Reporte 2021</div> /';
		}
		?>
		<br>
