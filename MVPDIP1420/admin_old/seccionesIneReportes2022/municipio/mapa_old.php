<?php
	...
	if(!empty($_POST)){
		...
		*/
		...
		//var_dump($secciones_ine_parametrosDatosMapa);
		$sql="
			SELECT
				sit.id,
				sit.clave,
				...
				FROM(
					SELECT 
						...
						si.longitud,
						si.tipo,
						(SELECT SUM(cvp2022.votos) FROM casillas_votos_partidos_2022 cvp2022 WHERE cvp2022.tipo = 0 AND cvp2022.id_seccion_ine = si.id AND cvp2022.id_municipio = '{$id_municipio}' GROUP BY cvp2022.id_partido_2022 ORDER BY SUM(cvp2022.votos) DESC limit 1 ) partido_ganador_votos,

						(SELECT cvp2022.id_partido_2022 FROM casillas_votos_partidos_2022 cvp2022 WHERE cvp2022.tipo = 0 AND cvp2022.id_seccion_ine = si.id AND cvp2022.id_municipio = '{$id_municipio}' GROUP BY cvp2022.id_partido_2022 ORDER BY SUM(cvp2022.votos) DESC limit 1 ) partido_ganador_id,

						(SELECT p2022.id  FROM partidos_2022 p2022 WHERE p2022.tipo = 0 AND p2022.principal = '1' LIMIT 1) partido_sistema_id,
						(SELECT p2022.nombre_corto  FROM partidos_2022 p2022 WHERE p2022.tipo = 0 AND p2022.principal = '1' LIMIT 1) partido_sistema_corto,
						(SELECT p2022.color_border  FROM partidos_2022 p2022 WHERE p2022.tipo = 0 AND p2022.principal = '1' LIMIT 1) partido_sistema_border,
						(SELECT p2022.color_background  FROM partidos_2022 p2022 WHERE p2022.tipo = 0 AND p2022.principal = '1' LIMIT 1) partido_sistema_background,
						(SELECT p2022.logo  FROM partidos_2022 p2022 WHERE p2022.tipo = 0 AND p2022.principal = '1' LIMIT 1) partido_sistema_logo,
						
						(SELECT SUM(cvp2022.votos)  FROM casillas_votos_partidos_2022 cvp2022 WHERE cvp2022.tipo = 0 AND cvp2022.id_municipio = '{$id_municipio}' AND EXISTS (SELECT p.id  FROM partidos_2022 p WHERE p.tipo = 0 AND p.principal = '1' AND p.id = cvp2022.id_partido_2022 ) AND cvp2022.id_seccion_ine=si.id) partido_sistema_votos,

						(SELECT SUM(IFNULL(cv2022.votos_nulos,0)) FROM casillas_votos_2022 cv2022 WHERE cv2022.tipo = 0 AND cv2022.id_seccion_ine = si.id AND cv2022.id_municipio = '{$id_municipio}') votos_nulos,
						(SELECT SUM(IFNULL(cv2022.votos_can_nreg,0)) FROM casillas_votos_2022 cv2022 WHERE cv2022.tipo = 0 AND cv2022.id_seccion_ine = si.id AND cv2022.id_municipio = '{$id_municipio}' ) votos_can_nreg,
						(SELECT SUM(IFNULL(cv2022.lista_nominal,0)) FROM casillas_votos_2022 cv2022 WHERE cv2022.tipo = 0 AND cv2022.id_seccion_ine = si.id AND cv2022.id_municipio = '{$id_municipio}' ) lista_nominal,
						(SELECT SUM(IFNULL(cvp2022.votos,0)) FROM casillas_votos_partidos_2022 cvp2022 WHERE cvp2022.tipo = 0 AND cvp2022.id_seccion_ine = si.id AND cvp2022.id_municipio = '{$id_municipio}' ) votos_validos
			...
			SELECT
				...
				FROM(
					SELECT 
						...
						(SELECT p2022.color_background  FROM partidos_2022 p2022 WHERE p2022.tipo=0 AND p2022.principal = '1' LIMIT 1) partido_sistema_background,
						(SELECT p2022.logo  FROM partidos_2022 p2022 WHERE p2022.tipo=0 AND p2022.principal = '1' LIMIT 1) partido_sistema_logo,
						(SELECT SUM(cvp2022.votos)  FROM casillas_votos_partidos_2022 cvp2022 WHERE cvp2022.tipo=0 AND cvp2022.id_municipio = '{$id_municipio}' AND EXISTS (SELECT p.id  FROM partidos_2022 p WHERE p.principal = '1' AND p.id = cvp2022.id_partido_2022  ) AND cvp2022.id_seccion_ine=si.id) partido_sistema_votos,
						(SELECT SUM(IFNULL(cv2022.votos_nulos,0)) FROM casillas_votos_2022 cv2022 WHERE cv2022.tipo=0 AND cv2022.id_seccion_ine = si.id AND cv2022.id_municipio = '{$id_municipio}') votos_nulos,
						(SELECT SUM(IFNULL(cv2022.votos_can_nreg,0)) FROM casillas_votos_2022 cv2022 WHERE cv2022.tipo=0 AND cv2022.id_seccion_ine = si.id AND cv2022.id_municipio = '{$id_municipio}' ) votos_can_nreg,
						...
						(SELECT SUM(IFNULL(cvp2022.votos,0)) FROM casillas_votos_partidos_2022 cvp2022 WHERE cvp2022.tipo=0 AND cvp2022.id_seccion_ine = si.id AND cvp2022.id_municipio = '{$id_municipio}' ) votos_validos,
						(SELECT COUNT(cv2022.id) FROM casillas_votos_2022 cv2022 WHERE cv2022.tipo=0 AND cv2022.id_seccion_ine = si.id AND cv2022.id_municipio = '{$id_municipio}' ) casillas 
					FROM secciones_ine si
					WHERE si.id_municipio = '{$id_municipio}'
				) as si
			LEFT JOIN partidos_2022 p
			ON si.partido_ganador_id = p.id AND p.tipo = 0
		";
