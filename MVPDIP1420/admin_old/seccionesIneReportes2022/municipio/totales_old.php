<?php
	...
	$sql = "SELECT
			*,
			(SELECT SUM(cpv2022.votos) FROM casillas_votos_partidos_2022 cpv2022 WHERE cpv2022.id_partido_2022 = p2022.id AND cpv2022.id_municipio={$id_municipio} AND cpv2022.tipo=0 ) votos_totales_2022
			FROM partidos_2022 p2022
			WHERE p2022.principal=1 AND p2022.codigo_plataforma = '{$codigo_plataforma}' AND p2022.tipo=0 ";
	$resultado = $conexion->query($sql);
	$row=$resultado->fetch_assoc();
