<?php
	@session_start(); 
	$_SESSION['Paguinasub']="setupReportes/index.php"; 
...
?>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$("#modulo_casillas_votos_2021_incidentes_reportes").click(function(event) { 
				urlink="casillasVotos2021IncidenciasReportes/index.php";
			...
			$("#modulo_casillas_votos_2021_status_reportes").click(function(event) { 
				urlink="casillasVotos2021StatusReportes/index.php";
				dataString = 'urlink='+urlink; 
				$.ajax({
					type: "POST",
					url: "functions/backarray.php",
	...
	<div style="display: table;width: 100%;text-align: left; color:black; padding: 25px;" id="bodymanager"> 
		...
		<?php
			if(	$casillas_votos_2021 == true ){
				?>
				<div class="moduloP" >
					<div class="modulo" id="modulo_casillas_votos_2021_incidentes_reportes" >
				...
				<div class="moduloP" >
					<div class="modulo" id="modulo_casillas_votos_2021_status_reportes" >
						<div class="moduloImagen" style="width: 100%;background-color: #DCDCDC;text-align: center;padding: 12px">
