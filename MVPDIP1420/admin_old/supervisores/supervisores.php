<?php
	...
	$sql = "SELECT count(*) total FROM supervisores WHERE 1 = 1   "; 
	...
	////////////////////////////
	////////////////////////////
	$sql = "SELECT id,clave,nombre_completo FROM supervisores WHERE 1 = 1  "; 
	...
	if( $nombre_completo!="" ){   //name
		$post_search=true;
		$sql.=" AND nombre_completo LIKE '%{$nombre_completo}%' ";
		$sqlContador .= " AND nombre_completo LIKE '%{$nombre_completo}%' ";
	}
	...
	if($post_search){
		$sqlContadorScript = "SELECT count(*) total FROM supervisores WHERE 1 = 1   "; 
