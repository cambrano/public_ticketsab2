<?php
	...
	@session_start(); 
	$_SESSION['Paguinasub']="tiposCategoriasCiudadanos/create.php";
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "tiposCategoriasCiudadanos/db_add.php",
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Crear Categoría Ciudadano</font>
				</label><br>
				<label class="descripcionForm">
					<font style="font-size: 13px;">Campos para modificar categoría.</font><br><br>
				</label><br>
