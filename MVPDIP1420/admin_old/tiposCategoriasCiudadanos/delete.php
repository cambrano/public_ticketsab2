<?php
	...
	@session_start(); 
	$_SESSION['Paguinasub']="tiposCategoriasCiudadanos/delete.php";
	if(!empty($_GET)){
	...
	$tablasRelacionadas = tablasRelacionadas('tipos_categorias_ciudadanos',$id);
...
?>
	...
	<script language="javascript" type="text/javascript">
		function cerrar(){
			$("#homebody").load('tiposCategoriasCiudadanos/index.php');
		}
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "tiposCategoriasCiudadanos/db_delete.php",
				data: dataString,
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Eliminar Categoría Ciudadano</font>
				</label>
			</div>
		</div>
		<div class="bodyinput">
			<label class="labelForm" id="labeltemaname">Categoría Ciudadano</label><br>
			<label class="descripcionForm">
				<strong><?= $tipo_categoria_ciudadanoDatos['nombre']?></strong>
			</label><br>
			<?php
			if($registros_tablas!=''){
