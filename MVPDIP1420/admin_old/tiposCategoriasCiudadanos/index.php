<?php
	...
	@session_start();
	$_SESSION['Paguinasub']="tiposCategoriasCiudadanos/index.php";
	...
	?>
	<title>Categorías Ciudadanos</title>
		...
		<div style="float: right; width: 100%; text-align: left;"> 
			<?php
				if( $moduloAccionPermisos['insert'] || $moduloAccionPermisos['all']){
					?>
					<input type="button" value="Nuevo Tipo Categoría Ciudadano" onClick="add();"> 
					<?php
				}
			?>
		</div>
