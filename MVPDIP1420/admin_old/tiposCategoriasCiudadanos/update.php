<?php
	...
	@session_start(); 
	$_SESSION['Paguinasub']="tiposCategoriasCiudadanos/update.php";  
	...
	$redirectSecurity=redirectSecurity($id,'tipos_categorias_ciudadanos','tiposCategoriasCiudadanos','index');
