...
?>
	<script type="text/javascript">
		function searchTable(value){
			...
			$.ajax({
				type: "POST",
				url: "seccionesIneCiudadanosEncuestas/table.php",
	...
	<div class="sucForm">
		<label class="labelForm" id="labeltemaname">Encuestas<br></label><br>
		<select class="selectpicker" data-live-search="true" data-size="5" data-actions-box="true" title="Seleccione" id="id_encuesta" onchange="searchTable();">
			<?php
			echo encuestas();
			?>
		</select><br>
