<?php
	...
	if(!empty($_POST)){
		...
		$seccion_ine_ciudadano_check_2024Datos = seccion_ine_ciudadano_check_2024Datos('',$id_seccion_ine,'','',$id_usuario,'',$id_seccion_ine_ciudadano,$id_seccion_ine_ciudadano_relacionado);
		...
		if($seccion_ine_ciudadano_check_2024Datos['id']==""){
			...
			$_POST["seccion_ine_ciudadano_check_2024"][0]['check_out']=1;
			$_POST["seccion_ine_ciudadano_check_2024"][0]['check_out_fecha']=$fechaSF;
			$_POST["seccion_ine_ciudadano_check_2024"][0]['check_out_hora']=$fechaSH; 
			$_POST["seccion_ine_ciudadano_check_2024"][0]['check_out_fecha_hora']=$fechaH; 
			...
			// update
			//echo "NO";
			if($seccion_ine_ciudadano_check_2024Datos['check_out'] != 1){
				//editamos
