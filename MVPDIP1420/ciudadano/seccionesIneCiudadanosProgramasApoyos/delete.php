<?php
	...
	echo $redirectSecurity=redirectSecurity($id,'secciones_ine_ciudadanos_programas_apoyos','seccionesIneCiudadanosProgramasApoyos','index');
	if($redirectSecurity!=""){
		die;
	}
	$seccion_ine_ciudadano_programa_apoyoDatos=seccion_ine_ciudadano_programa_apoyoDatos($id,$id_seccion_ine_ciudadanox);
	$id = $seccion_ine_ciudadano_programa_apoyoDatos['id'];
...
?>
	...
	<script language="javascript" type="text/javascript">
		function cerrar(){
			link="seccionesIneCiudadanosProgramasApoyos/index.php?cot=<?= $id_seccion_ine_ciudadanox ?>"; 
			var link2="seccionesIneCiudadanosProgramasApoyos/index.php";
			dataString = 'urlink='+link2+'&id=<?= $id_seccion_ine_ciudadanox ?>'; 
		...
		function guardar() {
			...
			$.ajax({
				type: "POST",
				url: "seccionesIneCiudadanosProgramasApoyos/db_delete.php",
				data: dataString,
				success: function(data) { 
					if(data=="SI"){
						document.getElementById("sumbmit").disabled = true;
	...
	<div class="bodymanager" id="bodymanager"> 
		...
		<div class="bodyform">
			<div class= "bodyheader">
				<label class="tituloForm">
					<font style="font-size: 25px;">Eliminar Programa Apoyo</font>
				</label><br>
		...
		<div class="bodyinput">
			...
			<label class="descripcionForm">
				<strong><?=$seccion_ine_ciudadano_programa_apoyoDatos['fecha_hora']; ?></strong>
			</label><br><br>
			<label class="labelForm" id="labeltemaname">Nombre Programa Apoyo</label><br>
			<label class="descripcionForm">
				<strong><?=$seccion_ine_ciudadano_programa_apoyoDatos['nombre_programa_apoyo']; ?></strong>
			</label><br><br>
