	...
	<script type="text/javascript" language="javascript" >
		$(document).ready(function() {
			...
			var dataTable = $('#secciones_ine_ciudadanos_programas_apoyos-tabla').DataTable( {
				...
				"ajax":{
					url :"seccionesIneCiudadanosProgramasApoyos/secciones_ine_ciudadanos_programas_apoyos.php", // json datasource
			...
			$('#selectCheckbox').on("click", function(event){ // triggering delete one by one
				if( $('.checkselected:checked').length > 0 ){  // at-least one checkbox checked
					...
					var link="seccionesIneCiudadanosProgramasApoyos/index.php?cot="+ids_string;   
		...
		function edit(valor){
			link="seccionesIneCiudadanosProgramasApoyos/update.php?id="+valor; 
			var link2="seccionesIneCiudadanosProgramasApoyos/update.php";
		...
		function add(){
			////ajax
			link="seccionesIneCiudadanosProgramasApoyos/create.php";
			var link2="seccionesIneCiudadanosProgramasApoyos/create.php";
		...
		function borrar(valor){
			link="seccionesIneCiudadanosProgramasApoyos/delete.php?id="+valor; 
			var link2="seccionesIneCiudadanosProgramasApoyos/delete.php";
			dataString = 'urlink='+link2+'&id='+valor;
			$.ajax({
				type: "POST",
				url: "functions/backarray.php",
