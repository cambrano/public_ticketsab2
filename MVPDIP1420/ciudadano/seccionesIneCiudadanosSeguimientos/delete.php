<?php
	...
	$seccion_ine_ciudadano_seguimientoDatos=seccion_ine_ciudadano_seguimientoDatos($id);
	$id = $seccion_ine_ciudadano_seguimientoDatos['id'];

	$id_seccion_ine_ciudadanox=$seccion_ine_ciudadano_seguimientoDatos['id_seccion_ine_ciudadano']; 
			...
			$.ajax({
				...
				success: function(data) { 
					if(data=="SI"){
						...
						link="seccionesIneCiudadanosSeguimientos/index.php?cot=<?= $id_seccion_ine_ciudadano ?>"; 
						var link2="seccionesIneCiudadanosSeguimientos/index.php";
						dataString = 'urlink='+link2;  
						$.ajax({
							type: "POST",
