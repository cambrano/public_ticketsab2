	<script type="text/javascript">
		...
		function guardarStatus(){
			...
			$.ajax({
				type: "POST",
				url: "casillasVotos2021/asignar_casilla_status.php",
		...
		function guardarIncidencia(){
			...
			$.ajax({
				type: "POST",
				url: "casillasVotos2021/asignar_casilla_incidencia.php",
	...
	<div style=" width: 100%; display:inline-block; text-align: left;">
		<div class="sucFormTitulo">
			<label class="labelForm" id="labeltemaname">Estatus Casilla Voto 2021</label>
		</div>

		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Estatus<font color="#FF0004">*</font></label><br>
			<?php
				$selecTipoSeccion[$casilla_voto_2021_statusDatosAll[0]['status']] = 'selected="selected"';
			?>
		...
		<div class="sucFormTitulo">
			<label class="labelForm" id="labeltemaname">Reportar Incidencias Casilla Voto 2021</label>
		</div>

		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">Semaforo<font color="#FF0004">*</font></label><br>
			<?php
				if($casilla_voto_2021_incidenciasDatos[0]['status']==1 && $casilla_voto_2021_incidenciasDatos[0]['semaforo'] !=''){
					$selecTipoSeccionInicidencia['1'] = 'selected="selected"';
				}else{
					if($casilla_voto_2021_incidenciasDatos[0]['semaforo'] !=''){
						$selecTipoSeccionInicidencia[$casilla_voto_2021_incidenciasDatos[0]['semaforo']] = 'selected="selected"';
					}else{
		...
		<div class="sucForm" style="display: none;width: 100%" id="observacionesDiv">
			...
			<textarea id="observaciones" style="width: 99%;height: 150px" maxlength="140"><?= $casilla_voto_2021_incidenciasDatos[0]['observaciones'] ?></textarea> <br>
		</div>
		<div class="sucForm">
			<label class="labelForm" id="labeltemaname">&nbsp;</label><br>
		...
		<div class="sucForm">
			...
			<input class="inputlogin" disabled="disabled" type="text" name="clave" autocomplete="off"  id="clave" value="<?= $casilla_voto_2021Datos['clave'] ?>" placeholder="" maxlength="120" onblur="aMays(event, this)"/><br>
		</div>
		<div class="sucForm">
		...
		<div class="sucForm" style="display: none">
			<label class="labelForm" id="labeltemaname">Estatus<font color="#FF0004">*</font></label><br>
			<input class="inputlogin" type="text" style="width: 100%" name="status" autocomplete="off"  value="<?= $casilla_voto_2021Datos['status'] ?>" placeholder="estatus" /><br>
		</div>
		<div class="sucFormTitulo">
