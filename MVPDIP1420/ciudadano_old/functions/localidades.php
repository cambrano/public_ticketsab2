<?php
		function localidades($id_localidad=null,$id_municipio=null,$id_estado=null,$sin_seleccione=null) {
			include 'db.php';    
			$id;
			...
			if(!empty($id_municipio)){
				...
				if(!empty($id_estado)){
					$sql="SELECT * FROM localidades WHERE id_estado={$id_estado} AND id_municipio={$id_municipio} ";
		...
		function localidadId($localidad=null,$id_estadoL=null,$id_municipio=null){
			include 'db.php';  
			$sql=("SELECT * FROM localidades WHERE 1 = 1 ");
			if($localidad!=""){
		...
		function localidadIgualId($localidad=null,$id_estadoL=null,$id_municipio=null){
			include 'db.php';  
