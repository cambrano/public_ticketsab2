<?php
	function secciones_ine($id=null,$id_municipioL=null,$id_distrito_local=null,$id_distrito_federal=null,$sin_seleccione=null){
		include 'db.php'; 
		$id;
	...
	function secciones_ineDatosMapa($registros=null,$orderby=null,$limit=null) {
		...
		$sql="
			SELECT 
			*,
			(SELECT COUNT(*) FROM lista_nominal l WHERE l.id_seccion_ine = s.id) lista_nominal,
