<?php
		function casillas_votos_2021($id=null,$id_seccion_ine=null) {
			include 'db.php'; 
			$id;
			$select[$id]='selected="selected"';
			$return ="<option ".$select[$sel]." value='' >Seleccione</option> ";
			$sql="SELECT * FROM casillas_votos_2021 WHERE 1 AND codigo_plataforma='{$codigo_plataforma}'";
			if($id_seccion_ine!=""){
		...
		function casilla_voto_2021Datos($id=null,$id_casilla_voto_2021=null){
			include 'db.php';
			$sql=("SELECT * FROM casillas_votos_2021 WHERE codigo_plataforma='{$codigo_plataforma}' ");
		...
		function casillas_votos_2021Datos($id=null,$id_seccion_ine=null,$orden=null){
			...
			$sql="SELECT 
					*
					FROM casillas_votos_2021 WHERE codigo_plataforma='{$codigo_plataforma}' ";
			if($id!=""){
				$sql.=" AND id = '{$id}' ";
			}
			if($id_seccion_ine!=""){
		...
		function casillas_votos_2021DatosMapa($id=null,$id_seccion_ine=null,$orden=null){
			...
			$sql="SELECT
					...
					WHERE cv2021.codigo_plataforma='{$codigo_plataforma}' 
			";
			if($id!=""){
