<?php
		...
		*/
		...
		$sqlKIjU21534330577Y0iPs61534330577=("SELECT * FROM usuarios WHERE tipo='1' AND codigo_plataforma='{$codigo_plataforma}' ");
		$resultadoKIjU21534330577Y0iPs61534330577 = $conexion->query($sqlKIjU21534330577Y0iPs61534330577);
		$rowKIjU21534330577Y0iPs61534330577=$resultadoKIjU21534330577Y0iPs61534330577->fetch_array();
		if($rowKIjU21534330577Y0iPs61534330577['id']==""){
