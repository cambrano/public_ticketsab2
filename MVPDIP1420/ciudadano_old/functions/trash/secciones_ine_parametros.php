<?php
		function secciones_ine_parametrosDatos($id=null,$id_seccion_ine=null,$orden=null,$limit=null){
			...
			$sql="SELECT 
					*
					FROM secciones_ine_parametros WHERE codigo_plataforma='{$codigo_plataforma}' ";
			if($id!=""){
				$sql.=" AND id = '{$id}' ";
			}
			if($id_seccion_ine!=""){
		...
		function secciones_ine_parametrosDatosMapa($id=null,$id_seccion_ine=null,$id_municipio=null,$id_distrito_local=null,$id_distrito_federal=null,$orden=null,$limit=null) {
			include 'db.php'; 
			$sql="SELECT id_seccion_ine,tipo,orden,latitud,longitud FROM secciones_ine_parametros sip WHERE sip.codigo_plataforma='{$codigo_plataforma}' ";
			if($id!=""){
				$sql.=" AND sip.id = '{$id}' ";
			}
			if($id_seccion_ine!=""){
