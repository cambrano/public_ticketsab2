...
function primeros_pasos(){
	...
	//usuarios
	$sql="SELECT apellido_paterno FROM empleados WHERE codigo_plataforma='{$codigo_plataforma}'  ";
	$resultado = $conexion->query($sql);
	$row=$resultado->fetch_array();
	...
	//banco debito
	$sql="SELECT id FROM bancos WHERE id_tipo_cuenta=1 AND codigo_plataforma='{$codigo_plataforma}'  ";
	$resultado = $conexion->query($sql);
	$row=$resultado->fetch_array();
	$bancos=$row['id'];
	if($bancos!=""){
	...
	//banco credito
	$sql="SELECT id FROM bancos WHERE id_tipo_cuenta=2 AND codigo_plataforma='{$codigo_plataforma}'  ";
	$resultado = $conexion->query($sql);
	$row=$resultado->fetch_array();
	$bancos=$row['id'];
	if($bancos!=""){
	...
	//correo sistema
	$sql="SELECT id FROM correo_sistema WHERE status=1 AND codigo_plataforma='{$codigo_plataforma}'  ";
	$resultado = $conexion->query($sql);
	$row=$resultado->fetch_array();
	...
	//notificaciones
	$sql="SELECT id FROM notificaciones_sistema WHERE  codigo_plataforma='{$codigo_plataforma}'  ";
	$resultado = $conexion->query($sql);
	$row=$resultado->fetch_array();
	...
	//sucursales
	$sql="SELECT id FROM sucursales WHERE  codigo_plataforma='{$codigo_plataforma}'  ";
	$resultado = $conexion->query($sql);
	$row=$resultado->fetch_array();
	$sucursales=$row['id'];
	if($sucursales!=""){
	...
	//tipos_productos
	$sql="SELECT id FROM tipos_productos WHERE  codigo_plataforma='{$codigo_plataforma}'  ";
	$resultado = $conexion->query($sql);
	$row=$resultado->fetch_array();
	...
	//tipos_habitaciones
	$sql="SELECT id FROM tipos_habitaciones WHERE  codigo_plataforma='{$codigo_plataforma}'  ";
	$resultado = $conexion->query($sql);
	$row=$resultado->fetch_array();
	...
	//tipos_gastos
	$sql="SELECT id FROM tipos_gastos WHERE  codigo_plataforma='{$codigo_plataforma}'  ";
	$resultado = $conexion->query($sql);
	$row=$resultado->fetch_array();
	$tipos_gastos=$row['id'];
	if($tipos_gastos!=""){
