	...
	*/
	...
	var tplTextOptions = {
		buttons : {
			...
			'Datos_Correo' : {name : __('Datos Correo'), type : 'nicEditorDatosCorreoSelect', command : 'InsertText'},
	...
	var nicEditorDatosCorreoSelect = nicEditorSelect.extend({
		sel : {
			'Correo_Electronico_Repuesta' : 'Correo Electrónico Repuesta',
			'Correo_Electronico_Envio' : 'Correo Electrónico Enío',
			'URL' : 'Url Base',
			'Nombre_Sistema' : 'Nombre Sistema',
			'Slogan_Sistema' : 'Slogan Sistema', 
		},
		init : function() {
			this.setDisplay('Datos Correo Electrónico');
			for(itm in this.sel) {
				this.add(itm,this.sel[itm]);
			}
		},
		...
		update : function(elm) {
			if (this.options.command == 'InsertText') {
				switch(elm){
					case 'Correo_Electronico_Repuesta':content="[*__Correo_Electronico_Repuesta__*]";break;
					case 'Correo_Electronico_Envio':content="[*__Correo_Electronico_Envio__*]";break;
