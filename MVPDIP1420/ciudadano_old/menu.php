...
<ul id="nav" class="nav navbar-nav">
	...
	<?php
		if($casilla == 1 || $casilla == 1){
			echo "<li><a href='#' id='casillas_votos_2021_a'>Municipal </a></li>";
			echo "<li><a href='#' id='casillas_votos_2021_dl'>Local </a></li>";
			echo "<li><a href='#' id='casillas_votos_2021_df'>Federal </a></li>";
		}
	?>
