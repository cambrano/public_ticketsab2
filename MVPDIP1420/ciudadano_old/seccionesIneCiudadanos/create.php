<?php
	...
	$seccion_ine_ciudadanoDatos['id_municipio'] = 342;
	...
	<script language="javascript" type="text/javascript">
		...
		function guardar() {
			...
			*/
			...
			ocr = ocr.replace(espacios_invalidos, ''); 
			if(ocr == ""){
				...
				if(ocr.length != '13' ){
					document.getElementById("ocr").focus(); 
					document.getElementById("sumbmit").disabled = false;
					$("#mensaje").html("OCR valido de 13 digitos");
					document.getElementById("mensaje").classList.add("mensajeError");
					return false;
				}
			}
			...
			fecha_nacimiento = fecha_nacimiento.replace(espacios_invalidos, '');
			if(fecha_nacimiento == ""){
			...
			*/
			...
			manzana = manzana.replace(espacios_invalidos, '');
			var vigencia = document.getElementById("vigencia").value;
			if(vigencia != ""){
				var valoresAceptados = /^[0-9]+$/;
				if (vigencia.match(valoresAceptados)){
				} else {
