<?php
	...
	foreach($_POST["seccion_ine_ciudadano"][0] as $keyPrincipal => $atributo) {
		$_POST["seccion_ine_ciudadano"][0][$keyPrincipal]= mysqli_real_escape_string($conexion,$atributo);
	}
	...
	if( 
		...
		if(!empty($_POST)){
			...
			$_POST["seccion_ine_ciudadano"][0]['clave'] = $seccion_ine_ciudadanoDatos['clave'];
