...
?>
			...
			$.ajax({
				...
				success: function(data) {
					...
					if(data.status_verificacion == 1){
						...
						document.getElementById("latitud").value = data.latitud_calle;
						document.getElementById("longitud").value = data.longitud_calle;
						...
						zoom=14;
						const location = {lng:data.longitud_calle, lat:data.latitud_calle};
						myMap(location,zoom);
						...
						$("#mensaje").html("No encontrado,Este ciudadano es desconocido verificar los datos."); 
						document.getElementById("mensaje").classList.add("mensajeSucces");
					}
					if(data.disponible==true){
						$("#mensaje").html("&nbsp;");
						document.getElementById("mensaje").classList.remove("mensajeError");
						$("#mensaje").html("Disponible,Este ciudadano no esta en el sistema."); 
						document.getElementById("mensaje").classList.add("mensajeSucces");
					}else{
						document.getElementById("mensaje").classList.add("mensajeError");
						$("#mensaje").html("No Disponible, Este ciudadano esta en el sistema.");
					}
				}
			});
		}
	...
	<div style=" width: 100%; display:inline-block; text-align: left;">
		...
		<div class="sucFormTitulo">
			<label class="labelForm" id="labeltemaname">Identificaciones</label><br>
		</div>
		...
		<div class="sucForm" style="width: 100%">
			<input type="button" onclick="buscar_clave_electoral()" value="Buscar Datos">
		</div> 
