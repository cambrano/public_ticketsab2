<?php
	...
	if(!empty($_POST)){
		...
		$id_casilla_voto_2021 = $_COOKIE["id_casilla_voto"];
		...
		$seccion_ine_ciudadano_check_2021Datos = seccion_ine_ciudadano_check_2021Datos('',$id_seccion_ine,'',$id_casilla_voto_2021,$id_usuario,'',$id_seccion_ine_ciudadano,$id_seccion_ine_ciudadano_relacionado);
		...
		if($seccion_ine_ciudadano_check_2021Datos['id']==""){
			...
			$_POST["seccion_ine_ciudadano_check_2021"][0]['id_casilla_voto_2021']=$id_casilla_voto_2021;
			...
			$_POST["seccion_ine_ciudadano_check_2021"][0]['id_seccion_ine_ciudadano_relacionado']=$id_seccion_ine_ciudadano_relacionado;


			$_POST["seccion_ine_ciudadano_check_2021"][0]['check_out']=1;
			$_POST["seccion_ine_ciudadano_check_2021"][0]['check_out_fecha']=$fechaSF;
			$_POST["seccion_ine_ciudadano_check_2021"][0]['check_out_hora']=$fechaSH; 
			$_POST["seccion_ine_ciudadano_check_2021"][0]['check_out_fecha_hora']=$fechaH; 
			...
			// update
			//echo "NO";
			if($seccion_ine_ciudadano_check_2021Datos['check_out'] != 1){
				//editamos
				...
				$update_secciones_ine_ciudadanos_check_2021 = "UPDATE secciones_ine_ciudadanos_check_2021 SET ". join(",",$valueSets) . " WHERE id=".$id;
				$conexion->autocommit(FALSE);
