...
?>
	<script type="text/javascript">
		...
		function searchTable(value){
			...
			$.ajax({
				type: "POST",
				url: "seccionesIneCiudadanosSeguimientos/table.php",
	...
	<div class="sucForm">
		...
		<select class="selectpicker" data-live-search="true" data-size="5" data-actions-box="true" title="Seleccione" id="id_identidad" onchange="searchTable();" <?= $disbale_id_pricipal ?> >
			<?php
			echo identidades($_SESSION['id_identidad']);
			?>
		</select><br>
	</div>

	<div class="sucForm">
		<label class="labelForm" id="labeltemaname">Redes Sociales</label><br>
		<select class="selectpicker" data-live-search="true" data-size="5" data-actions-box="true" title="Seleccione" id="id_red_social" onchange="searchTable();">
			<?php
			echo redes_sociales();
			?>
		</select><br>
	...
	<div class="sucForm">
		...
		<select class="selectpicker" data-live-search="true" data-size="5" data-actions-box="true" title="Seleccione" id="verificado" onchange="searchTable();">
