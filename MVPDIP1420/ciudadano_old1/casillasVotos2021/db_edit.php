<?php
	...
	if($_POST["casilla_voto_2021"][0]['tipo']=='x'){
		$_POST["casilla_voto_2021"][0]['tipo']=0;
	}

	$id_casilla_voto_2021 = $_COOKIE["id_casilla_voto_partidos"];
	$_POST["casilla_voto_2021"][0]['id'] = $id_casilla_voto_2021;
	$casilla_voto_2021Datos=casilla_voto_2021Datos($id_casilla_voto_2021);

	$_POST["casilla_voto_2021"][0]['clave'] = $casilla_voto_2021Datos['clave'];
	$_POST["casilla_voto_2021"][0]['id_seccion_ine'] = $casilla_voto_2021Datos['id_seccion_ine'];
	$_POST["casilla_voto_2021"][0]['id_tipo_casilla'] = $casilla_voto_2021Datos['id_tipo_casilla'];
	$_POST["casilla_voto_2021"][0]['codigo'] = $casilla_voto_2021Datos['codigo'];
	$_POST["casilla_voto_2021"][0]['id_pais'] = $casilla_voto_2021Datos['id_pais'];
	$_POST["casilla_voto_2021"][0]['id_estado'] = $casilla_voto_2021Datos['id_estado'];
	$_POST["casilla_voto_2021"][0]['id_municipio'] = $casilla_voto_2021Datos['id_municipio'];
	$_POST["casilla_voto_2021"][0]['id_localidad'] = $casilla_voto_2021Datos['id_localidad'];
	$_POST["casilla_voto_2021"][0]['calle'] = $casilla_voto_2021Datos['calle'];
	$_POST["casilla_voto_2021"][0]['colonia'] = $casilla_voto_2021Datos['colonia'];
	$_POST["casilla_voto_2021"][0]['codigo_postal'] = $casilla_voto_2021Datos['codigo_postal'];
	$_POST["casilla_voto_2021"][0]['longitud'] = $casilla_voto_2021Datos['longitud'];
	$_POST["casilla_voto_2021"][0]['latitud'] = $casilla_voto_2021Datos['latitud'];
			...
			if(!empty($casillas_votos_partidos_2021Datos)){
				...
				foreach ($votos_partidos_2021 as $key => $value) {
					if( registrosCompara("casillas_votos_partidos_2021",$value,1)){
						...
						$voto_partido['id_casilla_voto_2021']=$id_casilla_voto_2021;
						...
						if(!$update_casillas_votos_partidos_2021 || $num=0){
							$success=false;
							echo "<br>";
							echo "ERROR update_casillas_votos_partidos_20211"; 
							var_dump($conexion->error);
						}
