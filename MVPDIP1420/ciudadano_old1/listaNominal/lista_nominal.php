<?php
	...
	if( $id_municipio!="" ){   //name
		$post_search=true;
		$sql.=" AND l.id_municipio = '{$id_municipio}' ";
		$sqlContador .= " AND id_municipio = '{$id_municipio}' ";
	} 
	...
	if( $id_localidad!="" ){   //name
		...
		$sqlContador .= " AND id_localidad = '{$id_localidad}' ";
	} 
	...
	$militante_partido=$_SESSION['searchTable']['militante_partido'];
	if( $militante_partido!="" ){   //name
		$post_search=true;
		$sql.=" AND l.militante_partido LIKE '%{$militante_partido}%' ";
		$sqlContador .= " AND militante_partido LIKE '%{$militante_partido}%' ";
	}
	...
	while($row=$result->fetch_assoc()){
		...
		$nestedData[] = $row["militante_partido"]; 
