<?php
	...
	@session_start();
	$_SESSION['Paguinasub']="seccionesIneCiudadanosEntrega/index.php";
...
?>
	<script type="text/javascript">
		...
		function desbloquear_casilla(){
			...
			$('#id_casilla_voto_2021').prop('disabled', false);
			$('#id_casilla_voto_2021').selectpicker('refresh');
		}
	</script>
	<script type="text/javascript">
	...
	<div id="bodymanager" class="bodymanager">
		...
		<div class="sucForm">
			...
			<select id="id_casilla_voto_2021" class='myselect' <?= $input_dis ?> >
				<?= casillas_votos_2021($id_casilla_voto_2021,$id_seccion_ine) ?>
			</select>
		</div>
		<div class="sucForm">
