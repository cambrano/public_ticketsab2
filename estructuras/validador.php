									...
									while($row5=$resultado5->fetch_assoc()){
										...
										if($nivel5_id_tipo_ciudadano != $niveles[4] ){
											...
											while($row6=$resultado6->fetch_assoc()){
												...
												$id_seccion_ine_ciudadano7 = $nivel4_id=$row6['id'];
												...
												if($nivel6_id_tipo_ciudadano != $niveles[5] ){
													...
													echo "<tr><td>".$nivel6_id."</td><td>".$nivel6_clave."</td><td>".$nivel6_folio."</td><td>".$nivel6_tipo."</td><td>".$_tipo_nivel[$niveles[5]]."</td><td>".$nivel5_nombre_completo."</td><td>".$row6['usuario_insert']."</td><td>".$row6['usuario_update']."</td></tr>";
													echo "</table><br>";
												}
											}
										}
