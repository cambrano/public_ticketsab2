<?php
		function casillas_votos_2021($id=null) {
			include 'db.php'; 
			$id;
		...
		function casillas_votos_2021Datos($id=null,$id_seccion_ine=null,$orden=null,$tipo=null){
			include 'db.php'; 
			$sql="SELECT 
					*
		...
		function casillas_votos_2021DatosMapa($id=null,$id_seccion_ine=null,$id_municipioL=null,$id_distrito_localL=null,$id_distrito_federalL=null,$orden=null,$tipo=null,$groupby=null){
			include 'db.php'; 
			$sql="SELECT 
					*
					FROM casillas_votos_2021 WHERE 1 = 1 ";
