<?php
		function casillas_votos_partidos_2021Datos($id=null,$id_casilla_voto_2021=null,$id_seccion_ine=null,$orden=null){
			...
			$sql="SELECT 
					*
					FROM casillas_votos_partidos_2021 WHERE 1 = 1 ";
			if($id!=""){
				$sql.=" AND id = '{$id}' ";
			}
		...
		function casillas_votos_partidos_2021_partidosDatos($id=null,$id_casilla_voto_2021=null,$id_seccion_ine=null,$orden=null,$tipo=null){
			include 'db.php'; 
			$sql="SELECT 
					*
