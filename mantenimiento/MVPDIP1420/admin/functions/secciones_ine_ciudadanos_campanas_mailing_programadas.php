<?php
		...
		function seccion_ine_ciudadano_campana_mailing_programadaDatos($id=null){
			include 'db.php';
			$sql=("SELECT 
					siccmp.fechaR,
					siccmp.id,
					...
					(SELECT cmp.asunto FROM campanas_mailing_cuerpos cmp WHERE cmp.id_campana_mailing= siccmp.id_campana_mailing) asunto,
					(SELECT cmp.cuerpo FROM campanas_mailing_cuerpos cmp WHERE cmp.id_campana_mailing= siccmp.id_campana_mailing) cuerpo,
		...
		function secciones_ine_ciudadanos_campanas_mailing_programadasDatosArray($registros=null,$orderby=null,$limit=null) {
		include 'db.php'; 
		$sql="
			SELECT
				*,
