...
<html lang="es">
	<head>
		...
		<title><?= $titulo_page ?> - En Mantenimiento</title>
		<!--Optiones-->
		<meta property="og:url" content="index.php">
		<meta property="og:type" content="website" />
		<meta property="og:title" content="<?= $titulo_page ?> - En Mantenimiento" />
		...
		<meta itemprop="name" content="<?= $titulo_page ?> - En Mantenimiento" />
					...
					<div class="row justify-content-center">
						<div class="col-xl-8 col-lg-8">
							<div class="header-content text-center">
								...
								<img style="width: 320px;" src="assets/iconos/logo.png" alt="Logo">
								<h4 class="title" style="color:white;background-color:#808080;padding:10px">Página en Mantenimiento</h4>
							</div>
							<!-- header content -->
						</div>
					</div>
