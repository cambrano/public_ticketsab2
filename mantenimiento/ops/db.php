<?php
	...
	$dbusuario_user = $dbusuario = $database_users_12X12[$datauser_random]['usuario']="cambrano_cozumel";
	$dbpassword_user = $dbpassword = $database_users_12X12[$datauser_random]['password']="cozumel";
